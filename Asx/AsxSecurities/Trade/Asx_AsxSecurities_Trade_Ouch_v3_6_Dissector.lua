...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.accepted_sequence_number = ProtoField.new("Accepted Sequence Number", "asx.asxsecurities.trade.ouch.v3.6.acceptedsequencenumber", ftypes.STRING)
omi_asx_asxsecurities_trade_ouch_v3_6.fields.accepted_session = ProtoField.new("Accepted Session", "asx.asxsecurities.trade.ouch.v3.6.acceptedsession", ftypes.STRING)
...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.debug_text = ProtoField.new("Debug Text", "asx.asxsecurities.trade.ouch.v3.6.debugtext", ftypes.STRING)
...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_packet_type = ProtoField.new("Packet Type", "asx.asxsecurities.trade.ouch.v3.6.serverpackettype", ftypes.STRING)
...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_packet = ProtoField.new("Packet", "asx.asxsecurities.trade.ouch.v3.6.serverpacket", ftypes.STRING)
omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_packet_header = ProtoField.new("Packet Header", "asx.asxsecurities.trade.ouch.v3.6.serverpacketheader", ftypes.STRING)
omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "asx.asxsecurities.trade.ouch.v3.6.serversoupbintcppacket", ftypes.STRING)

-- Asx AsxSecurities Trade 3.6 Application Messages
...
-- Asx AsxSecurities Trade 3.6 Session Messages
omi_asx_asxsecurities_trade_ouch_v3_6.fields.client_heartbeat = ProtoField.new("Client Heartbeat", "asx.asxsecurities.trade.ouch.v3.6.clientheartbeat", ftypes.BYTES)
...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.end_of_session = ProtoField.new("End Of Session", "asx.asxsecurities.trade.ouch.v3.6.endofsession", ftypes.BYTES)
...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.logout_request = ProtoField.new("Logout Request", "asx.asxsecurities.trade.ouch.v3.6.logoutrequest", ftypes.BYTES)
...
omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_heartbeat = ProtoField.new("Server Heartbeat", "asx.asxsecurities.trade.ouch.v3.6.serverheartbeat", ftypes.BYTES)
...
-- Asx AsxSecurities Trade Ouch 3.6 Generated Fields
omi_asx_asxsecurities_trade_ouch_v3_6.fields.sequenced_data_packet_sequence_number = ProtoField.new("Sequenced Data Packet Sequence Number", "asx.asxsecurities.trade.ouch.v3.6.sequenceddatapacketsequencenumber", ftypes.UINT64)

-----------------------------------------------------------------------
-- Asx AsxSecurities Trade Ouch 3.6 Formatting
-----------------------------------------------------------------------
...
omi_asx_asxsecurities_trade_ouch_v3_6.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_asx_asxsecurities_trade_ouch_v3_6.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
...
function omi_asx_asxsecurities_trade_ouch_v3_6.prefs_changed()
  ...
  if show.sequences ~= omi_asx_asxsecurities_trade_ouch_v3_6.prefs.show_sequences then
    show.sequences = omi_asx_asxsecurities_trade_ouch_v3_6.prefs.show_sequences
  end
end
...
asx_asxsecurities_trade_ouch_v3_6.conversation = {}
...
asx_asxsecurities_trade_ouch_v3_6.stream_frame = nil
asx_asxsecurities_trade_ouch_v3_6.stream_occurrence = 0

-- Conversation key for the current packet (src/dst tuple)
asx_asxsecurities_trade_ouch_v3_6.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
asx_asxsecurities_trade_ouch_v3_6.conversation.data = function(packet)
...
asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number = {}

-- Size: Accepted Sequence Number
asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.size = 20

-- Display: Accepted Sequence Number
asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.display = function(value)
  return "Accepted Sequence Number: "..value
end

-- Dissect: Accepted Sequence Number
asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.size
  ...
  parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.accepted_sequence_number, range, value, display)

  return offset + length, value
end

-- Accepted Session
asx_asxsecurities_trade_ouch_v3_6.accepted_session = {}

-- Size: Accepted Session
asx_asxsecurities_trade_ouch_v3_6.accepted_session.size = 10

-- Display: Accepted Session
asx_asxsecurities_trade_ouch_v3_6.accepted_session.display = function(value)
  return "Accepted Session: "..value
end

-- Dissect: Accepted Session
asx_asxsecurities_trade_ouch_v3_6.accepted_session.dissect = function(buffer, offset, packet, parent)
  local length = asx_asxsecurities_trade_ouch_v3_6.accepted_session.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = asx_asxsecurities_trade_ouch_v3_6.accepted_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.accepted_session, range, value, display)
...
-- Client Packet Type
asx_asxsecurities_trade_ouch_v3_6.client_packet_type = {}

-- Size: Client Packet Type
asx_asxsecurities_trade_ouch_v3_6.client_packet_type.size = 1

-- Display: Client Packet Type
asx_asxsecurities_trade_ouch_v3_6.client_packet_type.display = function(value)
  if value == "+" then
...
asx_asxsecurities_trade_ouch_v3_6.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = asx_asxsecurities_trade_ouch_v3_6.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = asx_asxsecurities_trade_ouch_v3_6.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.client_packet_type, range, value, display)
...
-- Debug Text
asx_asxsecurities_trade_ouch_v3_6.debug_text = {}

-- Size: Debug Text
asx_asxsecurities_trade_ouch_v3_6.debug_text.size = 1

-- Display: Debug Text
asx_asxsecurities_trade_ouch_v3_6.debug_text.display = function(value)
  return "Debug Text: "..value
end

-- Dissect: Debug Text
asx_asxsecurities_trade_ouch_v3_6.debug_text.dissect = function(buffer, offset, packet, parent)
  local length = asx_asxsecurities_trade_ouch_v3_6.debug_text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = asx_asxsecurities_trade_ouch_v3_6.debug_text.display(value, buffer, offset, packet, parent)

  parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.debug_text, range, value, display)
...
-- Server Packet Type
asx_asxsecurities_trade_ouch_v3_6.server_packet_type = {}

-- Size: Server Packet Type
asx_asxsecurities_trade_ouch_v3_6.server_packet_type.size = 1

-- Display: Server Packet Type
asx_asxsecurities_trade_ouch_v3_6.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
asx_asxsecurities_trade_ouch_v3_6.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = asx_asxsecurities_trade_ouch_v3_6.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = asx_asxsecurities_trade_ouch_v3_6.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_packet_type, range, value, display)
...
-- End Of Session
asx_asxsecurities_trade_ouch_v3_6.end_of_session = {}

-- Display: End Of Session
asx_asxsecurities_trade_ouch_v3_6.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
asx_asxsecurities_trade_ouch_v3_6.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = asx_asxsecurities_trade_ouch_v3_6.end_of_session.display(packet, parent, 0)
...
-- Server Heartbeat
asx_asxsecurities_trade_ouch_v3_6.server_heartbeat = {}

-- Display: Server Heartbeat
asx_asxsecurities_trade_ouch_v3_6.server_heartbeat.display = function(packet, parent, length)
  return "Server Heartbeat"
end


-- Dissect: Server Heartbeat
asx_asxsecurities_trade_ouch_v3_6.server_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = asx_asxsecurities_trade_ouch_v3_6.server_heartbeat.display(packet, parent, 0)
  packet.cols.info = display
  ...
  if flow ~= nil then
    ...
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.current)
      end
      ...
      if value ~= nil then
        ...
        if show.sequences then
          local sequence = parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.sequenced_data_packet_sequence_number, UInt64.new(value))
          sequence:set_generated()
        end
      end
    else
      if memo ~= nil and #memo > 0 then
        if asx_asxsecurities_trade_ouch_v3_6.stream_frame ~= packet.number or asx_asxsecurities_trade_ouch_v3_6.stream_occurrence >= #memo then
          asx_asxsecurities_trade_ouch_v3_6.stream_frame = packet.number
          asx_asxsecurities_trade_ouch_v3_6.stream_occurrence = 0
        end
        asx_asxsecurities_trade_ouch_v3_6.stream_occurrence = asx_asxsecurities_trade_ouch_v3_6.stream_occurrence + 1
        local value = memo[asx_asxsecurities_trade_ouch_v3_6.stream_occurrence]
...
asx_asxsecurities_trade_ouch_v3_6.login_accepted_packet.size =
  asx_asxsecurities_trade_ouch_v3_6.accepted_session.size + 
  asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.size
...
asx_asxsecurities_trade_ouch_v3_6.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, accepted_session = asx_asxsecurities_trade_ouch_v3_6.accepted_session.dissect(buffer, index, packet, parent)

  -- Accepted Sequence Number: 20 Byte Ascii String
  index, accepted_sequence_number = asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.dissect(buffer, index, packet, parent)

  -- Store Accepted Sequence Number Value
  asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.current = accepted_sequence_number

  if not packet.visited then
    asx_asxsecurities_trade_ouch_v3_6.conversation.current.accepted_sequence_number.last = accepted_sequence_number
  end
...
asx_asxsecurities_trade_ouch_v3_6.debug_packet.size =
  asx_asxsecurities_trade_ouch_v3_6.debug_text.size
...
asx_asxsecurities_trade_ouch_v3_6.debug_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, debug_text = asx_asxsecurities_trade_ouch_v3_6.debug_text.dissect(buffer, index, packet, parent)
...
-- Server Payload
asx_asxsecurities_trade_ouch_v3_6.server_payload = {}

-- Dissect: Server Payload
asx_asxsecurities_trade_ouch_v3_6.server_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
  ...
  if server_packet_type == "H" then
    return asx_asxsecurities_trade_ouch_v3_6.server_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if server_packet_type == "Z" then
    return asx_asxsecurities_trade_ouch_v3_6.end_of_session.dissect(buffer, offset, packet, parent)
  end
...
asx_asxsecurities_trade_ouch_v3_6.server_packet_header = {}

-- Size: Server Packet Header
asx_asxsecurities_trade_ouch_v3_6.server_packet_header.size =
  asx_asxsecurities_trade_ouch_v3_6.packet_length.size + 
  asx_asxsecurities_trade_ouch_v3_6.server_packet_type.size

-- Display: Server Packet Header
asx_asxsecurities_trade_ouch_v3_6.server_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Packet Header
asx_asxsecurities_trade_ouch_v3_6.server_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = asx_asxsecurities_trade_ouch_v3_6.server_packet_type.dissect(buffer, index, packet, parent)
...
asx_asxsecurities_trade_ouch_v3_6.server_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = asx_asxsecurities_trade_ouch_v3_6.server_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return asx_asxsecurities_trade_ouch_v3_6.server_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Packet Header: Struct of 2 fields
  index, server_packet_header = asx_asxsecurities_trade_ouch_v3_6.server_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = asx_asxsecurities_trade_ouch_v3_6.server_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < asx_asxsecurities_trade_ouch_v3_6.server_packet_header.size then
...
-- Server Packet
asx_asxsecurities_trade_ouch_v3_6.server_packet = {}

-- Verify required size of Tcp packet
asx_asxsecurities_trade_ouch_v3_6.server_packet.requiredsize = function(buffer)
  return buffer:len() >= asx_asxsecurities_trade_ouch_v3_6.server_packet_header.size
end
...
asx_asxsecurities_trade_ouch_v3_6.server_packet.dissect = function(buffer, packet, parent)
  ...
  asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.current = data.accepted_sequence_number.frames[packet.number]
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = asx_asxsecurities_trade_ouch_v3_6.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
-- Logout Request
asx_asxsecurities_trade_ouch_v3_6.logout_request = {}

-- Display: Logout Request
asx_asxsecurities_trade_ouch_v3_6.logout_request.display = function(packet, parent, length)
  return "Logout Request"
end


-- Dissect: Logout Request
asx_asxsecurities_trade_ouch_v3_6.logout_request.dissect = function(buffer, offset, packet, parent)
  local display = asx_asxsecurities_trade_ouch_v3_6.logout_request.display(packet, parent, 0)
  packet.cols.info = display
...
-- Client Heartbeat
asx_asxsecurities_trade_ouch_v3_6.client_heartbeat = {}

-- Display: Client Heartbeat
asx_asxsecurities_trade_ouch_v3_6.client_heartbeat.display = function(packet, parent, length)
  return "Client Heartbeat"
end


-- Dissect: Client Heartbeat
asx_asxsecurities_trade_ouch_v3_6.client_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = asx_asxsecurities_trade_ouch_v3_6.client_heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
-- Client Payload
asx_asxsecurities_trade_ouch_v3_6.client_payload = {}

-- Dissect: Client Payload
asx_asxsecurities_trade_ouch_v3_6.client_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
  ...
  if client_packet_type == "R" then
    return asx_asxsecurities_trade_ouch_v3_6.client_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request
  if client_packet_type == "O" then
    return asx_asxsecurities_trade_ouch_v3_6.logout_request.dissect(buffer, offset, packet, parent)
  end
...
asx_asxsecurities_trade_ouch_v3_6.client_packet_header = {}

-- Size: Client Packet Header
asx_asxsecurities_trade_ouch_v3_6.client_packet_header.size =
  asx_asxsecurities_trade_ouch_v3_6.packet_length.size + 
  asx_asxsecurities_trade_ouch_v3_6.client_packet_type.size

-- Display: Client Packet Header
asx_asxsecurities_trade_ouch_v3_6.client_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Packet Header
asx_asxsecurities_trade_ouch_v3_6.client_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = asx_asxsecurities_trade_ouch_v3_6.client_packet_type.dissect(buffer, index, packet, parent)
...
asx_asxsecurities_trade_ouch_v3_6.client_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = asx_asxsecurities_trade_ouch_v3_6.client_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return asx_asxsecurities_trade_ouch_v3_6.client_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Packet Header: Struct of 2 fields
  index, client_packet_header = asx_asxsecurities_trade_ouch_v3_6.client_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = asx_asxsecurities_trade_ouch_v3_6.client_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_asx_asxsecurities_trade_ouch_v3_6.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < asx_asxsecurities_trade_ouch_v3_6.client_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Packet
asx_asxsecurities_trade_ouch_v3_6.client_packet = {}

-- Verify required size of Tcp packet
asx_asxsecurities_trade_ouch_v3_6.client_packet.requiredsize = function(buffer)
  return buffer:len() >= asx_asxsecurities_trade_ouch_v3_6.client_packet_header.size
end

-- Dissect Client Packet
asx_asxsecurities_trade_ouch_v3_6.client_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = asx_asxsecurities_trade_ouch_v3_6.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
function omi_asx_asxsecurities_trade_ouch_v3_6.init()
  asx_asxsecurities_trade_ouch_v3_6.accepted_sequence_number.current = nil
  asx_asxsecurities_trade_ouch_v3_6.conversation.current = nil
  asx_asxsecurities_trade_ouch_v3_6.conversation.flows = {}
end
...
asx_asxsecurities_trade_ouch_v3_6.role = function(packet)
  if omi_asx_asxsecurities_trade_ouch_v3_6.prefs.assume_role == 1 then
    return "initiator"
  end

  if omi_asx_asxsecurities_trade_ouch_v3_6.prefs.assume_role == 2 then
    return "acceptor"
  end

  local acceptor_port = omi_asx_asxsecurities_trade_ouch_v3_6.prefs.acceptor_port
  ...
  if omi_asx_asxsecurities_trade_ouch_v3_6.prefs.swap_sides then
...
asx_asxsecurities_trade_ouch_v3_6.swap = function(packet)
  local key = conversation(packet)
...
function omi_asx_asxsecurities_trade_ouch_v3_6.dissector(buffer, packet, parent)
  ...
  if role == "initiator" then
    return asx_asxsecurities_trade_ouch_v3_6.client_packet.dissect(buffer, packet, protocol)
  end

  return asx_asxsecurities_trade_ouch_v3_6.server_packet.dissect(buffer, packet, protocol)
end
...
asx_asxsecurities_trade_ouch_v3_6.client_packet.fingerprint = function(buffer)
...
asx_asxsecurities_trade_ouch_v3_6.server_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_asx_asxsecurities_trade_ouch_v3_6_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not asx_asxsecurities_trade_ouch_v3_6.client_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not asx_asxsecurities_trade_ouch_v3_6.client_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Asx AsxSecurities Trade Ouch 3.6 (Tcp)
local function omi_asx_asxsecurities_trade_ouch_v3_6_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not asx_asxsecurities_trade_ouch_v3_6.server_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not asx_asxsecurities_trade_ouch_v3_6.server_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Asx AsxSecurities Trade Ouch 3.6 (Tcp): apply the heuristic of the sender's connection role
local function omi_asx_asxsecurities_trade_ouch_v3_6_tcp_heuristic(buffer, packet, parent)
  local role = asx_asxsecurities_trade_ouch_v3_6.role(packet)
  local initiator = omi_asx_asxsecurities_trade_ouch_v3_6_tcp_initiator_heuristic
  local acceptor = omi_asx_asxsecurities_trade_ouch_v3_6_tcp_acceptor_heuristic
  ...
  asx_asxsecurities_trade_ouch_v3_6.swap(packet)
