...
asx_asxsecurities_trade_ouch_v3_6.role = function(packet)
  ...
  local port = omi_asx_asxsecurities_trade_ouch_v3_6.prefs.acceptor_port
...
local function omi_asx_asxsecurities_trade_ouch_v3_6_tcp_heuristic(buffer, packet, parent)
  local role = asx_asxsecurities_trade_ouch_v3_6.role(packet)
  local first, second = omi_asx_asxsecurities_trade_ouch_v3_6_tcp_initiator_heuristic, omi_asx_asxsecurities_trade_ouch_v3_6_tcp_acceptor_heuristic
