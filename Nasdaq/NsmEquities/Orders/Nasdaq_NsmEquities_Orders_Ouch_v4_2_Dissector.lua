...
local omi_nasdaq_nsmequities_orders_ouch_v4_2 = Proto("Omi.Nasdaq.NsmEquities.Orders.Ouch.v4.2", "Nasdaq NsmEquities Orders Ouch 4.2")
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.accepted_sequence_number = ProtoField.new("Accepted Sequence Number", "nasdaq.nsmequities.orders.ouch.v4.2.acceptedsequencenumber", ftypes.STRING)
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.accepted_session = ProtoField.new("Accepted Session", "nasdaq.nsmequities.orders.ouch.v4.2.acceptedsession", ftypes.STRING)
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.nsmequities.orders.ouch.v4.2.clientpackettype", ftypes.STRING)
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.debug_text = ProtoField.new("Debug Text", "nasdaq.nsmequities.orders.ouch.v4.2.debugtext", ftypes.STRING)
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.server_packet_type = ProtoField.new("Packet Type", "nasdaq.nsmequities.orders.ouch.v4.2.serverpackettype", ftypes.STRING)
...
-- Nasdaq NsmEquities Orders Ouch 4.2 Framing
...
-- Nasdaq NsmEquities Orders 4.2 Session Messages
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.client_heartbeat = ProtoField.new("Client Heartbeat", "nasdaq.nsmequities.orders.ouch.v4.2.clientheartbeat", ftypes.BYTES)
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.end_of_session = ProtoField.new("End Of Session", "nasdaq.nsmequities.orders.ouch.v4.2.endofsession", ftypes.BYTES)
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.logout_request = ProtoField.new("Logout Request", "nasdaq.nsmequities.orders.ouch.v4.2.logoutrequest", ftypes.BYTES)
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.server_heartbeat = ProtoField.new("Server Heartbeat", "nasdaq.nsmequities.orders.ouch.v4.2.serverheartbeat", ftypes.BYTES)
...
-- Nasdaq NsmEquities Orders Ouch 4.2 Generated Fields
omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.sequenced_data_packet_sequence_number = ProtoField.new("Sequenced Data Packet Sequence Number", "nasdaq.nsmequities.orders.ouch.v4.2.sequenceddatapacketsequencenumber", ftypes.UINT64)

-----------------------------------------------------------------------
-- Nasdaq NsmEquities Orders Ouch 4.2 Formatting
-----------------------------------------------------------------------
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.swap_sides = Pref.bool("Swap Sides", false, "The first frame seen of each conversation was the acceptor's, not the initiator's; for captures that start mid conversation")
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
function omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_headers then
    show.headers = omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_headers
  end
  ...
  if show.structs ~= omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_structs then
    show.structs = omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_structs
  end
  if show.sequences ~= omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_sequences then
    show.sequences = omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.show_sequences
  end
end
...
nasdaq_nsmequities_orders_ouch_v4_2.conversation = {}
nasdaq_nsmequities_orders_ouch_v4_2.conversation.flows = {}
...
nasdaq_nsmequities_orders_ouch_v4_2.stream_frame = nil
nasdaq_nsmequities_orders_ouch_v4_2.stream_occurrence = 0

-- Conversation key for the current packet (src/dst tuple)
nasdaq_nsmequities_orders_ouch_v4_2.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_nsmequities_orders_ouch_v4_2.conversation.data = function(packet)
  local key = nasdaq_nsmequities_orders_ouch_v4_2.conversation.key(packet)
  local data = nasdaq_nsmequities_orders_ouch_v4_2.conversation.flows[key]
  if data == nil then
    data = { accepted_sequence_number = { last = nil, frames = {} }, sequence = { next = nil, frames = {} } }
    nasdaq_nsmequities_orders_ouch_v4_2.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_nsmequities_orders_ouch_v4_2.conversation.current = nil
...
nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number = {}

-- Size: Accepted Sequence Number
nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.size = 20

-- Display: Accepted Sequence Number
nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.display = function(value)
  return "Accepted Sequence Number: "..value
end

-- Dissect: Accepted Sequence Number
nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.size
  ...
  local display = nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.accepted_sequence_number, range, value, display)

  return offset + length, value
end

-- Accepted Session
nasdaq_nsmequities_orders_ouch_v4_2.accepted_session = {}

-- Size: Accepted Session
nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.size = 10

-- Display: Accepted Session
nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.display = function(value)
  return "Accepted Session: "..value
end

-- Dissect: Accepted Session
nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.accepted_session, range, value, display)
...
-- Client Packet Type
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.client_packet_type, range, value, display)
...
-- Debug Text
nasdaq_nsmequities_orders_ouch_v4_2.debug_text = {}

-- Size: Debug Text
nasdaq_nsmequities_orders_ouch_v4_2.debug_text.size = 1

-- Display: Debug Text
nasdaq_nsmequities_orders_ouch_v4_2.debug_text.display = function(value)
  return "Debug Text: "..value
end

-- Dissect: Debug Text
nasdaq_nsmequities_orders_ouch_v4_2.debug_text.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_orders_ouch_v4_2.debug_text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nsmequities_orders_ouch_v4_2.debug_text.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.debug_text, range, value, display)
...
-- Server Packet Type
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.server_packet_type, range, value, display)
...
nasdaq_nsmequities_orders_ouch_v4_2.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  local flow = nasdaq_nsmequities_orders_ouch_v4_2.conversation.current
  if flow ~= nil then
    local memo = flow.sequence.frames[packet.number]
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.current)
      end
      ...
      if value ~= nil then
        ...
        if show.sequences then
          local sequence = parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.sequenced_data_packet_sequence_number, UInt64.new(value))
          sequence:set_generated()
        end
      end
    else
      if memo ~= nil and #memo > 0 then
        if nasdaq_nsmequities_orders_ouch_v4_2.stream_frame ~= packet.number or nasdaq_nsmequities_orders_ouch_v4_2.stream_occurrence >= #memo then
          nasdaq_nsmequities_orders_ouch_v4_2.stream_frame = packet.number
          nasdaq_nsmequities_orders_ouch_v4_2.stream_occurrence = 0
        end
        nasdaq_nsmequities_orders_ouch_v4_2.stream_occurrence = nasdaq_nsmequities_orders_ouch_v4_2.stream_occurrence + 1
        local value = memo[nasdaq_nsmequities_orders_ouch_v4_2.stream_occurrence]
...
nasdaq_nsmequities_orders_ouch_v4_2.login_accepted_packet.size =
  nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.size + 
  nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.size
...
nasdaq_nsmequities_orders_ouch_v4_2.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, accepted_session = nasdaq_nsmequities_orders_ouch_v4_2.accepted_session.dissect(buffer, index, packet, parent)

  -- Accepted Sequence Number: 20 Byte Ascii String
  index, accepted_sequence_number = nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.dissect(buffer, index, packet, parent)

  -- Store Accepted Sequence Number Value
  nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.current = accepted_sequence_number

  if not packet.visited then
    nasdaq_nsmequities_orders_ouch_v4_2.conversation.current.accepted_sequence_number.last = accepted_sequence_number
  end
...
nasdaq_nsmequities_orders_ouch_v4_2.debug_packet.size =
  nasdaq_nsmequities_orders_ouch_v4_2.debug_text.size
...
nasdaq_nsmequities_orders_ouch_v4_2.debug_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, debug_text = nasdaq_nsmequities_orders_ouch_v4_2.debug_text.dissect(buffer, index, packet, parent)
...
-- Server Payload
nasdaq_nsmequities_orders_ouch_v4_2.server_payload = {}

-- Dissect: Server Payload
nasdaq_nsmequities_orders_ouch_v4_2.server_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
...
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header = {}

-- Size: Server Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.size =
  nasdaq_nsmequities_orders_ouch_v4_2.packet_length.size + 
  nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.size

-- Display: Server Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = nasdaq_nsmequities_orders_ouch_v4_2.server_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Server Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.server_packet_header, buffer(offset, 0))
    local index = nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Packet Header: Struct of 2 fields
  index, server_packet_header = nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_nsmequities_orders_ouch_v4_2.server_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.size then
...
-- Server Packet
nasdaq_nsmequities_orders_ouch_v4_2.server_packet = {}

-- Verify required size of Tcp packet
nasdaq_nsmequities_orders_ouch_v4_2.server_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nsmequities_orders_ouch_v4_2.server_packet_header.size
end

-- Dissect Server Packet
nasdaq_nsmequities_orders_ouch_v4_2.server_packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_nsmequities_orders_ouch_v4_2.conversation.data(packet)
  if not packet.visited then
    data.accepted_sequence_number.frames[packet.number] = data.accepted_sequence_number.last
  end
  nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.current = data.accepted_sequence_number.frames[packet.number]
  nasdaq_nsmequities_orders_ouch_v4_2.conversation.current = data
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_nsmequities_orders_ouch_v4_2.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
-- Client Payload
nasdaq_nsmequities_orders_ouch_v4_2.client_payload = {}

-- Dissect: Client Payload
nasdaq_nsmequities_orders_ouch_v4_2.client_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
...
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header = {}

-- Size: Client Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.size =
  nasdaq_nsmequities_orders_ouch_v4_2.packet_length.size + 
  nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.size

-- Display: Client Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_nsmequities_orders_ouch_v4_2.client_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Client Packet Header
nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.client_packet_header, buffer(offset, 0))
    local index = nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Packet Header: Struct of 2 fields
  index, client_packet_header = nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_nsmequities_orders_ouch_v4_2.client_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_nsmequities_orders_ouch_v4_2.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Packet
nasdaq_nsmequities_orders_ouch_v4_2.client_packet = {}

-- Verify required size of Tcp packet
nasdaq_nsmequities_orders_ouch_v4_2.client_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nsmequities_orders_ouch_v4_2.client_packet_header.size
end

-- Dissect Client Packet
nasdaq_nsmequities_orders_ouch_v4_2.client_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_nsmequities_orders_ouch_v4_2.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
function omi_nasdaq_nsmequities_orders_ouch_v4_2.init()
  nasdaq_nsmequities_orders_ouch_v4_2.accepted_sequence_number.current = nil
  nasdaq_nsmequities_orders_ouch_v4_2.conversation.current = nil
  nasdaq_nsmequities_orders_ouch_v4_2.conversation.flows = {}
end

-- Connection roles for Nasdaq NsmEquities Orders Ouch 4.2: Client is the initiator, Server is the acceptor
...
nasdaq_nsmequities_orders_ouch_v4_2.role = function(packet)
  if omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.assume_role == 1 then
    return "initiator"
  end

  if omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.assume_role == 2 then
    return "acceptor"
  end

  local acceptor_port = omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.acceptor_port
  ...
  if omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.swap_sides then
...
nasdaq_nsmequities_orders_ouch_v4_2.swap = function(packet)
  local key = conversation(packet)
...
function omi_nasdaq_nsmequities_orders_ouch_v4_2.dissector(buffer, packet, parent)
  ...
  if role == "initiator" then
    return nasdaq_nsmequities_orders_ouch_v4_2.client_packet.dissect(buffer, packet, protocol)
  end

  return nasdaq_nsmequities_orders_ouch_v4_2.server_packet.dissect(buffer, packet, protocol)
end
...
nasdaq_nsmequities_orders_ouch_v4_2.client_packet.fingerprint = function(buffer)
...
nasdaq_nsmequities_orders_ouch_v4_2.server_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_nsmequities_orders_ouch_v4_2.client_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_nsmequities_orders_ouch_v4_2.client_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq NsmEquities Orders Ouch 4.2 (Tcp)
local function omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_nsmequities_orders_ouch_v4_2.server_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_nsmequities_orders_ouch_v4_2.server_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_heuristic(buffer, packet, parent)
  ...
  nasdaq_nsmequities_orders_ouch_v4_2.swap(packet)
...
-- Register Heuristics for Nasdaq NsmEquities Orders Ouch 4.2
omi_nasdaq_nsmequities_orders_ouch_v4_2:register_heuristic("tcp", omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_heuristic)

-- Register Nasdaq NsmEquities Orders Ouch 4.2 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_nasdaq_nsmequities_orders_ouch_v4_2)
