...
nasdaq_nsmequities_totalview_itch_v3_0.milliseconds_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Millisecond: Numeric
  index, millisecond = nasdaq_nsmequities_totalview_itch_v3_0.millisecond.dissect(buffer, index, packet, parent)
...
nasdaq_nsmequities_totalview_itch_v3_0.server_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nsmequities_totalview_itch_v3_0.server_packet_type.size
end
...
nasdaq_nsmequities_totalview_itch_v3_0.client_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nsmequities_totalview_itch_v3_0.client_packet_type.size
end
