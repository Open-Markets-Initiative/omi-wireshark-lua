...
nasdaq_nsmequities_totalview_itch_v5_0_2017.sequence_number.current = nil

-- Generated: Sequence Number
nasdaq_nsmequities_totalview_itch_v5_0_2017.sequence_number.generated = function(value, range, packet, parent)
  local display = nasdaq_nsmequities_totalview_itch_v5_0_2017.sequence_number.display(value)
  local sequence_number = parent:add(omi_nasdaq_nsmequities_totalview_itch_v5_0_2017.fields.sequence_number, range, value, display)
...
nasdaq_nsmequities_totalview_itch_v5_0_2017.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_nsmequities_totalview_itch_v5_0_2017.sequence_number.current = sequence_number

  if not packet.visited then
    nasdaq_nsmequities_totalview_itch_v5_0_2017.conversation.current.sequence_number.last = sequence_number
  end
...
nasdaq_nsmequities_totalview_itch_v5_0_2017.packet.dissect = function(buffer, packet, parent)
  ...
  nasdaq_nsmequities_totalview_itch_v5_0_2017.sequence_number.current = data.sequence_number.frames[packet.number]
  ...
  if flow ~= nil then
    ...
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_nsmequities_totalview_itch_v5_0_2017.sequence_number.current)
      end
