...
local function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_ntxoptions_tradefeed_itch_v2_1.role(packet)
  local first = omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_initiator_heuristic
  local second = omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_acceptor_heuristic
