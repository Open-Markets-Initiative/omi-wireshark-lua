...
-- Nasdaq Common Mold64 Udp 1.0 Framing
...
function omi_nasdaq_common_mold64_udp_v1_0.prefs_changed()
  ...
  if show.indexes ~= omi_nasdaq_common_mold64_udp_v1_0.prefs.show_indexes then
    show.indexes = omi_nasdaq_common_mold64_udp_v1_0.prefs.show_indexes
  end
end
...
-- End Of Session
nasdaq_common_mold64_udp_v1_0.end_of_session = {}

-- Display: End Of Session
nasdaq_common_mold64_udp_v1_0.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_common_mold64_udp_v1_0.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_common_mold64_udp_v1_0.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_common_mold64_udp_v1_0.heartbeat = {}

-- Display: Heartbeat
nasdaq_common_mold64_udp_v1_0.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_common_mold64_udp_v1_0.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_common_mold64_udp_v1_0.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_common_mold64_udp_v1_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_common_mold64_udp_v1_0.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_common_mold64_udp_v1_0.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, message_count do
    ...
    offset = nasdaq_common_mold64_udp_v1_0.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_common_mold64_udp_v1_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_common_mold64_udp_v1_0.messages.dissect(buffer, index, packet, parent, message_count)
...
omi_nasdaq_common_mold64_udp_v1_0:register_heuristic("udp", omi_nasdaq_common_mold64_udp_v1_0_udp_heuristic)

-- Register Nasdaq Common Mold64 Udp 1.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_common_mold64_udp_v1_0)
