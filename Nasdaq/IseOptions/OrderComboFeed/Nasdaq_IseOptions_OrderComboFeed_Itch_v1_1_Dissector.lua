...
-- Nasdaq IseOptions OrderComboFeed 1.1 Session Messages
...
omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
...
function omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs_changed()
  ...
  if show.repeating_groups ~= omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_repeating_groups then
    show.repeating_groups = omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_repeating_groups
  end
