...
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.reserved_16 = ProtoField.new("Reserved 16", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.reserved16", ftypes.BYTES)
...
-- Nasdaq IseOptions SpreadTradeFeed Itch 2.1 Framing
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.client_packet = ProtoField.new("Tcp Packet", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.clientpacket", ftypes.STRING)
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.client_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.clientpacketheader", ftypes.STRING)
...
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.packet = ProtoField.new("Packet", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.packet", ftypes.STRING)
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.server_packet = ProtoField.new("Tcp Packet", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.serverpacket", ftypes.STRING)
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.server_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.serverpacketheader", ftypes.STRING)
...
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.end_of_session = ProtoField.new("End Of Session", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.endofsession", ftypes.BYTES)
...
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.heartbeat = ProtoField.new("Heartbeat", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.heartbeat", ftypes.BYTES)
...
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.messagesequencenumber", ftypes.UINT64)
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.sequenced_data_packet_sequence_number = ProtoField.new("Sequenced Data Packet Sequence Number", "nasdaq.iseoptions.spreadtradefeed.itch.v2.1.sequenceddatapacketsequencenumber", ftypes.UINT64)
...
omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.prefs_changed()
  ...
  if show.sequences ~= omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.prefs.show_sequences
  end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation = {}
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.flows = {}
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_frame = nil
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_occurrence = 0

-- Conversation key for the current packet (src/dst tuple)
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.data = function(packet)
  local key = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.key(packet)
  local data = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.flows[key]
  if data == nil then
    data = { accepted_sequence_number = { last = nil, frames = {} }, sequence = { next = nil, frames = {} } }
    nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.current = nil
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_iseoptions_spreadtradefeed_itch_v2_1.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.message_sequence_number, UInt64.new(nasdaq_iseoptions_spreadtradefeed_itch_v2_1.sequence + message_index - 1))
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.udp_packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.sequence = udp_sequence_number
...
-- Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.packet = {}

-- Verify required size of Udp packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_iseoptions_spreadtradefeed_itch_v2_1.udp_packet_header.size
end

-- Dissect Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.packet.dissect = function(buffer, packet, parent)
  local index = 0
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  local flow = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.current
  if flow ~= nil then
    local memo = flow.sequence.frames[packet.number]
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_iseoptions_spreadtradefeed_itch_v2_1.accepted_sequence_number.current)
      end
      ...
      if value ~= nil then
        ...
        if show.sequences then
          local sequence = parent:add(omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.sequenced_data_packet_sequence_number, UInt64.new(value))
          sequence:set_generated()
        end
      end
    else
      if memo ~= nil and #memo > 0 then
        if nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_frame ~= packet.number or nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_occurrence >= #memo then
          nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_frame = packet.number
          nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_occurrence = 0
        end
        nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_occurrence = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_occurrence + 1
        local value = memo[nasdaq_iseoptions_spreadtradefeed_itch_v2_1.stream_occurrence]
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.accepted_sequence_number.current = accepted_sequence_number

  if not packet.visited then
    nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.current.accepted_sequence_number.last = accepted_sequence_number
  end
...
-- Server Payload
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_payload = {}

-- Dissect: Server Payload
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header = {}

-- Size: Server Packet Header
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.size =
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Packet Header
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.server_packet_header, buffer(offset, 0))
    local index = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  ...
  index, server_packet_header = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_payload.dissect(buffer, index, packet, parent, server_packet_type)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.size then
...
-- Server Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet = {}

-- Verify required size of Tcp packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet_header.size
end

-- Dissect Server Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.data(packet)
  if not packet.visited then
    data.accepted_sequence_number.frames[packet.number] = data.accepted_sequence_number.last
  end
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.accepted_sequence_number.current = data.accepted_sequence_number.frames[packet.number]
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.current = data
...
-- Client Payload
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_payload = {}

-- Dissect: Client Payload
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header = {}

-- Size: Client Packet Header
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.size =
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.packet_length.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_type.size

-- Display: Client Packet Header
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Packet Header
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.fields.client_packet_header, buffer(offset, 0))
    local index = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  ...
  index, client_packet_header = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_payload.dissect(buffer, index, packet, parent, client_packet_type)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet = {}

-- Verify required size of Tcp packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet_header.size
end

-- Dissect Client Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet.dissect = function(buffer, packet, parent)
  local index = 0
...
function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.init()
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.accepted_sequence_number.current = nil
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.current = nil
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.conversation.flows = {}
end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.role = function(packet)
  ...
  local acceptor_port = omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.prefs.acceptor_port
...
function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    ...
    if role == "initiator" then
      return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet.dissect(buffer, packet, protocol)
    end

    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet.dissect(buffer, packet, protocol)
  end

  if packet.port_type == 3 then
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.packet.dissect(buffer, packet, protocol)
  end
end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet.fingerprint = function(buffer)
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  ...
  if not nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1_udp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_iseoptions_spreadtradefeed_itch_v2_1.packet.requiredsize(buffer) then return false end
...
local function omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.role(packet)
  local initiator = omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1_tcp_initiator_heuristic
  local acceptor = omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1_tcp_acceptor_heuristic
