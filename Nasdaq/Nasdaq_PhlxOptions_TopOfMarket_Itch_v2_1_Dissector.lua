...
nasdaq_phlxoptions_topofmarket_itch_v2_1.role = function(packet)
  ...
  local port = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.acceptor_port
...
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_phlxoptions_topofmarket_itch_v2_1.role(packet)
  local first, second = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_initiator_heuristic, omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_acceptor_heuristic
