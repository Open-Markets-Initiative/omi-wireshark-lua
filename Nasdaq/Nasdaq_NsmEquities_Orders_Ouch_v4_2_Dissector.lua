  ...
  if flow ~= nil then
    ...
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_nsmequities_orders_ouch_v4_2.sequence_number.current)
      end
...
nasdaq_nsmequities_orders_ouch_v4_2.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_nsmequities_orders_ouch_v4_2.sequence_number.current = sequence_number

  if not packet.visited then
    nasdaq_nsmequities_orders_ouch_v4_2.conversation.current.sequence_number.last = sequence_number
  end
...
nasdaq_nsmequities_orders_ouch_v4_2.server_packet.dissect = function(buffer, packet, parent)
  ...
  nasdaq_nsmequities_orders_ouch_v4_2.sequence_number.current = data.sequence_number.frames[packet.number]
...
function omi_nasdaq_nsmequities_orders_ouch_v4_2.init()
  nasdaq_nsmequities_orders_ouch_v4_2.sequence_number.current = nil
  nasdaq_nsmequities_orders_ouch_v4_2.conversation.current = nil
  nasdaq_nsmequities_orders_ouch_v4_2.conversation.flows = {}
end
...
nasdaq_nsmequities_orders_ouch_v4_2.role = function(packet)
  ...
  local port = omi_nasdaq_nsmequities_orders_ouch_v4_2.prefs.acceptor_port
...
local function omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_nsmequities_orders_ouch_v4_2.role(packet)
  local first, second = omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_initiator_heuristic, omi_nasdaq_nsmequities_orders_ouch_v4_2_tcp_acceptor_heuristic
