...
-- Nasdaq Uqdf Output Utp 1.5 Framing
...
function omi_nasdaq_uqdf_output_utp_v1_5.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_uqdf_output_utp_v1_5.prefs.show_headers then
    show.headers = omi_nasdaq_uqdf_output_utp_v1_5.prefs.show_headers
  end
