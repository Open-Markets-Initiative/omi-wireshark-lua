...
omi_nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.fields.debug_text = ProtoField.new("Debug Text", "nasdaq.gemxoptions.depthofmarket.glimpse.v2.1.debugtext", ftypes.STRING)
...
-- Debug Text
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text = {}

-- Size: Debug Text
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.size = 1

-- Display: Debug Text
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.display = function(value)
  return "Debug Text: "..value
end

-- Dissect: Debug Text
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.fields.debug_text, range, value, display)
...
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_packet.size =
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.size
...
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, debug_text = nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.debug_text.dissect(buffer, index, packet, parent)
