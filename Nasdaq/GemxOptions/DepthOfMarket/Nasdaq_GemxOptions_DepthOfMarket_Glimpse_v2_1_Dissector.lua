...
omi_nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.fields.session = ProtoField.new("Session", "nasdaq.gemxoptions.depthofmarket.glimpse.v2.1.session", ftypes.STRING)
...
-- Session
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session = {}

-- Size: Session
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.size = 10

-- Display: Session
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.display = function(value)
  return "Session: "..value
end

-- Dissect: Session
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.fields.session, range, value, display)
...
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.snapshot_message.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.sequence_number.current = sequence_number

  if not packet.visited then
    nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.conversation.current.sequence_number.last = sequence_number
  end
  ...
  if flow ~= nil then
    ...
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.sequence_number.current)
      end
...
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.login_accepted_packet.size =
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.size + 
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.sequence_number.size
...
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, session = nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.session.dissect(buffer, index, packet, parent)
...
nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.server_packet.dissect = function(buffer, packet, parent)
  ...
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.sequence_number.current = data.sequence_number.frames[packet.number]
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.sequence_number.current = data.sequence_number.frames[packet.number]
...
function omi_nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.init()
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.sequence_number.current = nil
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.conversation.current = nil
  nasdaq_gemxoptions_depthofmarket_glimpse_v2_1.conversation.flows = {}
end
