...
local omi_nasdaq_nsmequities_level2_itch_v2_0 = Proto("Omi.Nasdaq.NsmEquities.Level2.Itch.v2.0", "Nasdaq NsmEquities Level2 Itch 2.0")
...
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.current_trading_state = ProtoField.new("Current Trading State", "nasdaq.nsmequities.level2.itch.v2.0.currenttradingstate", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.etp_flag = ProtoField.new("Etp Flag", "nasdaq.nsmequities.level2.itch.v2.0.etpflag", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.etp_leverage_factor = ProtoField.new("Etp Leverage Factor", "nasdaq.nsmequities.level2.itch.v2.0.etpleveragefactor", ftypes.UINT32)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.event_code = ProtoField.new("Event Code", "nasdaq.nsmequities.level2.itch.v2.0.eventcode", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.financial_status_indicator = ProtoField.new("Financial Status Indicator", "nasdaq.nsmequities.level2.itch.v2.0.financialstatusindicator", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.interest_flag = ProtoField.new("Interest Flag", "nasdaq.nsmequities.level2.itch.v2.0.interestflag", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.inverse_indicator = ProtoField.new("Inverse Indicator", "nasdaq.nsmequities.level2.itch.v2.0.inverseindicator", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.ipo_flag = ProtoField.new("Ipo Flag", "nasdaq.nsmequities.level2.itch.v2.0.ipoflag", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.ipo_price = ProtoField.new("Ipo Price", "nasdaq.nsmequities.level2.itch.v2.0.ipoprice", ftypes.DOUBLE)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.ipo_quotation_release_qualifier = ProtoField.new("Ipo Quotation Release Qualifier", "nasdaq.nsmequities.level2.itch.v2.0.ipoquotationreleasequalifier", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.ipo_quotation_release_time = ProtoField.new("Ipo Quotation Release Time", "nasdaq.nsmequities.level2.itch.v2.0.ipoquotationreleasetime", ftypes.UINT32)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.issue_classification = ProtoField.new("Issue Classification", "nasdaq.nsmequities.level2.itch.v2.0.issueclassification", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.issue_subtype = ProtoField.new("Issue Subtype", "nasdaq.nsmequities.level2.itch.v2.0.issuesubtype", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.level_1 = ProtoField.new("Level 1", "nasdaq.nsmequities.level2.itch.v2.0.level1", ftypes.DOUBLE)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.level_2 = ProtoField.new("Level 2", "nasdaq.nsmequities.level2.itch.v2.0.level2", ftypes.DOUBLE)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.level_3 = ProtoField.new("Level 3", "nasdaq.nsmequities.level2.itch.v2.0.level3", ftypes.DOUBLE)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.luld_reference_price_tier = ProtoField.new("Luld Reference Price Tier", "nasdaq.nsmequities.level2.itch.v2.0.luldreferencepricetier", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.market_category = ProtoField.new("Market Category", "nasdaq.nsmequities.level2.itch.v2.0.marketcategory", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.market_code = ProtoField.new("Market Code", "nasdaq.nsmequities.level2.itch.v2.0.marketcode", ftypes.STRING)
...
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.sequence_number = ProtoField.new("Sequence Number", "nasdaq.nsmequities.level2.itch.v2.0.sequencenumber", ftypes.UINT64)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.session = ProtoField.new("Session", "nasdaq.nsmequities.level2.itch.v2.0.session", ftypes.STRING)
omi_nasdaq_nsmequities_level2_itch_v2_0.fields.short_sale_threshold_indicator = ProtoField.new("Short Sale Threshold Indicator", "nasdaq.nsmequities.level2.itch.v2.0.shortsalethresholdindicator", ftypes.STRING)
...
-----------------------------------------------------------------------
-- Nasdaq NsmEquities Level2 Itch 2.0 Formatting
-----------------------------------------------------------------------
...
nasdaq_nsmequities_level2_itch_v2_0.timestamp_format = 2
...
omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")

omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_nsmequities_level2_itch_v2_0.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_headers then
    show.headers = omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_structs then
    show.structs = omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_indexes then
    show.indexes = omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_sequences then
    show.sequences = omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.show_sequences
  end
  ...
  if nasdaq_nsmequities_level2_itch_v2_0.utc_offset_hours ~= omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.utc_offset_hours then
    nasdaq_nsmequities_level2_itch_v2_0.utc_offset_hours = omi_nasdaq_nsmequities_level2_itch_v2_0.prefs.utc_offset_hours
  end
end
...
-- Size: Ipo Price
nasdaq_nsmequities_level2_itch_v2_0.ipo_price.size = 4

-- Display: Ipo Price
nasdaq_nsmequities_level2_itch_v2_0.ipo_price.display = function(value)
...
-- Dissect: Ipo Price
nasdaq_nsmequities_level2_itch_v2_0.ipo_price.dissect = function(buffer, offset, packet, parent)
...
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_qualifier = {}

-- Size: Ipo Quotation Release Qualifier
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_qualifier.size = 1

-- Display: Ipo Quotation Release Qualifier
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_qualifier.display = function(value)
  if value == "A" then
...
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_qualifier.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_qualifier.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_qualifier.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.ipo_quotation_release_qualifier, range, value, display)

  return offset + length, value
end

-- Ipo Quotation Release Time
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_time = {}

-- Size: Ipo Quotation Release Time
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_time.size = 4

-- Display: Ipo Quotation Release Time
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_time.display = function(value)
  return "Ipo Quotation Release Time: "..value
end

-- Dissect: Ipo Quotation Release Time
nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_time.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_time.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_nsmequities_level2_itch_v2_0.ipo_quotation_release_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.ipo_quotation_release_time, range, value, display)
...
-- Issue Subtype
nasdaq_nsmequities_level2_itch_v2_0.issue_subtype = {}

-- Size: Issue Subtype
nasdaq_nsmequities_level2_itch_v2_0.issue_subtype.size = 2

-- Display: Issue Subtype
nasdaq_nsmequities_level2_itch_v2_0.issue_subtype.display = function(value)
  if value == "A" then
...
nasdaq_nsmequities_level2_itch_v2_0.issue_subtype.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_level2_itch_v2_0.issue_subtype.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_nsmequities_level2_itch_v2_0.issue_subtype.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.issue_subtype, range, value, display)
...
-- Market Category
nasdaq_nsmequities_level2_itch_v2_0.market_category = {}

-- Size: Market Category
nasdaq_nsmequities_level2_itch_v2_0.market_category.size = 1

-- Display: Market Category
nasdaq_nsmequities_level2_itch_v2_0.market_category.display = function(value)
  if value == "Q" then
...
nasdaq_nsmequities_level2_itch_v2_0.market_category.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_level2_itch_v2_0.market_category.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nsmequities_level2_itch_v2_0.market_category.display(value, buffer, offset, packet, parent)
...
-- Display: Timestamp
nasdaq_nsmequities_level2_itch_v2_0.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_nsmequities_level2_itch_v2_0.timestamp_format == 0 then
  ...
  if nasdaq_nsmequities_level2_itch_v2_0.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_nsmequities_level2_itch_v2_0.utc_offset_hours * 3600
...
nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message = {}

-- Size: Stock Directory Message
nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message.size =
  nasdaq_nsmequities_level2_itch_v2_0.tracking_number.size + 
  nasdaq_nsmequities_level2_itch_v2_0.timestamp.size + 
  nasdaq_nsmequities_level2_itch_v2_0.stock.size + 
  nasdaq_nsmequities_level2_itch_v2_0.market_category.size + 
  nasdaq_nsmequities_level2_itch_v2_0.financial_status_indicator.size + 
  nasdaq_nsmequities_level2_itch_v2_0.round_lot_size.size + 
  nasdaq_nsmequities_level2_itch_v2_0.round_lots_only.size + 
  nasdaq_nsmequities_level2_itch_v2_0.issue_classification.size + 
  nasdaq_nsmequities_level2_itch_v2_0.issue_subtype.size + 
  nasdaq_nsmequities_level2_itch_v2_0.authenticity.size + 
  nasdaq_nsmequities_level2_itch_v2_0.short_sale_threshold_indicator.size + 
  nasdaq_nsmequities_level2_itch_v2_0.ipo_flag.size + 
  nasdaq_nsmequities_level2_itch_v2_0.luld_reference_price_tier.size + 
  nasdaq_nsmequities_level2_itch_v2_0.etp_flag.size + 
  nasdaq_nsmequities_level2_itch_v2_0.etp_leverage_factor.size + 
  nasdaq_nsmequities_level2_itch_v2_0.inverse_indicator.size

-- Display: Stock Directory Message
nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_nsmequities_level2_itch_v2_0.system_event_message.size =
  nasdaq_nsmequities_level2_itch_v2_0.tracking_number.size + 
  nasdaq_nsmequities_level2_itch_v2_0.timestamp.size + 
  nasdaq_nsmequities_level2_itch_v2_0.event_code.size

-- Display: System Event Message
nasdaq_nsmequities_level2_itch_v2_0.system_event_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_nsmequities_level2_itch_v2_0.system_event_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_level2_itch_v2_0.system_event_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_level2_itch_v2_0.system_event_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_nsmequities_level2_itch_v2_0.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == "R" then
    return nasdaq_nsmequities_level2_itch_v2_0.stock_directory_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stock Trading Action Message
  ...
  if message_type == "K" then
    return nasdaq_nsmequities_level2_itch_v2_0.ipo_quoting_period_update_message.dissect(buffer, offset, packet, parent)
  end
...
-- Message Header
nasdaq_nsmequities_level2_itch_v2_0.message_header = {}

-- Size: Message Header
nasdaq_nsmequities_level2_itch_v2_0.message_header.size =
  nasdaq_nsmequities_level2_itch_v2_0.message_length.size + 
  nasdaq_nsmequities_level2_itch_v2_0.message_type.size

-- Display: Message Header
nasdaq_nsmequities_level2_itch_v2_0.message_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message Header
nasdaq_nsmequities_level2_itch_v2_0.message_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = nasdaq_nsmequities_level2_itch_v2_0.message_length.dissect(buffer, index, packet, parent)

  -- Message Type: 1 Byte Ascii String Enum with 11 values
  index, message_type = nasdaq_nsmequities_level2_itch_v2_0.message_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Header
nasdaq_nsmequities_level2_itch_v2_0.message_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.message_header, buffer(offset, 0))
    local index = nasdaq_nsmequities_level2_itch_v2_0.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_level2_itch_v2_0.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_level2_itch_v2_0.message_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_nsmequities_level2_itch_v2_0.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset

  -- Implicit Message Index
  if message_index ~= nil and show.indexes then
    local iteration = parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.message_index, message_index)
    iteration:set_generated()
  end

  -- Implicit Message Sequence Number
  if message_index ~= nil and show.sequences and nasdaq_nsmequities_level2_itch_v2_0.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.message_sequence_number, UInt64.new(nasdaq_nsmequities_level2_itch_v2_0.sequence + message_index - 1))
    sequence:set_generated()
  end

  -- Message Header: Struct of 2 fields
  index, message_header = nasdaq_nsmequities_level2_itch_v2_0.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Message Type
  local message_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 11 branches
  index = nasdaq_nsmequities_level2_itch_v2_0.payload.dissect(buffer, index, packet, parent, message_type)
...
-- End Of Session
nasdaq_nsmequities_level2_itch_v2_0.end_of_session = {}

-- Display: End Of Session
nasdaq_nsmequities_level2_itch_v2_0.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_nsmequities_level2_itch_v2_0.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nsmequities_level2_itch_v2_0.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_nsmequities_level2_itch_v2_0.heartbeat = {}

-- Display: Heartbeat
nasdaq_nsmequities_level2_itch_v2_0.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_nsmequities_level2_itch_v2_0.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nsmequities_level2_itch_v2_0.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_nsmequities_level2_itch_v2_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_nsmequities_level2_itch_v2_0.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
...
-- Packet Header
nasdaq_nsmequities_level2_itch_v2_0.packet_header = {}

-- Size: Packet Header
nasdaq_nsmequities_level2_itch_v2_0.packet_header.size =
  nasdaq_nsmequities_level2_itch_v2_0.session.size + 
  nasdaq_nsmequities_level2_itch_v2_0.sequence_number.size + 
  nasdaq_nsmequities_level2_itch_v2_0.message_count.size

-- Display: Packet Header
nasdaq_nsmequities_level2_itch_v2_0.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
nasdaq_nsmequities_level2_itch_v2_0.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = nasdaq_nsmequities_level2_itch_v2_0.session.dissect(buffer, index, packet, parent)

  -- Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, sequence_number = nasdaq_nsmequities_level2_itch_v2_0.sequence_number.dissect(buffer, index, packet, parent)

  -- Message Count: 2 Byte Unsigned Fixed Width Integer
  index, message_count = nasdaq_nsmequities_level2_itch_v2_0.message_count.dissect(buffer, index, packet, parent)

  -- Sequence base for the packet's messages
  nasdaq_nsmequities_level2_itch_v2_0.sequence = sequence_number

  return index
end

-- Dissect: Packet Header
nasdaq_nsmequities_level2_itch_v2_0.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0.fields.packet_header, buffer(offset, 0))
    local index = nasdaq_nsmequities_level2_itch_v2_0.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_level2_itch_v2_0.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_level2_itch_v2_0.packet_header.fields(buffer, offset, packet, parent)
  end
end
...
-- Dissect Packet
nasdaq_nsmequities_level2_itch_v2_0.packet.dissect = function(buffer, packet, parent)
  local index = 0
...
function omi_nasdaq_nsmequities_level2_itch_v2_0.init()
end
...
function omi_nasdaq_nsmequities_level2_itch_v2_0.dissector(buffer, packet, parent)
  ...
  -- Dissect protocol
  local protocol = parent:add(omi_nasdaq_nsmequities_level2_itch_v2_0, buffer(), omi_nasdaq_nsmequities_level2_itch_v2_0.description, "("..buffer:len().." Bytes)")
...
-- Dissector Heuristic for Nasdaq NsmEquities Level2 Itch 2.0 (Udp)
local function omi_nasdaq_nsmequities_level2_itch_v2_0_udp_heuristic(buffer, packet, parent)
  ...
  omi_nasdaq_nsmequities_level2_itch_v2_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Nasdaq NsmEquities Level2 Itch 2.0
omi_nasdaq_nsmequities_level2_itch_v2_0:register_heuristic("udp", omi_nasdaq_nsmequities_level2_itch_v2_0_udp_heuristic)

-- Register Nasdaq NsmEquities Level2 Itch 2.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_nsmequities_level2_itch_v2_0)
