...
omi_nasdaq_nomoptions_itto_itch_v4_0.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.nomoptions.itto.itch.v4.0.clientpackettype", ftypes.STRING)
...
omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
...
function omi_nasdaq_nomoptions_itto_itch_v4_0.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_headers then
    show.headers = omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_headers
  end
  ...
  if show.structs ~= omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_structs then
    show.structs = omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_indexes then
    show.indexes = omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_sequences then
    show.sequences = omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.show_sequences
  end
...
-- Client Packet Type
nasdaq_nomoptions_itto_itch_v4_0.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_nomoptions_itto_itch_v4_0.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_nomoptions_itto_itch_v4_0.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_nomoptions_itto_itch_v4_0.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nomoptions_itto_itch_v4_0.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nomoptions_itto_itch_v4_0.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nomoptions_itto_itch_v4_0.fields.client_packet_type, range, value, display)
...
-- Server Packet Type
nasdaq_nomoptions_itto_itch_v4_0.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_nomoptions_itto_itch_v4_0.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_nomoptions_itto_itch_v4_0.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_nomoptions_itto_itch_v4_0.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nomoptions_itto_itch_v4_0.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nomoptions_itto_itch_v4_0.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nomoptions_itto_itch_v4_0.fields.server_packet_type, range, value, display)
...
-- Unsequenced Message
nasdaq_nomoptions_itto_itch_v4_0.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_nomoptions_itto_itch_v4_0.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_nomoptions_itto_itch_v4_0.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_nomoptions_itto_itch_v4_0.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_nomoptions_itto_itch_v4_0.fields.unsequenced_message, range, value, display)
...
nasdaq_nomoptions_itto_itch_v4_0.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, server_packet_type = nasdaq_nomoptions_itto_itch_v4_0.server_packet_type.dissect(buffer, index, packet, parent)
...
nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end
...
nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_nomoptions_itto_itch_v4_0.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
nasdaq_nomoptions_itto_itch_v4_0.server_tcp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_nomoptions_itto_itch_v4_0.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
nasdaq_nomoptions_itto_itch_v4_0.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, client_packet_type = nasdaq_nomoptions_itto_itch_v4_0.client_packet_type.dissect(buffer, index, packet, parent)
...
nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end
...
nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_nomoptions_itto_itch_v4_0.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
nasdaq_nomoptions_itto_itch_v4_0.client_tcp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_nomoptions_itto_itch_v4_0.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
nasdaq_nomoptions_itto_itch_v4_0.role = function(packet)
  if omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.assume_role == 1 then
    return "initiator"
  end
  if omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.assume_role == 2 then
    return "acceptor"
  end
  local port = omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.acceptor_port
  ...
  if omi_nasdaq_nomoptions_itto_itch_v4_0.prefs.swap_sides then
    first = not first
  end
  if swapped[key] then
    first = not first
...
nasdaq_nomoptions_itto_itch_v4_0.swap = function(packet)
  local key = conversation(packet)
...
local function omi_nasdaq_nomoptions_itto_itch_v4_0_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_nomoptions_itto_itch_v4_0.role(packet)
  local first, second = omi_nasdaq_nomoptions_itto_itch_v4_0_tcp_initiator_heuristic, omi_nasdaq_nomoptions_itto_itch_v4_0_tcp_acceptor_heuristic
  ...
  nasdaq_nomoptions_itto_itch_v4_0.swap(packet)
