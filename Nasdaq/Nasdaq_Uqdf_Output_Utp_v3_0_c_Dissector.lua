...
function omi_nasdaq_uqdf_output_utp_v3_0_c.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_uqdf_output_utp_v3_0_c.prefs.show_headers then
    show.headers = omi_nasdaq_uqdf_output_utp_v3_0_c.prefs.show_headers
  end
...
-- End Of Session
nasdaq_uqdf_output_utp_v3_0_c.end_of_session = {}

-- Display: End Of Session
nasdaq_uqdf_output_utp_v3_0_c.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_uqdf_output_utp_v3_0_c.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_uqdf_output_utp_v3_0_c.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_uqdf_output_utp_v3_0_c.heartbeat = {}

-- Display: Heartbeat
nasdaq_uqdf_output_utp_v3_0_c.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_uqdf_output_utp_v3_0_c.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_uqdf_output_utp_v3_0_c.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_uqdf_output_utp_v3_0_c.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_uqdf_output_utp_v3_0_c.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
