...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.server_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.phlxoptions.topofmarket.itch.v2.1.servertcppacketheader", ftypes.STRING)
...
-- Server Tcp Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_payload = {}

-- Dissect: Server Tcp Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header = {}

-- Size: Server Tcp Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.size =
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Tcp Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  ...
  index, server_tcp_packet_header = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_payload.dissect(buffer, index, packet, parent, server_packet_type)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.size then
...
-- Server Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet_header.size
end

-- Dissect Server Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet.dissect = function(buffer, packet, parent)
...
-- Client Tcp Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_payload = {}

-- Dissect: Client Tcp Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header = {}

-- Size: Client Tcp Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.size =
  nasdaq_phlxoptions_topofmarket_itch_v2_1.packet_length.size + 
  nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.size

-- Display: Client Tcp Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Tcp Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  ...
  index, client_tcp_packet_header = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_payload.dissect(buffer, index, packet, parent, client_packet_type)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet_header.size
end

-- Dissect Client Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
...
function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    ...
    if role == "initiator" then
      return nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet.dissect(buffer, packet, protocol)
    end

    return nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet.dissect(buffer, packet, protocol)
  end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet.fingerprint = function(buffer)
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  ...
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.client_tcp_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.server_tcp_packet.fingerprint(buffer) then return false end
