...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.phlxoptions.topofmarket.itch.v2.1.clientpackettype", ftypes.STRING)
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.debug_text = ProtoField.new("Debug Text", "nasdaq.phlxoptions.topofmarket.itch.v2.1.debugtext", ftypes.STRING)
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.client_packet = ProtoField.new("Tcp Packet", "nasdaq.phlxoptions.topofmarket.itch.v2.1.clientpacket", ftypes.STRING)
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.client_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.phlxoptions.topofmarket.itch.v2.1.clientpacketheader", ftypes.STRING)
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.end_of_session = ProtoField.new("End Of Session", "nasdaq.phlxoptions.topofmarket.itch.v2.1.endofsession", ftypes.BYTES)
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.heartbeat = ProtoField.new("Heartbeat", "nasdaq.phlxoptions.topofmarket.itch.v2.1.heartbeat", ftypes.BYTES)
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nasdaq.phlxoptions.topofmarket.itch.v2.1.messagesequencenumber", ftypes.UINT64)
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.sequenced_data_packet_sequence_number = ProtoField.new("Sequenced Data Packet Sequence Number", "nasdaq.phlxoptions.topofmarket.itch.v2.1.sequenceddatapacketsequencenumber", ftypes.UINT64)
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
...
function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs_changed()
  ...
  if show.sequences ~= omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_sequences
  end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation = {}
nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.flows = {}
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_frame = nil
nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_occurrence = 0

-- Conversation key for the current packet (src/dst tuple)
nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.data = function(packet)
  local key = nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.key(packet)
  local data = nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.flows[key]
  if data == nil then
    data = { accepted_sequence_number = { last = nil, frames = {} }, sequence = { next = nil, frames = {} } }
    nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.current = nil
...
-- Client Packet Type
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.client_packet_type, range, value, display)
...
-- Debug Text
nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text = {}

-- Size: Debug Text
nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.size = 1

-- Display: Debug Text
nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.display = function(value)
  return "Debug Text: "..value
end

-- Dissect: Debug Text
nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.debug_text, range, value, display)
...
-- Server Packet Type
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
...
-- Unsequenced Message
nasdaq_phlxoptions_topofmarket_itch_v2_1.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_phlxoptions_topofmarket_itch_v2_1.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_phlxoptions_topofmarket_itch_v2_1.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.unsequenced_message, range, value, display)
...
-- Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.packet = {}
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.end_of_session_packet = {}

-- Display: End Of Session Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.end_of_session_packet.display = function(packet, parent, length)
  return "End Of Session Packet"
end


-- Dissect: End Of Session Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.end_of_session_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.end_of_session_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_heartbeat_packet = {}

-- Display: Server Heartbeat Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_heartbeat_packet.display = function(packet, parent, length)
  return "Server Heartbeat Packet"
end


-- Dissect: Server Heartbeat Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  local flow = nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.current
  if flow ~= nil then
    local memo = flow.sequence.frames[packet.number]
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_phlxoptions_topofmarket_itch_v2_1.accepted_sequence_number.current)
      end
      ...
      if value ~= nil then
        ...
        if show.sequences then
          local sequence = parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.sequenced_data_packet_sequence_number, UInt64.new(value))
          sequence:set_generated()
        end
      end
    else
      if memo ~= nil and #memo > 0 then
        if nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_frame ~= packet.number or nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_occurrence >= #memo then
          nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_frame = packet.number
          nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_occurrence = 0
        end
        nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_occurrence = nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_occurrence + 1
        local value = memo[nasdaq_phlxoptions_topofmarket_itch_v2_1.stream_occurrence]
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_phlxoptions_topofmarket_itch_v2_1.accepted_sequence_number.current = accepted_sequence_number

  if not packet.visited then
    nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.current.accepted_sequence_number.last = accepted_sequence_number
  end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_packet.size =
  nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.size
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, debug_text = nasdaq_phlxoptions_topofmarket_itch_v2_1.debug_text.dissect(buffer, index, packet, parent)
...
-- Server Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_payload = {}

-- Dissect: Server Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
  ...
  if server_packet_type == "H" then
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.server_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session Packet
  if server_packet_type == "Z" then
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.end_of_session_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header = {}

-- Size: Server Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.size =
  nasdaq_phlxoptions_topofmarket_itch_v2_1.packet_length.size + 
  nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type.size

-- Display: Server Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Server Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.server_packet_header, buffer(offset, 0))
    local index = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Packet Header: Struct of 2 fields
  index, server_packet_header = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.size then
...
-- Server Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet = {}

-- Verify required size of Tcp packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet_header.size
end

-- Dissect Server Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.data(packet)
  if not packet.visited then
    data.accepted_sequence_number.frames[packet.number] = data.accepted_sequence_number.last
  end
  nasdaq_phlxoptions_topofmarket_itch_v2_1.accepted_sequence_number.current = data.accepted_sequence_number.frames[packet.number]
  nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.current = data
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_phlxoptions_topofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.logout_request_packet = {}

-- Display: Logout Request Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.logout_request_packet.display = function(packet, parent, length)
  return "Logout Request Packet"
end


-- Dissect: Logout Request Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.logout_request_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.logout_request_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_heartbeat_packet = {}

-- Display: Client Heartbeat Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_heartbeat_packet.display = function(packet, parent, length)
  return "Client Heartbeat Packet"
end


-- Dissect: Client Heartbeat Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
-- Client Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_payload = {}

-- Dissect: Client Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
  ...
  if client_packet_type == "R" then
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.client_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request Packet
  if client_packet_type == "O" then
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.logout_request_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header = {}

-- Size: Client Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.size =
  nasdaq_phlxoptions_topofmarket_itch_v2_1.packet_length.size + 
  nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.size

-- Display: Client Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Client Packet Header
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.client_packet_header, buffer(offset, 0))
    local index = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Packet Header: Struct of 2 fields
  index, client_packet_header = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet = {}

-- Verify required size of Tcp packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet_header.size
end

-- Dissect Client Packet
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_phlxoptions_topofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.init()
  nasdaq_phlxoptions_topofmarket_itch_v2_1.accepted_sequence_number.current = nil
  nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.current = nil
  nasdaq_phlxoptions_topofmarket_itch_v2_1.conversation.flows = {}
end

-- Connection roles for Nasdaq PhlxOptions TopOfMarket Itch 2.1: Client is the initiator, Server is the acceptor
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.role = function(packet)
  if omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.assume_role == 1 then
    return "initiator"
  end

  if omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.assume_role == 2 then
    return "acceptor"
  end

  local acceptor_port = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.acceptor_port
  ...
  if omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.swap_sides then
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.swap = function(packet)
  local key = conversation(packet)
...
function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    local role = nasdaq_phlxoptions_topofmarket_itch_v2_1.role(packet)

    if role == "initiator" then
      return nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet.dissect(buffer, packet, protocol)
    end

    return nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet.dissect(buffer, packet, protocol)
  end

  if packet.port_type == 3 then
    return nasdaq_phlxoptions_topofmarket_itch_v2_1.packet.dissect(buffer, packet, protocol)
  end
end
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet.fingerprint = function(buffer)
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.client_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq PhlxOptions TopOfMarket Itch 2.1 (Tcp)
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.server_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_udp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_phlxoptions_topofmarket_itch_v2_1.packet.requiredsize(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq PhlxOptions TopOfMarket Itch 2.1 (Tcp): apply the heuristic of the sender's connection role
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_phlxoptions_topofmarket_itch_v2_1.role(packet)
  local initiator = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_initiator_heuristic
  local acceptor = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_tcp_acceptor_heuristic
  ...
  nasdaq_phlxoptions_topofmarket_itch_v2_1.swap(packet)
...
-- Register Nasdaq PhlxOptions TopOfMarket Itch 2.1 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1)

-- Register Nasdaq PhlxOptions TopOfMarket Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_phlxoptions_topofmarket_itch_v2_1)
