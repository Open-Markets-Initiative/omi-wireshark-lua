...
omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")

omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.timestamp_format = Pref.enum("Nanoseconds Format", 2, "Nanoseconds display format", timestamp_format_enum, false)
...
function omi_nasdaq_nomoptions_bono_itch_v3_2.prefs_changed()
  ...
  if show.application_messages ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_application_messages then
    show.application_messages = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_application_messages
  end
  if show.headers ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_headers then
    show.headers = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_structs then
    show.structs = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_indexes then
    show.indexes = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_sequences then
    show.sequences = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.show_sequences
  end
  if nasdaq_nomoptions_bono_itch_v3_2.format_timestamp ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.format_timestamp then
    nasdaq_nomoptions_bono_itch_v3_2.format_timestamp = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.format_timestamp
  end
  if nasdaq_nomoptions_bono_itch_v3_2.timestamp_format ~= omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.timestamp_format then
    nasdaq_nomoptions_bono_itch_v3_2.timestamp_format = omi_nasdaq_nomoptions_bono_itch_v3_2.prefs.timestamp_format
  end
...
nasdaq_nomoptions_bono_itch_v3_2.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_nomoptions_bono_itch_v3_2.conversation.data = function(packet)
  local key = nasdaq_nomoptions_bono_itch_v3_2.conversation.key(packet)
  local data = nasdaq_nomoptions_bono_itch_v3_2.conversation.flows[key]
  if data == nil then
    data = { second = { last = nil, frames = {} } }
    nasdaq_nomoptions_bono_itch_v3_2.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_nomoptions_bono_itch_v3_2.conversation.current = nil
...
-- Store: Second
nasdaq_nomoptions_bono_itch_v3_2.second.current = nil
...
nasdaq_nomoptions_bono_itch_v3_2.timestamp.display = function(nanoseconds, stored_second, packet)
  -- Raw display mode
  if nasdaq_nomoptions_bono_itch_v3_2.timestamp_format == 0 then
    return "Timestamp: "..(stored_second * 1000000000 + nanoseconds)
  end

  -- Full datetime mode (calculate from capture date + UTC offset)
  if nasdaq_nomoptions_bono_itch_v3_2.timestamp_format == 2 and packet then
...
nasdaq_nomoptions_bono_itch_v3_2.timestamp.composite = function(buffer, offset, stored_second, packet, parent)
  ...
  local display = nasdaq_nomoptions_bono_itch_v3_2.timestamp.display(nanoseconds, stored_second, packet)
...
nasdaq_nomoptions_bono_itch_v3_2.timestamp.dissect = function(buffer, offset, packet, parent)
  if nasdaq_nomoptions_bono_itch_v3_2.format_timestamp then
    local stored_second = nasdaq_nomoptions_bono_itch_v3_2.second.current
...
nasdaq_nomoptions_bono_itch_v3_2.timestamp_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Second Value
  nasdaq_nomoptions_bono_itch_v3_2.second.current = second

  if not packet.visited then
    nasdaq_nomoptions_bono_itch_v3_2.conversation.current.second.last = second
  end
...
nasdaq_nomoptions_bono_itch_v3_2.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_nomoptions_bono_itch_v3_2.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_nomoptions_bono_itch_v3_2.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_nomoptions_bono_itch_v3_2.fields.message_sequence_number, UInt64.new(nasdaq_nomoptions_bono_itch_v3_2.sequence + message_index - 1))
...
nasdaq_nomoptions_bono_itch_v3_2.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_nomoptions_bono_itch_v3_2.message.size(buffer, offset)
...
-- End Of Session
nasdaq_nomoptions_bono_itch_v3_2.end_of_session = {}

-- Display: End Of Session
nasdaq_nomoptions_bono_itch_v3_2.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_nomoptions_bono_itch_v3_2.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nomoptions_bono_itch_v3_2.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_nomoptions_bono_itch_v3_2.heartbeat = {}

-- Display: Heartbeat
nasdaq_nomoptions_bono_itch_v3_2.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_nomoptions_bono_itch_v3_2.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nomoptions_bono_itch_v3_2.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_nomoptions_bono_itch_v3_2.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_nomoptions_bono_itch_v3_2.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_nomoptions_bono_itch_v3_2.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
nasdaq_nomoptions_bono_itch_v3_2.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_nomoptions_bono_itch_v3_2.sequence = sequence_number
...
nasdaq_nomoptions_bono_itch_v3_2.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nomoptions_bono_itch_v3_2.packet_header.size
end

-- Dissect Packet
nasdaq_nomoptions_bono_itch_v3_2.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_nomoptions_bono_itch_v3_2.conversation.data(packet)
  if not packet.visited then
    data.second.frames[packet.number] = data.second.last
  end
  nasdaq_nomoptions_bono_itch_v3_2.second.current = data.second.frames[packet.number]
  nasdaq_nomoptions_bono_itch_v3_2.conversation.current = data
  ...
  index = nasdaq_nomoptions_bono_itch_v3_2.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq NomOptions Bono Itch 3.2 (Udp)
local function omi_nasdaq_nomoptions_bono_itch_v3_2_udp_heuristic(buffer, packet, parent)
...
-- Register Nasdaq NomOptions Bono Itch 3.2 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_nomoptions_bono_itch_v3_2)
