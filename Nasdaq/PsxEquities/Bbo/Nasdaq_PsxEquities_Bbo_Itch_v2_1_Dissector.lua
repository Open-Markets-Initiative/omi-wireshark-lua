...
local omi_nasdaq_psxequities_bbo_itch_v2_1 = Proto("Omi.Nasdaq.PsxEquities.Bbo.Itch.v2.1", "Nasdaq PsxEquities Bbo Itch 2.1")
...
-- Nasdaq PsxEquities Bbo Itch 2.1 Framing
...
-- Nasdaq PsxEquities Bbo 2.1 Session Messages
omi_nasdaq_psxequities_bbo_itch_v2_1.fields.end_of_session = ProtoField.new("End Of Session", "nasdaq.psxequities.bbo.itch.v2.1.endofsession", ftypes.BYTES)
omi_nasdaq_psxequities_bbo_itch_v2_1.fields.heartbeat = ProtoField.new("Heartbeat", "nasdaq.psxequities.bbo.itch.v2.1.heartbeat", ftypes.BYTES)

-- Nasdaq PsxEquities Bbo 2.1 Application Messages
...
omi_nasdaq_psxequities_bbo_itch_v2_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nasdaq.psxequities.bbo.itch.v2.1.messagesequencenumber", ftypes.UINT64)

-----------------------------------------------------------------------
-- Nasdaq PsxEquities Bbo Itch 2.1 Formatting
-----------------------------------------------------------------------
...
nasdaq_psxequities_bbo_itch_v2_1.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_psxequities_bbo_itch_v2_1.utc_offset_hours = 5
...
omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_psxequities_bbo_itch_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_headers then
    show.headers = omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_structs then
    show.structs = omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_psxequities_bbo_itch_v2_1.prefs.show_sequences
  end
...
nasdaq_psxequities_bbo_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_psxequities_bbo_itch_v2_1.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_psxequities_bbo_itch_v2_1.fields.message_sequence_number, UInt64.new(nasdaq_psxequities_bbo_itch_v2_1.sequence + message_index - 1))
...
-- End Of Session
nasdaq_psxequities_bbo_itch_v2_1.end_of_session = {}

-- Display: End Of Session
nasdaq_psxequities_bbo_itch_v2_1.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_psxequities_bbo_itch_v2_1.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_psxequities_bbo_itch_v2_1.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_psxequities_bbo_itch_v2_1.heartbeat = {}

-- Display: Heartbeat
nasdaq_psxequities_bbo_itch_v2_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_psxequities_bbo_itch_v2_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_psxequities_bbo_itch_v2_1.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_psxequities_bbo_itch_v2_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_psxequities_bbo_itch_v2_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_psxequities_bbo_itch_v2_1.end_of_session.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_psxequities_bbo_itch_v2_1.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_psxequities_bbo_itch_v2_1.sequence = sequence_number
...
nasdaq_psxequities_bbo_itch_v2_1.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_psxequities_bbo_itch_v2_1.packet_header.size
end
...
-- Dissector Heuristic for Nasdaq PsxEquities Bbo Itch 2.1 (Udp)
local function omi_nasdaq_psxequities_bbo_itch_v2_1_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_psxequities_bbo_itch_v2_1:register_heuristic("udp", omi_nasdaq_psxequities_bbo_itch_v2_1_udp_heuristic)

-- Register Nasdaq PsxEquities Bbo Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_psxequities_bbo_itch_v2_1)
