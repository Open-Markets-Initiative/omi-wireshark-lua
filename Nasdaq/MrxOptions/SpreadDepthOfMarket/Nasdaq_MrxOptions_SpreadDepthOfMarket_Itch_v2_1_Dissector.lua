...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.debug_text = ProtoField.new("Debug Text", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.debugtext", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clientpacket", ftypes.STRING)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clientpacketheader", ftypes.STRING)
...
-- Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.packet = {}
...
-- Server Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_payload = {}

-- Dissect: Server Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header = {}

-- Size: Server Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.size =
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.server_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  ...
  index, server_packet_header = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_payload.dissect(buffer, index, packet, parent, server_packet_type)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.size then
...
-- Server Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_header.size
end

-- Dissect Server Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet.dissect = function(buffer, packet, parent)
...
-- Client Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_payload = {}

-- Dissect: Client Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header = {}

-- Size: Client Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.size =
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.size

-- Display: Client Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  ...
  index, client_packet_header = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_payload.dissect(buffer, index, packet, parent, client_packet_type)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_header.size
end

-- Dissect Client Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet.dissect = function(buffer, packet, parent)
  local index = 0
...
function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    ...
    if role == "initiator" then
      return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet.dissect(buffer, packet, protocol)
    end

    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet.dissect(buffer, packet, protocol)
  end

  if packet.port_type == 3 then
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.packet.dissect(buffer, packet, protocol)
  end
end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet.fingerprint = function(buffer)
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  ...
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_udp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.packet.requiredsize(buffer) then return false end
