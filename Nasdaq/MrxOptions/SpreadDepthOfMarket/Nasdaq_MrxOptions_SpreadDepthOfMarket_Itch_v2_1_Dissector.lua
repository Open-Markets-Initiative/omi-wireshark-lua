...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clientpackettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.reserved_1 = ProtoField.new("Reserved 1", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.reserved1", ftypes.BYTES)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.reserved_16 = ProtoField.new("Reserved 16", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.reserved16", ftypes.BYTES)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.reserved_3 = ProtoField.new("Reserved 3", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.reserved3", ftypes.BYTES)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.reserved_4 = ProtoField.new("Reserved 4", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.reserved4", ftypes.BYTES)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.reserved_8 = ProtoField.new("Reserved 8", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.reserved8", ftypes.BYTES)
...
-- Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1 Framing
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clientsoupbintcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clienttcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clienttcppacketheader", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.server_tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.servertcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.server_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.servertcppacketheader", ftypes.STRING)
...
-- Nasdaq MrxOptions SpreadDepthOfMarket 2.1 Session Messages
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_heartbeat_packet = ProtoField.new("Client Heartbeat Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.clientheartbeatpacket", ftypes.BYTES)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.end_of_session = ProtoField.new("End Of Session", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.endofsession", ftypes.BYTES)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.end_of_session_packet = ProtoField.new("End Of Session Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.endofsessionpacket", ftypes.BYTES)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.heartbeat = ProtoField.new("Heartbeat", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.heartbeat", ftypes.BYTES)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.logout_request_packet = ProtoField.new("Logout Request Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.logoutrequestpacket", ftypes.BYTES)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.server_heartbeat_packet = ProtoField.new("Server Heartbeat Packet", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.serverheartbeatpacket", ftypes.BYTES)
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.messagesequencenumber", ftypes.UINT64)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.sequenced_data_packet_sequence_number = ProtoField.new("Sequenced Data Packet Sequence Number", "nasdaq.mrxoptions.spreaddepthofmarket.itch.v2.1.sequenceddatapacketsequencenumber", ftypes.UINT64)

-----------------------------------------------------------------------
-- Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1 Formatting
-----------------------------------------------------------------------
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.utc_offset_hours = 5
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.swap_sides = Pref.bool("Swap Sides", false, "The first frame seen of each conversation was the acceptor's, not the initiator's; for captures that start mid conversation")
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")

omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_headers then
    show.headers = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_headers
  end
  if show.repeating_groups ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_repeating_groups then
    show.repeating_groups = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_repeating_groups
  end
  ...
  if show.structs ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_structs then
    show.structs = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.show_sequences
  end
  if nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.timestamp_format ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.timestamp_format then
    nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.timestamp_format = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.timestamp_format
  end
  if nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.utc_offset_hours ~= omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.utc_offset_hours then
    nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.utc_offset_hours = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.utc_offset_hours
  end
end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation = {}
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.flows = {}
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_frame = nil
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_occurrence = 0

-- Conversation key for the current packet (src/dst tuple)
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.data = function(packet)
  local key = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.key(packet)
  local data = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.flows[key]
  if data == nil then
    data = { accepted_sequence_number = { last = nil, frames = {} }, sequence = { next = nil, frames = {} } }
    nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.current = nil
...
-- Client Packet Type
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_packet_type, range, value, display)
...
-- Server Packet Type
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
...
-- Display: Timestamp
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.timestamp_format == 0 then
  ...
  if nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.utc_offset_hours * 3600
...
-- Unsequenced Message
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.unsequenced_message, range, value, display)
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.end_of_session_packet = {}

-- Display: End Of Session Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.end_of_session_packet.display = function(packet, parent, length)
  return "End Of Session Packet"
end


-- Dissect: End Of Session Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.end_of_session_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.end_of_session_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_heartbeat_packet = {}

-- Display: Server Heartbeat Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_heartbeat_packet.display = function(packet, parent, length)
  return "Server Heartbeat Packet"
end


-- Dissect: Server Heartbeat Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  local flow = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.current
  if flow ~= nil then
    local memo = flow.sequence.frames[packet.number]
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.accepted_sequence_number.current)
      end
      ...
      if value ~= nil then
        ...
        if show.sequences then
          local sequence = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.sequenced_data_packet_sequence_number, UInt64.new(value))
          sequence:set_generated()
        end
      end
    else
      if memo ~= nil and #memo > 0 then
        if nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_frame ~= packet.number or nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_occurrence >= #memo then
          nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_frame = packet.number
          nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_occurrence = 0
        end
        nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_occurrence = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_occurrence + 1
        local value = memo[nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.stream_occurrence]
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.accepted_sequence_number.current = accepted_sequence_number

  if not packet.visited then
    nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.current.accepted_sequence_number.last = accepted_sequence_number
  end
...
-- Server Tcp Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_payload = {}

-- Dissect: Server Tcp Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
  ...
  if server_packet_type == "H" then
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session Packet
  if server_packet_type == "Z" then
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.end_of_session_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header = {}

-- Size: Server Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.size =
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type.size

-- Display: Server Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Server Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.server_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Tcp Packet Header: Struct of 2 fields
  index, server_tcp_packet_header = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.size then
...
-- Server Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet_header.size
end

-- Dissect Server Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.data(packet)
  if not packet.visited then
    data.accepted_sequence_number.frames[packet.number] = data.accepted_sequence_number.last
  end
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.accepted_sequence_number.current = data.accepted_sequence_number.frames[packet.number]
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.current = data
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.logout_request_packet = {}

-- Display: Logout Request Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.logout_request_packet.display = function(packet, parent, length)
  return "Logout Request Packet"
end


-- Dissect: Logout Request Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.logout_request_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.logout_request_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_heartbeat_packet = {}

-- Display: Client Heartbeat Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_heartbeat_packet.display = function(packet, parent, length)
  return "Client Heartbeat Packet"
end


-- Dissect: Client Heartbeat Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
-- Client Tcp Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_payload = {}

-- Dissect: Client Tcp Payload
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
  ...
  if client_packet_type == "R" then
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request Packet
  if client_packet_type == "O" then
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.logout_request_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header = {}

-- Size: Client Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.size =
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.size

-- Display: Client Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Client Tcp Packet Header
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Tcp Packet Header: Struct of 2 fields
  index, client_tcp_packet_header = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet_header.size
end

-- Dissect Client Tcp Packet
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.init()
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.accepted_sequence_number.current = nil
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.current = nil
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.conversation.flows = {}
end

-- Connection roles for Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1: Client is the initiator, Server is the acceptor
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.role = function(packet)
  if omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.assume_role == 1 then
    return "initiator"
  end

  if omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.assume_role == 2 then
    return "acceptor"
  end

  local acceptor_port = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.acceptor_port
  ...
  if omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.prefs.swap_sides then
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.swap = function(packet)
  local key = conversation(packet)
...
function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    local role = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.role(packet)

    if role == "initiator" then
      return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet.dissect(buffer, packet, protocol)
    end

    return nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet.dissect(buffer, packet, protocol)
  end
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet.fingerprint = function(buffer)
...
nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.client_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1 (Tcp)
local function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.server_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1 (Tcp): apply the heuristic of the sender's connection role
local function omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.role(packet)
  local initiator = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_initiator_heuristic
  local acceptor = omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1_tcp_acceptor_heuristic
  ...
  nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1.swap(packet)
...
-- Register Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1)

-- Register Nasdaq MrxOptions SpreadDepthOfMarket Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1)
