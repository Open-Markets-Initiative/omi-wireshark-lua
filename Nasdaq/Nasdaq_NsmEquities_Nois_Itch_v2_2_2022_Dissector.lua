...
local omi_nasdaq_nsmequities_nois_itch_v2_2_2022 = Proto("Omi.Nasdaq.NsmEquities.Nois.Itch.v2.2.2022", "Nasdaq NsmEquities Nois Itch 2.2.2022")
...
-- Nasdaq NsmEquities Nois Itch 2.2.2022 Framing
...
-- Nasdaq NsmEquities Nois 2.2.2022 Session Messages
omi_nasdaq_nsmequities_nois_itch_v2_2_2022.fields.end_of_session = ProtoField.new("End Of Session", "nasdaq.nsmequities.nois.itch.v2.2.2022.endofsession", ftypes.BYTES)
omi_nasdaq_nsmequities_nois_itch_v2_2_2022.fields.heartbeat = ProtoField.new("Heartbeat", "nasdaq.nsmequities.nois.itch.v2.2.2022.heartbeat", ftypes.BYTES)
...
-----------------------------------------------------------------------
-- Nasdaq NsmEquities Nois Itch 2.2.2022 Formatting
-----------------------------------------------------------------------
...
nasdaq_nsmequities_nois_itch_v2_2_2022.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_nsmequities_nois_itch_v2_2_2022.utc_offset_hours = 5
...
omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_headers then
    show.headers = omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_structs then
    show.structs = omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_indexes then
    show.indexes = omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.show_indexes
  end
  if nasdaq_nsmequities_nois_itch_v2_2_2022.timestamp_format ~= omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.timestamp_format then
    nasdaq_nsmequities_nois_itch_v2_2_2022.timestamp_format = omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.timestamp_format
  end
  if nasdaq_nsmequities_nois_itch_v2_2_2022.utc_offset_hours ~= omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.utc_offset_hours then
    nasdaq_nsmequities_nois_itch_v2_2_2022.utc_offset_hours = omi_nasdaq_nsmequities_nois_itch_v2_2_2022.prefs.utc_offset_hours
  end
end
...
-- Display: Timestamp
nasdaq_nsmequities_nois_itch_v2_2_2022.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_nsmequities_nois_itch_v2_2_2022.timestamp_format == 0 then
  ...
  if nasdaq_nsmequities_nois_itch_v2_2_2022.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_nsmequities_nois_itch_v2_2_2022.utc_offset_hours * 3600
...
-- End Of Session
nasdaq_nsmequities_nois_itch_v2_2_2022.end_of_session = {}

-- Display: End Of Session
nasdaq_nsmequities_nois_itch_v2_2_2022.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_nsmequities_nois_itch_v2_2_2022.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nsmequities_nois_itch_v2_2_2022.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_nsmequities_nois_itch_v2_2_2022.heartbeat = {}

-- Display: Heartbeat
nasdaq_nsmequities_nois_itch_v2_2_2022.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_nsmequities_nois_itch_v2_2_2022.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nsmequities_nois_itch_v2_2_2022.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_nsmequities_nois_itch_v2_2_2022.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_nsmequities_nois_itch_v2_2_2022.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_nsmequities_nois_itch_v2_2_2022.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
-- Register Nasdaq NsmEquities Nois Itch 2.2.2022 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_nsmequities_nois_itch_v2_2_2022)
