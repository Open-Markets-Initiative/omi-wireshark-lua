...
eurex_t7_eti_fbe_v1.role = function(packet)
  ...
  local acceptor_port = omi_eurex_t7_eti_fbe_v1.prefs.acceptor_port
...
local function omi_eurex_t7_eti_fbe_v1_tcp_heuristic(buffer, packet, parent)
  local role = eurex_t7_eti_fbe_v1.role(packet)
  local initiator = omi_eurex_t7_eti_fbe_v1_tcp_initiator_heuristic
  local acceptor = omi_eurex_t7_eti_fbe_v1_tcp_acceptor_heuristic
