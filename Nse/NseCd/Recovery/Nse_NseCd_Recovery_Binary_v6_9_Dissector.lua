...
-----------------------------------------------------------------------
-- Nse NseCd Recovery Binary 6.9 Formatting
-----------------------------------------------------------------------
...
nse_nsecd_recovery_binary_v6_9.role = function(packet)
  ...
  local acceptor_port = omi_nse_nsecd_recovery_binary_v6_9.prefs.acceptor_port
...
local function omi_nse_nsecd_recovery_binary_v6_9_tcp_heuristic(buffer, packet, parent)
  local role = nse_nsecd_recovery_binary_v6_9.role(packet)
  local initiator = omi_nse_nsecd_recovery_binary_v6_9_tcp_initiator_heuristic
  local acceptor = omi_nse_nsecd_recovery_binary_v6_9_tcp_acceptor_heuristic
