...
-- Nse NseCd Snapshot Binary 7.1 Framing
...
-----------------------------------------------------------------------
-- Nse NseCd Snapshot Binary 7.1 Formatting
-----------------------------------------------------------------------
...
omi_nse_nsecd_snapshot_binary_v7_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_nse_nsecd_snapshot_binary_v7_1.prefs_changed()
  ...
  if show.headers ~= omi_nse_nsecd_snapshot_binary_v7_1.prefs.show_headers then
    show.headers = omi_nse_nsecd_snapshot_binary_v7_1.prefs.show_headers
  end
...
nse_nsecd_snapshot_binary_v7_1.role = function(packet)
  ...
  local acceptor_port = omi_nse_nsecd_snapshot_binary_v7_1.prefs.acceptor_port
...
local function omi_nse_nsecd_snapshot_binary_v7_1_tcp_heuristic(buffer, packet, parent)
  local role = nse_nsecd_snapshot_binary_v7_1.role(packet)
  local initiator = omi_nse_nsecd_snapshot_binary_v7_1_tcp_initiator_heuristic
  local acceptor = omi_nse_nsecd_snapshot_binary_v7_1_tcp_acceptor_heuristic
