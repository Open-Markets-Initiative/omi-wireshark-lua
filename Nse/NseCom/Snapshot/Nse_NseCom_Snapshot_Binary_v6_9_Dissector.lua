...
-- Nse NseCom Snapshot Binary 6.9 Framing
...
-----------------------------------------------------------------------
-- Nse NseCom Snapshot Binary 6.9 Formatting
-----------------------------------------------------------------------
...
omi_nse_nsecom_snapshot_binary_v6_9.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_nse_nsecom_snapshot_binary_v6_9.prefs_changed()
  ...
  if show.headers ~= omi_nse_nsecom_snapshot_binary_v6_9.prefs.show_headers then
    show.headers = omi_nse_nsecom_snapshot_binary_v6_9.prefs.show_headers
  end
...
nse_nsecom_snapshot_binary_v6_9.role = function(packet)
  ...
  local acceptor_port = omi_nse_nsecom_snapshot_binary_v6_9.prefs.acceptor_port
...
local function omi_nse_nsecom_snapshot_binary_v6_9_tcp_heuristic(buffer, packet, parent)
  local role = nse_nsecom_snapshot_binary_v6_9.role(packet)
  local initiator = omi_nse_nsecom_snapshot_binary_v6_9_tcp_initiator_heuristic
  local acceptor = omi_nse_nsecom_snapshot_binary_v6_9_tcp_acceptor_heuristic
