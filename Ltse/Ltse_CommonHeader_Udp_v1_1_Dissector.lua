...
function omi_ltse_commonheader_udp_v1_1.prefs_changed()
  ...
  if show.indexes ~= omi_ltse_commonheader_udp_v1_1.prefs.show_indexes then
    show.indexes = omi_ltse_commonheader_udp_v1_1.prefs.show_indexes
  end
end
...
-- Register Ltse CommonHeader Udp 1.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_ltse_commonheader_udp_v1_1)
