...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.amexequities.depthfeed.pillar.v1.6.reserved1", ftypes.BYTES)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.reserved_2 = ProtoField.new("Reserved 2", "nyse.amexequities.depthfeed.pillar.v1.6.reserved2", ftypes.BYTES)
...
-- Nyse AmexEquities DepthFeed Pillar 1.6 Framing
...
-- Nyse AmexEquities DepthFeed 1.6 Session Messages
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.heartbeat = ProtoField.new("Heartbeat", "nyse.amexequities.depthfeed.pillar.v1.6.heartbeat", ftypes.BYTES)
...
nyse_amexequities_depthfeed_pillar_v1_6.message.size = function(buffer, offset)
  local index = offset
...
nyse_amexequities_depthfeed_pillar_v1_6.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nyse_amexequities_depthfeed_pillar_v1_6.message.size(buffer, offset)
...
-- Heartbeat
nyse_amexequities_depthfeed_pillar_v1_6.heartbeat = {}

-- Display: Heartbeat
nyse_amexequities_depthfeed_pillar_v1_6.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nyse_amexequities_depthfeed_pillar_v1_6.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.heartbeat.display(packet, parent, 0)
...
-- Messages
nyse_amexequities_depthfeed_pillar_v1_6.messages = {}

-- Dissect: Messages
nyse_amexequities_depthfeed_pillar_v1_6.messages.dissect = function(buffer, offset, packet, parent, delivery_flag)
  -- Dissect Heartbeat
  if delivery_flag == 1 then
    return nyse_amexequities_depthfeed_pillar_v1_6.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, number_msgs do
    ...
    offset = nyse_amexequities_depthfeed_pillar_v1_6.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nyse_amexequities_depthfeed_pillar_v1_6.packet.dissect = function(buffer, packet, parent)
  ...
  index = nyse_amexequities_depthfeed_pillar_v1_6.messages.dissect(buffer, index, packet, parent, delivery_flag)
