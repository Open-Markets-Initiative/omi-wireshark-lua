...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.seconds = ProtoField.new("Seconds", "nyse.amexequities.bqt.xdp.v2.4.a.seconds", ftypes.UINT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.send_time = ProtoField.new("Send Time", "nyse.amexequities.bqt.xdp.v2.4.a.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.send_time_utc = ProtoField.new("Send Time", "nyse.amexequities.bqt.xdp.v2.4.a.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-- Nyse AmexEquities Bqt Xdp 2.4.a Framing
...
-- 0=Local, 1=Utc
nyse_amexequities_bqt_xdp_v2_4_a.absolute_time_base = 0
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)
...
function omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs_changed()
  ...
  if show.headers ~= omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_headers then
    show.headers = omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_headers
  end
  ...
  if nyse_amexequities_bqt_xdp_v2_4_a.absolute_time_base ~= omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.absolute_time_base then
    nyse_amexequities_bqt_xdp_v2_4_a.absolute_time_base = omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.absolute_time_base
  end
end
...
-- Seconds
nyse_amexequities_bqt_xdp_v2_4_a.seconds = {}

-- Size: Seconds
nyse_amexequities_bqt_xdp_v2_4_a.seconds.size = 4

-- Display: Seconds
nyse_amexequities_bqt_xdp_v2_4_a.seconds.display = function(value)
  -- Parse unix seconds timestamp
  return "Seconds: "..os.date("%Y-%m-%d %H:%M:%S", value)
end

-- Dissect: Seconds
nyse_amexequities_bqt_xdp_v2_4_a.seconds.dissect = function(buffer, offset, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.seconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_amexequities_bqt_xdp_v2_4_a.seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.seconds, range, value, display)
...
-- Send Time
nyse_amexequities_bqt_xdp_v2_4_a.send_time = {}

-- Size: Send Time
nyse_amexequities_bqt_xdp_v2_4_a.send_time.size =
  nyse_amexequities_bqt_xdp_v2_4_a.seconds.size + 
  nyse_amexequities_bqt_xdp_v2_4_a.nanoseconds.size

-- Display: Send Time
nyse_amexequities_bqt_xdp_v2_4_a.send_time.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
nyse_amexequities_bqt_xdp_v2_4_a.send_time.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seconds: 4 Byte Unsigned Fixed Width Integer
  index, seconds = nyse_amexequities_bqt_xdp_v2_4_a.seconds.dissect(buffer, index, packet, parent)
...
-- Dissect: Send Time
nyse_amexequities_bqt_xdp_v2_4_a.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_amexequities_bqt_xdp_v2_4_a.send_time.size
    ...
    local field = omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.send_time
    if nyse_amexequities_bqt_xdp_v2_4_a.absolute_time_base == 1 then field = omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_amexequities_bqt_xdp_v2_4_a.send_time.fields(buffer, offset, packet, parent)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_amexequities_bqt_xdp_v2_4_a.send_time.fields(buffer, offset, packet, parent)
  end
end
...
nyse_amexequities_bqt_xdp_v2_4_a.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, send_time = nyse_amexequities_bqt_xdp_v2_4_a.send_time.dissect(buffer, index, packet, parent)
