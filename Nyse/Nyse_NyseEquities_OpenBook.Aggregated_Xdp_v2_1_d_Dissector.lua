...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.reserved1", ftypes.BYTES)
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.reserved_2 = ProtoField.new("Reserved 2", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.reserved2", ftypes.BYTES)
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.reserved_4 = ProtoField.new("Reserved 4", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.reserved4", ftypes.BYTES)
...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.seconds = ProtoField.new("Seconds", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.seconds", ftypes.UINT32)
...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.send_time = ProtoField.new("Send Time", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.send_time_utc = ProtoField.new("Send Time", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-- Nyse NyseEquities OpenBook.Aggregated Xdp 2.1.d Framing
...
-----------------------------------------------------------------------
-- Nyse NyseEquities OpenBook.Aggregated Xdp 2.1.d Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.absolute_time_base = 0
...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)
...
function omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs_changed()
  ...
  if show.headers ~= omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs.show_headers then
    show.headers = omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs.show_headers
  end
  ...
  if nyse_nyseequities_openbookaggregated_xdp_v2_1_d.absolute_time_base ~= omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs.absolute_time_base then
    nyse_nyseequities_openbookaggregated_xdp_v2_1_d.absolute_time_base = omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.prefs.absolute_time_base
  end
end
...
-- Seconds
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds = {}

-- Size: Seconds
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.size = 4

-- Display: Seconds
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.display = function(value)
  -- Parse unix seconds timestamp
  return "Seconds: "..os.date("%Y-%m-%d %H:%M:%S", value)
end

-- Dissect: Seconds
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.dissect = function(buffer, offset, packet, parent)
  local length = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.seconds, range, value, display)
...
-- Send Time
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time = {}

-- Size: Send Time
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.size =
  nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.size + 
  nyse_nyseequities_openbookaggregated_xdp_v2_1_d.nanoseconds.size

-- Display: Send Time
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seconds: 4 Byte Unsigned Fixed Width Integer
  index, seconds = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.seconds.dissect(buffer, index, packet, parent)
...
-- Dissect: Send Time
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.size
    ...
    local field = omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.send_time
    if nyse_nyseequities_openbookaggregated_xdp_v2_1_d.absolute_time_base == 1 then field = omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.fields(buffer, offset, packet, parent)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.fields(buffer, offset, packet, parent)
  end
end
...
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, send_time = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.send_time.dissect(buffer, index, packet, parent)
