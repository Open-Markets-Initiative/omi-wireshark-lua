...
local omi_nyse_options_deepfeed_xdp_v1_3_a = Proto("Omi.Nyse.Options.DeepFeed.Xdp.v1.3.a", "Nyse Options DeepFeed Xdp 1.3.a")
...
omi_nyse_options_deepfeed_xdp_v1_3_a.fields.seconds = ProtoField.new("Seconds", "nyse.options.deepfeed.xdp.v1.3.a.seconds", ftypes.UINT32)
...
omi_nyse_options_deepfeed_xdp_v1_3_a.fields.send_time = ProtoField.new("Send Time", "nyse.options.deepfeed.xdp.v1.3.a.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_options_deepfeed_xdp_v1_3_a.fields.send_time_utc = ProtoField.new("Send Time", "nyse.options.deepfeed.xdp.v1.3.a.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-- Nyse Options DeepFeed Xdp 1.3.a Framing
...
-- Nyse Options DeepFeed 1.3.a Application Messages
...
-----------------------------------------------------------------------
-- Nyse Options DeepFeed Xdp 1.3.a Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
nyse_options_deepfeed_xdp_v1_3_a.absolute_time_base = 0
...
omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)

-- Handle changed preferences
function omi_nyse_options_deepfeed_xdp_v1_3_a.prefs_changed()

  -- Check if preferences have changed
  if show.application_messages ~= omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_application_messages then
    show.application_messages = omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_application_messages
  end
  if show.headers ~= omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_headers then
    show.headers = omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_headers
  end
  if show.structs ~= omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_structs then
    show.structs = omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_indexes then
    show.indexes = omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.show_indexes
  end
  if nyse_options_deepfeed_xdp_v1_3_a.absolute_time_base ~= omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.absolute_time_base then
    nyse_options_deepfeed_xdp_v1_3_a.absolute_time_base = omi_nyse_options_deepfeed_xdp_v1_3_a.prefs.absolute_time_base
  end
end
...
-- Seconds
nyse_options_deepfeed_xdp_v1_3_a.seconds = {}

-- Size: Seconds
nyse_options_deepfeed_xdp_v1_3_a.seconds.size = 4

-- Display: Seconds
nyse_options_deepfeed_xdp_v1_3_a.seconds.display = function(value)
  -- Parse unix seconds timestamp
  return "Seconds: "..os.date("%Y-%m-%d %H:%M:%S", value)
end

-- Dissect: Seconds
nyse_options_deepfeed_xdp_v1_3_a.seconds.dissect = function(buffer, offset, packet, parent)
  local length = nyse_options_deepfeed_xdp_v1_3_a.seconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_options_deepfeed_xdp_v1_3_a.seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_options_deepfeed_xdp_v1_3_a.fields.seconds, range, value, display)
...
nyse_options_deepfeed_xdp_v1_3_a.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
...
-- Dissect: Message
nyse_options_deepfeed_xdp_v1_3_a.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nyse_options_deepfeed_xdp_v1_3_a.fields.message, buffer(offset, 0))
    local current = nyse_options_deepfeed_xdp_v1_3_a.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    nyse_options_deepfeed_xdp_v1_3_a.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
-- Send Time
nyse_options_deepfeed_xdp_v1_3_a.send_time = {}

-- Size: Send Time
nyse_options_deepfeed_xdp_v1_3_a.send_time.size =
  nyse_options_deepfeed_xdp_v1_3_a.seconds.size + 
  nyse_options_deepfeed_xdp_v1_3_a.nanoseconds.size

-- Display: Send Time
nyse_options_deepfeed_xdp_v1_3_a.send_time.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
nyse_options_deepfeed_xdp_v1_3_a.send_time.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seconds: 4 Byte Unsigned Fixed Width Integer
  index, seconds = nyse_options_deepfeed_xdp_v1_3_a.seconds.dissect(buffer, index, packet, parent)
...
-- Dissect: Send Time
nyse_options_deepfeed_xdp_v1_3_a.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_options_deepfeed_xdp_v1_3_a.send_time.size
    ...
    local field = omi_nyse_options_deepfeed_xdp_v1_3_a.fields.send_time
    if nyse_options_deepfeed_xdp_v1_3_a.absolute_time_base == 1 then field = omi_nyse_options_deepfeed_xdp_v1_3_a.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_options_deepfeed_xdp_v1_3_a.send_time.fields(buffer, offset, packet, parent)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_options_deepfeed_xdp_v1_3_a.send_time.fields(buffer, offset, packet, parent)
  end
end
...
nyse_options_deepfeed_xdp_v1_3_a.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, send_time = nyse_options_deepfeed_xdp_v1_3_a.send_time.dissect(buffer, index, packet, parent)
...
nyse_options_deepfeed_xdp_v1_3_a.packet.requiredsize = function(buffer)
  return buffer:len() >= nyse_options_deepfeed_xdp_v1_3_a.packet_header.size
end
...
nyse_options_deepfeed_xdp_v1_3_a.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = nyse_options_deepfeed_xdp_v1_3_a.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
...
-- Dissector Heuristic for Nyse Options DeepFeed Xdp 1.3.a (Udp)
local function omi_nyse_options_deepfeed_xdp_v1_3_a_udp_heuristic(buffer, packet, parent)
...
omi_nyse_options_deepfeed_xdp_v1_3_a:register_heuristic("udp", omi_nyse_options_deepfeed_xdp_v1_3_a_udp_heuristic)

-- Register Nyse Options DeepFeed Xdp 1.3.a for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_options_deepfeed_xdp_v1_3_a)
