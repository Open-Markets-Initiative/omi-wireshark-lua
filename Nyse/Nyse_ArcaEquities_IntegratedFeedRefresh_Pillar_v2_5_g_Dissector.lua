...
omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.arcaequities.integratedfeedrefresh.pillar.v2.5.g.reserved1", ftypes.BYTES)
omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.reserved_4 = ProtoField.new("Reserved 4", "nyse.arcaequities.integratedfeedrefresh.pillar.v2.5.g.reserved4", ftypes.BYTES)
...
omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.send_time = ProtoField.new("Send Time", "nyse.arcaequities.integratedfeedrefresh.pillar.v2.5.g.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.send_time_utc = ProtoField.new("Send Time", "nyse.arcaequities.integratedfeedrefresh.pillar.v2.5.g.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-- Nyse ArcaEquities IntegratedFeedRefresh Pillar 2.5.g Framing
...
-- Nyse ArcaEquities IntegratedFeedRefresh 2.5.g Session Messages
omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.heartbeat = ProtoField.new("Heartbeat", "nyse.arcaequities.integratedfeedrefresh.pillar.v2.5.g.heartbeat", ftypes.BYTES)
...
-- 0=Local, 1=Utc
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.absolute_time_base = 0
...
omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)
...
function omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.prefs_changed()
  ...
  if nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.absolute_time_base ~= omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.prefs.absolute_time_base then
    nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.absolute_time_base = omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.prefs.absolute_time_base
  end
end
...
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.message.size = function(buffer, offset)
  local index = offset
...
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.message.size(buffer, offset)
...
-- Heartbeat
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.heartbeat = {}

-- Display: Heartbeat
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.heartbeat.display(packet, parent, 0)
...
-- Messages
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.messages = {}

-- Dissect: Messages
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.messages.dissect = function(buffer, offset, packet, parent, delivery_flag)
  -- Dissect Heartbeat
  if delivery_flag == 1 then
    return nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, number_msgs do
    ...
    offset = nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.send_time.size
    ...
    local field = omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.send_time
    if nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.absolute_time_base == 1 then field = omi_nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.send_time.fields(buffer, offset, packet, parent)
...
nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.packet.dissect = function(buffer, packet, parent)
  ...
  index = nyse_arcaequities_integratedfeedrefresh_pillar_v2_5_g.messages.dissect(buffer, index, packet, parent, delivery_flag)
