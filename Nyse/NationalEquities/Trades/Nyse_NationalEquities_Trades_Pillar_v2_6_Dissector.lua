...
local omi_nyse_nationalequities_trades_pillar_v2_6 = Proto("Omi.Nyse.NationalEquities.Trades.Pillar.v2.6", "Nyse NationalEquities Trades Pillar 2.6")
...
omi_nyse_nationalequities_trades_pillar_v2_6.fields.exec_day_time = ProtoField.new("Exec Day Time", "nyse.nationalequities.trades.pillar.v2.6.execdaytime", ftypes.UINT32)
...
omi_nyse_nationalequities_trades_pillar_v2_6.fields.prior_day_time_ns = ProtoField.new("Prior Day Time Ns", "nyse.nationalequities.trades.pillar.v2.6.priordaytimens", ftypes.UINT32)
...
omi_nyse_nationalequities_trades_pillar_v2_6.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.nationalequities.trades.pillar.v2.6.reserved1", ftypes.BYTES)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.reserved_2 = ProtoField.new("Reserved 2", "nyse.nationalequities.trades.pillar.v2.6.reserved2", ftypes.BYTES)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.reserved_4 = ProtoField.new("Reserved 4", "nyse.nationalequities.trades.pillar.v2.6.reserved4", ftypes.BYTES)
...
omi_nyse_nationalequities_trades_pillar_v2_6.fields.send_time = ProtoField.new("Send Time", "nyse.nationalequities.trades.pillar.v2.6.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.send_time_utc = ProtoField.new("Send Time", "nyse.nationalequities.trades.pillar.v2.6.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-- Nyse NationalEquities Trades Pillar 2.6 Framing
...
-- Nyse NationalEquities Trades 2.6 Session Messages
omi_nyse_nationalequities_trades_pillar_v2_6.fields.heartbeat = ProtoField.new("Heartbeat", "nyse.nationalequities.trades.pillar.v2.6.heartbeat", ftypes.BYTES)

-- Nyse NationalEquities Trades 2.6 Application Messages
...
omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_prior_day_trade_cancel_message = ProtoField.new("Trf Fractional Prior Day Trade Cancel Message", "nyse.nationalequities.trades.pillar.v2.6.trffractionalpriordaytradecancelmessage", ftypes.STRING)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_prior_day_trade_message = ProtoField.new("Trf Fractional Prior Day Trade Message", "nyse.nationalequities.trades.pillar.v2.6.trffractionalpriordaytrademessage", ftypes.STRING)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_trade_correction_message = ProtoField.new("Trf Fractional Trade Correction Message", "nyse.nationalequities.trades.pillar.v2.6.trffractionaltradecorrectionmessage", ftypes.STRING)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_trade_message = ProtoField.new("Trf Fractional Trade Message", "nyse.nationalequities.trades.pillar.v2.6.trffractionaltrademessage", ftypes.STRING)
omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_trade_cancel_message = ProtoField.new("Trf Trade Cancel Message", "nyse.nationalequities.trades.pillar.v2.6.trftradecancelmessage", ftypes.STRING)
...
-- 0=Local, 1=Utc
nyse_nationalequities_trades_pillar_v2_6.absolute_time_base = 0
...
omi_nyse_nationalequities_trades_pillar_v2_6.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)
...
function omi_nyse_nationalequities_trades_pillar_v2_6.prefs_changed()
  ...
  if show.headers ~= omi_nyse_nationalequities_trades_pillar_v2_6.prefs.show_headers then
    show.headers = omi_nyse_nationalequities_trades_pillar_v2_6.prefs.show_headers
  end
  if show.structs ~= omi_nyse_nationalequities_trades_pillar_v2_6.prefs.show_structs then
    show.structs = omi_nyse_nationalequities_trades_pillar_v2_6.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_nationalequities_trades_pillar_v2_6.prefs.show_indexes then
    show.indexes = omi_nyse_nationalequities_trades_pillar_v2_6.prefs.show_indexes
  end
  ...
  if nyse_nationalequities_trades_pillar_v2_6.absolute_time_base ~= omi_nyse_nationalequities_trades_pillar_v2_6.prefs.absolute_time_base then
    nyse_nationalequities_trades_pillar_v2_6.absolute_time_base = omi_nyse_nationalequities_trades_pillar_v2_6.prefs.absolute_time_base
  end
end
...
-- Exec Day Time
nyse_nationalequities_trades_pillar_v2_6.exec_day_time = {}

-- Size: Exec Day Time
nyse_nationalequities_trades_pillar_v2_6.exec_day_time.size = 4

-- Display: Exec Day Time
nyse_nationalequities_trades_pillar_v2_6.exec_day_time.display = function(value)
  return "Exec Day Time: "..value
end

-- Dissect: Exec Day Time
nyse_nationalequities_trades_pillar_v2_6.exec_day_time.dissect = function(buffer, offset, packet, parent)
  local length = nyse_nationalequities_trades_pillar_v2_6.exec_day_time.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_nationalequities_trades_pillar_v2_6.exec_day_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.exec_day_time, range, value, display)

  return offset + length, value
end

-- Exec Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns = {}

-- Size: Exec Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.size = 4

-- Display: Exec Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.display = function(value)
  return "Exec Day Time Ns: "..value
end

-- Dissect: Exec Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.dissect = function(buffer, offset, packet, parent)
  local length = nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.exec_day_time_ns, range, value, display)

  return offset + length, value
end

-- Fractional Volume
nyse_nationalequities_trades_pillar_v2_6.fractional_volume = {}

-- Size: Fractional Volume
nyse_nationalequities_trades_pillar_v2_6.fractional_volume.size = 8

-- Display: Fractional Volume
nyse_nationalequities_trades_pillar_v2_6.fractional_volume.display = function(value)
  return "Fractional Volume: "..value
end

-- Dissect: Fractional Volume
nyse_nationalequities_trades_pillar_v2_6.fractional_volume.dissect = function(buffer, offset, packet, parent)
  local length = nyse_nationalequities_trades_pillar_v2_6.fractional_volume.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = nyse_nationalequities_trades_pillar_v2_6.fractional_volume.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.fractional_volume, range, value, display)
...
-- Prior Day Time
nyse_nationalequities_trades_pillar_v2_6.prior_day_time = {}

-- Size: Prior Day Time
nyse_nationalequities_trades_pillar_v2_6.prior_day_time.size = 4

-- Display: Prior Day Time
nyse_nationalequities_trades_pillar_v2_6.prior_day_time.display = function(value)
  return "Prior Day Time: "..value
end

-- Dissect: Prior Day Time
nyse_nationalequities_trades_pillar_v2_6.prior_day_time.dissect = function(buffer, offset, packet, parent)
  local length = nyse_nationalequities_trades_pillar_v2_6.prior_day_time.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_nationalequities_trades_pillar_v2_6.prior_day_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.prior_day_time, range, value, display)

  return offset + length, value
end

-- Prior Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns = {}

-- Size: Prior Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.size = 4

-- Display: Prior Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.display = function(value)
  return "Prior Day Time Ns: "..value
end

-- Dissect: Prior Day Time Ns
nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.dissect = function(buffer, offset, packet, parent)
  local length = nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.prior_day_time_ns, range, value, display)
...
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message = {}

-- Size: Trf Fractional Prior Day Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.size =
  ...
  nyse_nationalequities_trades_pillar_v2_6.fractional_volume.size + 
  nyse_nationalequities_trades_pillar_v2_6.prior_day_time.size + 
  nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.size

-- Display: Trf Fractional Prior Day Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trf Fractional Prior Day Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, prior_day_time = nyse_nationalequities_trades_pillar_v2_6.prior_day_time.dissect(buffer, index, packet, parent)

  -- Prior Day Time Ns: Binary
  index, prior_day_time_ns = nyse_nationalequities_trades_pillar_v2_6.prior_day_time_ns.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trf Fractional Prior Day Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_prior_day_trade_cancel_message, buffer(offset, 0))
    local index = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.fields(buffer, offset, packet, parent)
  end
end

-- Trf Fractional Prior Day Trade Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message = {}

-- Size: Trf Fractional Prior Day Trade Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.size =
  nyse_nationalequities_trades_pillar_v2_6.source_time.size + 
  nyse_nationalequities_trades_pillar_v2_6.source_time_ns.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_index.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_seq_num.size + 
...
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trf Fractional Prior Day Trade Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_prior_day_trade_message, buffer(offset, 0))
    local index = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.fields(buffer, offset, packet, parent)
  end
end

-- Trf Fractional Trade Correction Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message = {}

-- Size: Trf Fractional Trade Correction Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.size =
  nyse_nationalequities_trades_pillar_v2_6.source_time.size + 
  nyse_nationalequities_trades_pillar_v2_6.source_time_ns.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_index.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_seq_num.size + 
  ...
  nyse_nationalequities_trades_pillar_v2_6.trade_cond_3.size + 
  nyse_nationalequities_trades_pillar_v2_6.trade_cond_4.size + 
  nyse_nationalequities_trades_pillar_v2_6.exec_day_time.size + 
  nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.size

-- Display: Trf Fractional Trade Correction Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trf Fractional Trade Correction Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, exec_day_time = nyse_nationalequities_trades_pillar_v2_6.exec_day_time.dissect(buffer, index, packet, parent)

  -- Exec Day Time Ns: Binary
  index, exec_day_time_ns = nyse_nationalequities_trades_pillar_v2_6.exec_day_time_ns.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trf Fractional Trade Correction Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_trade_correction_message, buffer(offset, 0))
    local index = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.fields(buffer, offset, packet, parent)
  end
end

-- Trf Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message = {}

-- Size: Trf Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.size =
  nyse_nationalequities_trades_pillar_v2_6.source_time.size + 
  nyse_nationalequities_trades_pillar_v2_6.source_time_ns.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_index.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_seq_num.size + 
...
nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trf Trade Cancel Message
nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_trade_cancel_message, buffer(offset, 0))
    local index = nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.fields(buffer, offset, packet, parent)
  end
end

-- Trf Fractional Trade Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message = {}

-- Size: Trf Fractional Trade Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.size =
  nyse_nationalequities_trades_pillar_v2_6.source_time.size + 
  nyse_nationalequities_trades_pillar_v2_6.source_time_ns.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_index.size + 
  nyse_nationalequities_trades_pillar_v2_6.symbol_seq_num.size + 
...
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trf Fractional Trade Message
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.trf_fractional_trade_message, buffer(offset, 0))
    local index = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.fields(buffer, offset, packet, parent)
  end
end
...
nyse_nationalequities_trades_pillar_v2_6.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 210 then
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trf Trade Cancel Message
  if message_type == 216 then
    return nyse_nationalequities_trades_pillar_v2_6.trf_trade_cancel_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trf Fractional Trade Correction Message
  if message_type == 212 then
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_trade_correction_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trf Fractional Prior Day Trade Message
  if message_type == 213 then
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trf Fractional Prior Day Trade Cancel Message
  if message_type == 214 then
    return nyse_nationalequities_trades_pillar_v2_6.trf_fractional_prior_day_trade_cancel_message.dissect(buffer, offset, packet, parent)
  end
...
nyse_nationalequities_trades_pillar_v2_6.message.size = function(buffer, offset)
  local index = offset
...
nyse_nationalequities_trades_pillar_v2_6.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nyse_nationalequities_trades_pillar_v2_6.sequence ~= nil then
    local sequence = parent:add(omi_nyse_nationalequities_trades_pillar_v2_6.fields.message_sequence_number, UInt64.new(nyse_nationalequities_trades_pillar_v2_6.sequence + message_index - 1))
...
nyse_nationalequities_trades_pillar_v2_6.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nyse_nationalequities_trades_pillar_v2_6.message.size(buffer, offset)
...
-- Heartbeat
nyse_nationalequities_trades_pillar_v2_6.heartbeat = {}

-- Display: Heartbeat
nyse_nationalequities_trades_pillar_v2_6.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nyse_nationalequities_trades_pillar_v2_6.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nyse_nationalequities_trades_pillar_v2_6.heartbeat.display(packet, parent, 0)
...
-- Messages
nyse_nationalequities_trades_pillar_v2_6.messages = {}

-- Dissect: Messages
nyse_nationalequities_trades_pillar_v2_6.messages.dissect = function(buffer, offset, packet, parent, delivery_flag)
  -- Dissect Heartbeat
  if delivery_flag == 1 then
    return nyse_nationalequities_trades_pillar_v2_6.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, number_msgs do
    ...
    offset = nyse_nationalequities_trades_pillar_v2_6.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nyse_nationalequities_trades_pillar_v2_6.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_nationalequities_trades_pillar_v2_6.send_time.size
    ...
    local field = omi_nyse_nationalequities_trades_pillar_v2_6.fields.send_time
    if nyse_nationalequities_trades_pillar_v2_6.absolute_time_base == 1 then field = omi_nyse_nationalequities_trades_pillar_v2_6.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_nationalequities_trades_pillar_v2_6.send_time.fields(buffer, offset, packet, parent)
...
nyse_nationalequities_trades_pillar_v2_6.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nyse_nationalequities_trades_pillar_v2_6.sequence = seq_num
...
nyse_nationalequities_trades_pillar_v2_6.packet.requiredsize = function(buffer)
  return buffer:len() >= nyse_nationalequities_trades_pillar_v2_6.packet_header.size
end
...
nyse_nationalequities_trades_pillar_v2_6.packet.dissect = function(buffer, packet, parent)
  ...
  index = nyse_nationalequities_trades_pillar_v2_6.messages.dissect(buffer, index, packet, parent, delivery_flag)
...
-- Dissector Heuristic for Nyse NationalEquities Trades Pillar 2.6 (Udp)
local function omi_nyse_nationalequities_trades_pillar_v2_6_udp_heuristic(buffer, packet, parent)
...
omi_nyse_nationalequities_trades_pillar_v2_6:register_heuristic("udp", omi_nyse_nationalequities_trades_pillar_v2_6_udp_heuristic)

-- Register Nyse NationalEquities Trades Pillar 2.6 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_nationalequities_trades_pillar_v2_6)
