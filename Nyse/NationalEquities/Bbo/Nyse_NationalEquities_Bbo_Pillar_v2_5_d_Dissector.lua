...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.nationalequities.bbo.pillar.v2.5.d.reserved1", ftypes.BYTES)
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.reserved_2 = ProtoField.new("Reserved 2", "nyse.nationalequities.bbo.pillar.v2.5.d.reserved2", ftypes.BYTES)
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.reserved_4 = ProtoField.new("Reserved 4", "nyse.nationalequities.bbo.pillar.v2.5.d.reserved4", ftypes.BYTES)
...
-- Nyse NationalEquities Bbo Pillar 2.5.d Framing
...
-- Nyse NationalEquities Bbo 2.5.d Session Messages
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.heartbeat = ProtoField.new("Heartbeat", "nyse.nationalequities.bbo.pillar.v2.5.d.heartbeat", ftypes.BYTES)
...
nyse_nationalequities_bbo_pillar_v2_5_d.message.size = function(buffer, offset)
  local index = offset
...
nyse_nationalequities_bbo_pillar_v2_5_d.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nyse_nationalequities_bbo_pillar_v2_5_d.message.size(buffer, offset)
...
-- Heartbeat
nyse_nationalequities_bbo_pillar_v2_5_d.heartbeat = {}

-- Display: Heartbeat
nyse_nationalequities_bbo_pillar_v2_5_d.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nyse_nationalequities_bbo_pillar_v2_5_d.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nyse_nationalequities_bbo_pillar_v2_5_d.heartbeat.display(packet, parent, 0)
...
-- Messages
nyse_nationalequities_bbo_pillar_v2_5_d.messages = {}

-- Dissect: Messages
nyse_nationalequities_bbo_pillar_v2_5_d.messages.dissect = function(buffer, offset, packet, parent, delivery_flag)
  -- Dissect Heartbeat
  if delivery_flag == 1 then
    return nyse_nationalequities_bbo_pillar_v2_5_d.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, number_msgs do
    ...
    offset = nyse_nationalequities_bbo_pillar_v2_5_d.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nyse_nationalequities_bbo_pillar_v2_5_d.packet.dissect = function(buffer, packet, parent)
  ...
  index = nyse_nationalequities_bbo_pillar_v2_5_d.messages.dissect(buffer, index, packet, parent, delivery_flag)
