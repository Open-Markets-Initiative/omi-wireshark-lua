...
local omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h = Proto("Omi.Nyse.ArcaOptions.ComplexFeed.Pillar.v1.0.h", "Nyse ArcaOptions ComplexFeed Pillar 1.0.h")
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.ask_price = ProtoField.new("Ask Price", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.askprice", ftypes.INT32)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.bid_price = ProtoField.new("Bid Price", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.bidprice", ftypes.INT32)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.prevcloseprice", ftypes.UINT32)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.price_1 = ProtoField.new("Price 1", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.price1", ftypes.UINT32)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.price_2 = ProtoField.new("Price 2", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.price2", ftypes.UINT32)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.reserved1", ftypes.BYTES)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.reserved_2 = ProtoField.new("Reserved 2", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.reserved2", ftypes.BYTES)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.reserved_4 = ProtoField.new("Reserved 4", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.reserved4", ftypes.BYTES)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.secondreserved1", ftypes.BYTES)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.second_reserved_2 = ProtoField.new("Second Reserved 2", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.secondreserved2", ftypes.BYTES)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.send_time = ProtoField.new("Send Time", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.send_time_utc = ProtoField.new("Send Time", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.third_reserved_1 = ProtoField.new("Third Reserved 1", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.thirdreserved1", ftypes.BYTES)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.third_reserved_2 = ProtoField.new("Third Reserved 2", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.thirdreserved2", ftypes.BYTES)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.trade_price = ProtoField.new("Trade Price", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.tradeprice", ftypes.INT32)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.working_price = ProtoField.new("Working Price", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.workingprice", ftypes.INT32)

-- Nyse ArcaOptions ComplexFeed Pillar 1.0.h Framing
...
-- Nyse ArcaOptions ComplexFeed 1.0.h Session Messages
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.heartbeat = ProtoField.new("Heartbeat", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.heartbeat", ftypes.BYTES)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.messagesequencenumber", ftypes.UINT64)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.ask_price_calculate = ProtoField.new("Ask Price Calculate", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.askpricecalculate", ftypes.DOUBLE)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.bid_price_calculate = ProtoField.new("Bid Price Calculate", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.bidpricecalculate", ftypes.DOUBLE)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.trade_price_calculate = ProtoField.new("Trade Price Calculate", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.tradepricecalculate", ftypes.DOUBLE)
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.working_price_calculate = ProtoField.new("Working Price Calculate", "nyse.arcaoptions.complexfeed.pillar.v1.0.h.workingpricecalculate", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Nyse ArcaOptions ComplexFeed Pillar 1.0.h Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
nyse_arcaoptions_complexfeed_pillar_v1_0_h.absolute_time_base = 0

-- Ask Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals = true
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.resolve_records = Pref.bool("Outright Series Index Mapping Message", show.records, "Cache records and resolve cross-packet lookups")
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.format_decimals = Pref.bool("Format Decimals", true, "Format decimal-scaled fields as scaled values (off = raw mantissa)")

omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)

-- Handle changed preferences
function omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.resolve_records then
    show.records = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.resolve_records
  end
  ...
  if show.headers ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_headers then
    show.headers = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_headers
  end
  if show.repeating_groups ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_repeating_groups then
    show.repeating_groups = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_repeating_groups
  end
  if show.structs ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_structs then
    show.structs = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_indexes then
    show.indexes = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_indexes
  end
  if show.sequences ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_sequences then
    show.sequences = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.show_sequences
  end
  if nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.format_decimals then
    nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.format_decimals
  end
  if nyse_arcaoptions_complexfeed_pillar_v1_0_h.absolute_time_base ~= omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.absolute_time_base then
    nyse_arcaoptions_complexfeed_pillar_v1_0_h.absolute_time_base = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.prefs.absolute_time_base
  end
end
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation = {}
nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.data = function(packet)
  local key = nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.key(packet)
  local data = nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.flows[key]
  if data == nil then
    data = { outright_series_index_mapping_message = {} }
    nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.flows[key] = data
  end
  return data
end
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.current = nil
...
-- Second Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1 = {}

-- Size: Second Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.size = 1

-- Display: Second Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.second_reserved_1, range, value, display)

  return offset + length, value
end

-- Second Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2 = {}

-- Size: Second Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.size = 2

-- Display: Second Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.display = function(value)
  return "Second Reserved 2: "..value
end

-- Dissect: Second Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.dissect = function(buffer, offset, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.second_reserved_2, range, value, display)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.series_index.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.current.outright_series_index_mapping_message[value]

  local field_tree = parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.series_index, range, value, display)

  if record ~= nil then
    nyse_arcaoptions_complexfeed_pillar_v1_0_h.outright_series_index_mapping_message.current = record
...
-- Third Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1 = {}

-- Size: Third Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.size = 1

-- Display: Third Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.display = function(value)
  return "Third Reserved 1: "..value
end

-- Dissect: Third Reserved 1
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.third_reserved_1, range, value, display)

  return offset + length, value
end

-- Third Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2 = {}

-- Size: Third Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.size = 2

-- Display: Third Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.display = function(value)
  return "Third Reserved 2: "..value
end

-- Dissect: Third Reserved 2
nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.dissect = function(buffer, offset, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.display(value, buffer, offset, packet, parent)

  parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.third_reserved_2, range, value, display)
...
-- Ask Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate = {}

-- Display: Ask Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate.display = function(value)
  return "Ask Price Calculate: " .. string.format("%g", value)
end

-- Composite: Ask Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.ask_price_calculate, range, value, display)
  local mantissa_display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price.display(mantissa)

  field_tree:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.ask_price, range, mantissa, mantissa_display)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals then
    local record = nyse_arcaoptions_complexfeed_pillar_v1_0_h.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price.dissect(buffer, offset, packet, parent)
end

-- Bid Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate = {}

-- Display: Bid Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate.display = function(value)
  return "Bid Price Calculate: " .. string.format("%g", value)
end

-- Composite: Bid Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.bid_price_calculate, range, value, display)
  local mantissa_display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price.display(mantissa)

  field_tree:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.bid_price, range, mantissa, mantissa_display)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals then
    local record = nyse_arcaoptions_complexfeed_pillar_v1_0_h.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price.dissect(buffer, offset, packet, parent)
end

-- Trade Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate = {}

-- Display: Trade Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate.display = function(value)
  return "Trade Price Calculate: " .. string.format("%g", value)
end

-- Composite: Trade Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.trade_price_calculate, range, value, display)
  local mantissa_display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price.display(mantissa)

  field_tree:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.trade_price, range, mantissa, mantissa_display)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals then
    local record = nyse_arcaoptions_complexfeed_pillar_v1_0_h.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price.dissect(buffer, offset, packet, parent)
end

-- Working Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate = {}

-- Display: Working Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate.display = function(value)
  return "Working Price Calculate: " .. string.format("%g", value)
end

-- Composite: Working Price Calculate
nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.working_price_calculate, range, value, display)
  local mantissa_display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price.display(mantissa)

  field_tree:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.working_price, range, mantissa, mantissa_display)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_arcaoptions_complexfeed_pillar_v1_0_h.format_decimals then
    local record = nyse_arcaoptions_complexfeed_pillar_v1_0_h.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price.dissect(buffer, offset, packet, parent)
end
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.series_rfq_message.fields = function(buffer, offset, packet, parent)
  ...
  index, series_index, series_index_record = nyse_arcaoptions_complexfeed_pillar_v1_0_h.series_index.dissect(buffer, index, packet, parent)
  ...
  index, working_price = nyse_arcaoptions_complexfeed_pillar_v1_0_h.working_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.options_trade_message.size =
  ...
  nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.size + 
  nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.size
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.options_trade_message.fields = function(buffer, offset, packet, parent)
  ...
  index, trade_price = nyse_arcaoptions_complexfeed_pillar_v1_0_h.trade_price_calculate.dissect(buffer, index, packet, parent)
  ...
  index, second_reserved_1 = nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_1.dissect(buffer, index, packet, parent)

  -- Third Reserved 1: ASCII
  index, third_reserved_1 = nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_1.dissect(buffer, index, packet, parent)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.options_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, ask_price = nyse_arcaoptions_complexfeed_pillar_v1_0_h.ask_price_calculate.dissect(buffer, index, packet, parent)
  ...
  index, bid_price = nyse_arcaoptions_complexfeed_pillar_v1_0_h.bid_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.outright_series_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.current.outright_series_index_mapping_message[series_index] = {
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.symbol_index_mapping_message.size =
  ...
  nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.size + 
  nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.size
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.symbol_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_reserved_2 = nyse_arcaoptions_complexfeed_pillar_v1_0_h.second_reserved_2.dissect(buffer, index, packet, parent)

  -- Third Reserved 2: Binary
  index, third_reserved_2 = nyse_arcaoptions_complexfeed_pillar_v1_0_h.third_reserved_2.dissect(buffer, index, packet, parent)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.message.size = function(buffer, offset)
  local index = offset
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nyse_arcaoptions_complexfeed_pillar_v1_0_h.sequence ~= nil then
    local sequence = parent:add(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.message_sequence_number, UInt64.new(nyse_arcaoptions_complexfeed_pillar_v1_0_h.sequence + message_index - 1))
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nyse_arcaoptions_complexfeed_pillar_v1_0_h.message.size(buffer, offset)
...
-- Heartbeat
nyse_arcaoptions_complexfeed_pillar_v1_0_h.heartbeat = {}

-- Display: Heartbeat
nyse_arcaoptions_complexfeed_pillar_v1_0_h.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nyse_arcaoptions_complexfeed_pillar_v1_0_h.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nyse_arcaoptions_complexfeed_pillar_v1_0_h.heartbeat.display(packet, parent, 0)
...
-- Messages
nyse_arcaoptions_complexfeed_pillar_v1_0_h.messages = {}

-- Dissect: Messages
nyse_arcaoptions_complexfeed_pillar_v1_0_h.messages.dissect = function(buffer, offset, packet, parent, delivery_flag)
  -- Dissect Heartbeat
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_arcaoptions_complexfeed_pillar_v1_0_h.send_time.size
    ...
    local field = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.send_time
    if nyse_arcaoptions_complexfeed_pillar_v1_0_h.absolute_time_base == 1 then field = omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_arcaoptions_complexfeed_pillar_v1_0_h.send_time.fields(buffer, offset, packet, parent)
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nyse_arcaoptions_complexfeed_pillar_v1_0_h.sequence = seq_num
...
nyse_arcaoptions_complexfeed_pillar_v1_0_h.packet.dissect = function(buffer, packet, parent)
  ...
  local data = nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.data(packet)
  if not packet.visited then
  end
  nyse_arcaoptions_complexfeed_pillar_v1_0_h.conversation.current = data
  ...
  index = nyse_arcaoptions_complexfeed_pillar_v1_0_h.messages.dissect(buffer, index, packet, parent, delivery_flag)
...
-- Register Nyse ArcaOptions ComplexFeed Pillar 1.0.h for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h)
