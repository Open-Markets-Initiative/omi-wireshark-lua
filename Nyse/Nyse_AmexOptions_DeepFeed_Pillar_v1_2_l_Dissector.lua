...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.reserved_1 = ProtoField.new("Reserved 1", "nyse.amexoptions.deepfeed.pillar.v1.2.l.reserved1", ftypes.BYTES)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.reserved_2 = ProtoField.new("Reserved 2", "nyse.amexoptions.deepfeed.pillar.v1.2.l.reserved2", ftypes.BYTES)
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.reserved_4 = ProtoField.new("Reserved 4", "nyse.amexoptions.deepfeed.pillar.v1.2.l.reserved4", ftypes.BYTES)
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.second_reserved_2 = ProtoField.new("Second Reserved 2", "nyse.amexoptions.deepfeed.pillar.v1.2.l.secondreserved2", ftypes.BYTES)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.second_reserved_4 = ProtoField.new("Second Reserved 4", "nyse.amexoptions.deepfeed.pillar.v1.2.l.secondreserved4", ftypes.BYTES)
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.send_time = ProtoField.new("Send Time", "nyse.amexoptions.deepfeed.pillar.v1.2.l.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.send_time_utc = ProtoField.new("Send Time", "nyse.amexoptions.deepfeed.pillar.v1.2.l.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.third_reserved_2 = ProtoField.new("Third Reserved 2", "nyse.amexoptions.deepfeed.pillar.v1.2.l.thirdreserved2", ftypes.BYTES)
...
-- Nyse AmexOptions DeepFeed Pillar 1.2.l Framing
...
-- Nyse AmexOptions DeepFeed 1.2.l Application Messages
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nyse.amexoptions.deepfeed.pillar.v1.2.l.messagesequencenumber", ftypes.UINT64)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.auction_interest_clearing_price_calculate = ProtoField.new("Auction Interest Clearing Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.auctioninterestclearingpricecalculate", ftypes.DOUBLE)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.continuous_book_clearing_price_calculate = ProtoField.new("Continuous Book Clearing Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.continuousbookclearingpricecalculate", ftypes.DOUBLE)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.high_price_calculate = ProtoField.new("High Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.highpricecalculate", ftypes.DOUBLE)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.indicative_match_price_calculate = ProtoField.new("Indicative Match Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.indicativematchpricecalculate", ftypes.DOUBLE)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.low_price_calculate = ProtoField.new("Low Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.lowpricecalculate", ftypes.DOUBLE)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.price_calculate = ProtoField.new("Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.pricecalculate", ftypes.DOUBLE)
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.working_price_calculate = ProtoField.new("Working Price Calculate", "nyse.amexoptions.deepfeed.pillar.v1.2.l.workingpricecalculate", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Nyse AmexOptions DeepFeed Pillar 1.2.l Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
nyse_amexoptions_deepfeed_pillar_v1_2_l.absolute_time_base = 0

-- Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals = true
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.resolve_records = Pref.bool("Outright Series Index Mapping Message", show.records, "Cache records and resolve cross-packet lookups")
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.format_decimals = Pref.bool("Format Decimals", true, "Format decimal-scaled fields as scaled values (off = raw mantissa)")

omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)

-- Handle changed preferences
function omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.resolve_records then
    show.records = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.resolve_records
  end
  ...
  if show.headers ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_headers then
    show.headers = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_headers
  end
  if show.repeating_groups ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_repeating_groups then
    show.repeating_groups = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_repeating_groups
  end
  if show.structs ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_structs then
    show.structs = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_indexes then
    show.indexes = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_indexes
  end
  if show.sequences ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_sequences then
    show.sequences = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.show_sequences
  end
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.format_decimals then
    nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.format_decimals
  end
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.absolute_time_base ~= omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.absolute_time_base then
    nyse_amexoptions_deepfeed_pillar_v1_2_l.absolute_time_base = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.prefs.absolute_time_base
  end
end
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation = {}
nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.data = function(packet)
  local key = nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.key(packet)
  local data = nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.flows[key]
  if data == nil then
    data = { outright_series_index_mapping_message = {} }
    nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.flows[key] = data
  end
  return data
end
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.current = nil
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.series_index.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.current.outright_series_index_mapping_message[value]

  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.series_index, range, value, display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate = {}

-- Display: Auction Interest Clearing Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate.display = function(value)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.auction_interest_clearing_price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.auction_interest_clearing_price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price.dissect(buffer, offset, packet, parent)
end

-- Continuous Book Clearing Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate = {}

-- Display: Continuous Book Clearing Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate.display = function(value)
  return "Continuous Book Clearing Price Calculate: " .. string.format("%g", value)
end

-- Composite: Continuous Book Clearing Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.continuous_book_clearing_price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.continuous_book_clearing_price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price.dissect(buffer, offset, packet, parent)
end

-- High Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate = {}

-- Display: High Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate.display = function(value)
  return "High Price Calculate: " .. string.format("%g", value)
end

-- Composite: High Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.high_price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.high_price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price.dissect(buffer, offset, packet, parent)
end

-- Indicative Match Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate = {}

-- Display: Indicative Match Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate.display = function(value)
  return "Indicative Match Price Calculate: " .. string.format("%g", value)
end

-- Composite: Indicative Match Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.indicative_match_price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.indicative_match_price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price.dissect(buffer, offset, packet, parent)
end

-- Low Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate = {}

-- Display: Low Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate.display = function(value)
  return "Low Price Calculate: " .. string.format("%g", value)
end

-- Composite: Low Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.low_price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.low_price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price.dissect(buffer, offset, packet, parent)
end

-- Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate = {}

-- Display: Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate.display = function(value)
  return "Price Calculate: " .. string.format("%g", value)
end

-- Composite: Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.price.dissect(buffer, offset, packet, parent)
end

-- Working Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate = {}

-- Display: Working Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate.display = function(value)
  return "Working Price Calculate: " .. string.format("%g", value)
end

-- Composite: Working Price Calculate
nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.working_price_calculate, range, value, display)
  local mantissa_display = nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price.display(mantissa)

  field_tree:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.working_price, range, mantissa, mantissa_display)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexoptions_deepfeed_pillar_v1_2_l.format_decimals then
    local record = nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price.dissect(buffer, offset, packet, parent)
end
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.options_outright_series_summary_message.fields = function(buffer, offset, packet, parent)
  ...
  index, series_index, series_index_record = nyse_amexoptions_deepfeed_pillar_v1_2_l.series_index.dissect(buffer, index, packet, parent)

  -- High Price: Signed Binary
  index, high_price = nyse_amexoptions_deepfeed_pillar_v1_2_l.high_price_calculate.dissect(buffer, index, packet, parent)

  -- Low Price: Signed Binary
  index, low_price = nyse_amexoptions_deepfeed_pillar_v1_2_l.low_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.options_cross_trade_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Price: Signed Binary
  index, price = nyse_amexoptions_deepfeed_pillar_v1_2_l.price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.options_series_rfq_message.fields = function(buffer, offset, packet, parent)
  ...
  index, working_price = nyse_amexoptions_deepfeed_pillar_v1_2_l.working_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.options_imbalance_message.fields = function(buffer, offset, packet, parent)
  ...
  index, continuous_book_clearing_price = nyse_amexoptions_deepfeed_pillar_v1_2_l.continuous_book_clearing_price_calculate.dissect(buffer, index, packet, parent)

  -- Auction Interest Clearing Price: Signed Binary
  index, auction_interest_clearing_price = nyse_amexoptions_deepfeed_pillar_v1_2_l.auction_interest_clearing_price_calculate.dissect(buffer, index, packet, parent)
  ...
  index, indicative_match_price = nyse_amexoptions_deepfeed_pillar_v1_2_l.indicative_match_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.outright_series_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.current.outright_series_index_mapping_message[series_index] = {
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.message.size = function(buffer, offset)
  local index = offset
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nyse_amexoptions_deepfeed_pillar_v1_2_l.sequence ~= nil then
    local sequence = parent:add(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.message_sequence_number, UInt64.new(nyse_amexoptions_deepfeed_pillar_v1_2_l.sequence + message_index - 1))
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nyse_amexoptions_deepfeed_pillar_v1_2_l.message.size(buffer, offset)
...
-- Heartbeat
nyse_amexoptions_deepfeed_pillar_v1_2_l.heartbeat = {}

-- Display: Heartbeat
nyse_amexoptions_deepfeed_pillar_v1_2_l.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nyse_amexoptions_deepfeed_pillar_v1_2_l.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nyse_amexoptions_deepfeed_pillar_v1_2_l.heartbeat.display(packet, parent, 0)
...
-- Messages
nyse_amexoptions_deepfeed_pillar_v1_2_l.messages = {}

-- Dissect: Messages
nyse_amexoptions_deepfeed_pillar_v1_2_l.messages.dissect = function(buffer, offset, packet, parent, delivery_flag)
  -- Dissect Heartbeat
  if delivery_flag == 1 then
    return nyse_amexoptions_deepfeed_pillar_v1_2_l.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, number_msgs do
    ...
    offset = nyse_amexoptions_deepfeed_pillar_v1_2_l.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_amexoptions_deepfeed_pillar_v1_2_l.send_time.size
    ...
    local field = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.send_time
    if nyse_amexoptions_deepfeed_pillar_v1_2_l.absolute_time_base == 1 then field = omi_nyse_amexoptions_deepfeed_pillar_v1_2_l.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_amexoptions_deepfeed_pillar_v1_2_l.send_time.fields(buffer, offset, packet, parent)
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nyse_amexoptions_deepfeed_pillar_v1_2_l.sequence = seq_num
...
nyse_amexoptions_deepfeed_pillar_v1_2_l.packet.requiredsize = function(buffer)
  return buffer:len() >= nyse_amexoptions_deepfeed_pillar_v1_2_l.packet_header.size
end

-- Dissect Packet
nyse_amexoptions_deepfeed_pillar_v1_2_l.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.data(packet)
  if not packet.visited then
  end
  nyse_amexoptions_deepfeed_pillar_v1_2_l.conversation.current = data
  ...
  index = nyse_amexoptions_deepfeed_pillar_v1_2_l.messages.dissect(buffer, index, packet, parent, delivery_flag)
...
-- Register Nyse AmexOptions DeepFeed Pillar 1.2.l for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_amexoptions_deepfeed_pillar_v1_2_l)
