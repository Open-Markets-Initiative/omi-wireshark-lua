...
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.reserved_1 = ProtoField.new("Reserved 1", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.reserved1", ftypes.BYTES)
...
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.reserved_4 = ProtoField.new("Reserved 4", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.reserved4", ftypes.BYTES)
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.reserved_8 = ProtoField.new("Reserved 8", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.reserved8", ftypes.BYTES)
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.secondreserved1", ftypes.BYTES)
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.second_reserved_8 = ProtoField.new("Second Reserved 8", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.secondreserved8", ftypes.BYTES)
...
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.tcp_unit = ProtoField.new("Tcp Unit", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.tcpunit", ftypes.STRING)
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.third_reserved_8 = ProtoField.new("Third Reserved 8", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.thirdreserved8", ftypes.BYTES)
...
omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.venue_of_publication = ProtoField.new("Venue Of Publication", "lseg.tradeecho.level2incrementalrecovery.gtp.v26.1.2.venueofpublication", ftypes.STRING)

-- Lseg TradeEcho Level2IncrementalRecovery Gtp 26.1.2 Framing
...
function omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.prefs_changed()
  ...
  if show.headers ~= omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.prefs.show_headers then
    show.headers = omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.prefs.show_headers
  end
...
-- Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1 = {}

-- Size: Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.size = 1

-- Display: Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.reserved_1, range, value, display)
...
-- Reserved 4
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4 = {}

-- Size: Reserved 4
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.size = 4

-- Display: Reserved 4
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.display = function(value)
  return "Reserved 4: "..value
end

-- Dissect: Reserved 4
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.dissect = function(buffer, offset, packet, parent)
  local length = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.reserved_4, range, value, display)

  return offset + length, value
end

-- Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8 = {}

-- Size: Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.size = 8

-- Display: Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.display = function(value)
  return "Reserved 8: "..value
end

-- Dissect: Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.reserved_8, range, value, display)

  return offset + length, value
end

-- Second Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1 = {}

-- Size: Second Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.size = 1

-- Display: Second Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.second_reserved_1, range, value, display)

  return offset + length, value
end

-- Second Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8 = {}

-- Size: Second Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.size = 8

-- Display: Second Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.display = function(value)
  return "Second Reserved 8: "..value
end

-- Dissect: Second Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.second_reserved_8, range, value, display)
...
-- Third Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8 = {}

-- Size: Third Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.size = 8

-- Display: Third Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.display = function(value)
  return "Third Reserved 8: "..value
end

-- Dissect: Third Reserved 8
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.third_reserved_8, range, value, display)
...
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.venue_of_publication = {}

-- Size: Venue Of Publication
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.venue_of_publication.size = 4

-- Display: Venue Of Publication
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.venue_of_publication.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.si_quote_message.size =
  ...
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.venue_of_publication.size
...
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.si_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, venue_of_publication = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.venue_of_publication.dissect(buffer, index, packet, parent)
...
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.instrument_directory_message.size =
  ...
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.currency.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.average_daily_turnover_adt.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.size + 
  lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.size
...
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.instrument_directory_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Reserved 1: Byte
  index, reserved_1 = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_1.dissect(buffer, index, packet, parent)

  -- Reserved 4: Alpha
  index, reserved_4 = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_4.dissect(buffer, index, packet, parent)
  ...
  -- Reserved 8: Alpha
  index, reserved_8 = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.reserved_8.dissect(buffer, index, packet, parent)

  -- Second Reserved 1: Byte
  index, second_reserved_1 = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_1.dissect(buffer, index, packet, parent)

  -- Second Reserved 8: Alpha
  index, second_reserved_8 = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.second_reserved_8.dissect(buffer, index, packet, parent)

  -- Third Reserved 8: Alpha
  index, third_reserved_8 = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.third_reserved_8.dissect(buffer, index, packet, parent)
...
-- Tcp Unit
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit = {}

-- Display: Tcp Unit
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Tcp Unit
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit.fields = function(buffer, offset, packet, parent, size_of_tcp_unit)
  local index = offset
...
-- Dissect: Tcp Unit
lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit.dissect = function(buffer, offset, packet, parent, size_of_tcp_unit)
  local index = offset + size_of_tcp_unit

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.fields.tcp_unit, buffer(offset, 0))
    local current = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit.fields(buffer, offset, packet, parent, size_of_tcp_unit)
    parent:set_len(size_of_tcp_unit)
    local display = lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.tcp_unit.fields(buffer, offset, packet, parent, size_of_tcp_unit)
...
local tcp_unit_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < lseg_tradeecho_level2incrementalrecovery_gtp_v26_1_2.unit_header.size then
