...
omi_lseg_turquoise_analytics_gtp_v24_4.fields.average_daily_turnover_adt = ProtoField.new("Average Daily Turnover Adt", "lseg.turquoise.analytics.gtp.v24.4.averagedailyturnoveradt", ftypes.DOUBLE)
...
omi_lseg_turquoise_analytics_gtp_v24_4.fields.electronic_order_book = ProtoField.new("Electronic Order Book", "lseg.turquoise.analytics.gtp.v24.4.electronicorderbook", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_1 = ProtoField.new("Reserved 1", "lseg.turquoise.analytics.gtp.v24.4.reserved1", ftypes.BYTES)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_11 = ProtoField.new("Reserved 11", "lseg.turquoise.analytics.gtp.v24.4.reserved11", ftypes.BYTES)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_12 = ProtoField.new("Reserved 12", "lseg.turquoise.analytics.gtp.v24.4.reserved12", ftypes.BYTES)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_4 = ProtoField.new("Reserved 4", "lseg.turquoise.analytics.gtp.v24.4.reserved4", ftypes.BYTES)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_8 = ProtoField.new("Reserved 8", "lseg.turquoise.analytics.gtp.v24.4.reserved8", ftypes.BYTES)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "lseg.turquoise.analytics.gtp.v24.4.secondreserved1", ftypes.BYTES)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.second_reserved_8 = ProtoField.new("Second Reserved 8", "lseg.turquoise.analytics.gtp.v24.4.secondreserved8", ftypes.BYTES)
...
omi_lseg_turquoise_analytics_gtp_v24_4.fields.third_reserved_8 = ProtoField.new("Third Reserved 8", "lseg.turquoise.analytics.gtp.v24.4.thirdreserved8", ftypes.BYTES)
...
omi_lseg_turquoise_analytics_gtp_v24_4.fields.unused_3 = ProtoField.new("Unused 3", "lseg.turquoise.analytics.gtp.v24.4.unused3", ftypes.UINT8, nil, base.DEC, 0x07)
omi_lseg_turquoise_analytics_gtp_v24_4.fields.unused_4 = ProtoField.new("Unused 4", "lseg.turquoise.analytics.gtp.v24.4.unused4", ftypes.UINT8, nil, base.DEC, 0xF0)
...
-- Lseg Turquoise Analytics Gtp 24.4 Framing
...
-- Lseg Turquoise Analytics 24.4 Application Messages
omi_lseg_turquoise_analytics_gtp_v24_4.fields.analytics_message = ProtoField.new("Analytics Message", "lseg.turquoise.analytics.gtp.v24.4.analyticsmessage", ftypes.STRING)
...
omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

-- Handle changed preferences
function omi_lseg_turquoise_analytics_gtp_v24_4.prefs_changed()

  -- Check if preferences have changed
  if show.application_messages ~= omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_application_messages then
    show.application_messages = omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_application_messages
  end
  if show.headers ~= omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_headers then
    show.headers = omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_headers
  end
  if show.structs ~= omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_structs then
    show.structs = omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_structs
  end
  if show.indexes ~= omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_indexes then
    show.indexes = omi_lseg_turquoise_analytics_gtp_v24_4.prefs.show_indexes
  end
end
...
lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt = {}

-- Size: Average Daily Turnover Adt
lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.size = 8

-- Display: Average Daily Turnover Adt
lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.display = function(value)
  return "Average Daily Turnover Adt: "..value
end

-- Translate: Average Daily Turnover Adt
lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.translate = function(raw)
  return raw:tonumber()/10000
end

-- Dissect: Average Daily Turnover Adt
lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.size
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.translate(raw)
  local display = lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.average_daily_turnover_adt, range, value, display)
...
-- Reserved 1
lseg_turquoise_analytics_gtp_v24_4.reserved_1 = {}

-- Size: Reserved 1
lseg_turquoise_analytics_gtp_v24_4.reserved_1.size = 1

-- Display: Reserved 1
lseg_turquoise_analytics_gtp_v24_4.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
lseg_turquoise_analytics_gtp_v24_4.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_1, range, value, display)

  return offset + length, value
end

-- Reserved 11
lseg_turquoise_analytics_gtp_v24_4.reserved_11 = {}

-- Size: Reserved 11
lseg_turquoise_analytics_gtp_v24_4.reserved_11.size = 11

-- Display: Reserved 11
lseg_turquoise_analytics_gtp_v24_4.reserved_11.display = function(value)
  return "Reserved 11: "..value
end

-- Dissect: Reserved 11
lseg_turquoise_analytics_gtp_v24_4.reserved_11.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.reserved_11.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.reserved_11.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_11, range, value, display)

  return offset + length, value
end

-- Reserved 12
lseg_turquoise_analytics_gtp_v24_4.reserved_12 = {}

-- Size: Reserved 12
lseg_turquoise_analytics_gtp_v24_4.reserved_12.size = 12

-- Display: Reserved 12
lseg_turquoise_analytics_gtp_v24_4.reserved_12.display = function(value)
  return "Reserved 12: "..value
end

-- Dissect: Reserved 12
lseg_turquoise_analytics_gtp_v24_4.reserved_12.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.reserved_12.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.reserved_12.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_12, range, value, display)

  return offset + length, value
end

-- Reserved 4
lseg_turquoise_analytics_gtp_v24_4.reserved_4 = {}

-- Size: Reserved 4
lseg_turquoise_analytics_gtp_v24_4.reserved_4.size = 4

-- Display: Reserved 4
lseg_turquoise_analytics_gtp_v24_4.reserved_4.display = function(value)
  return "Reserved 4: "..value
end

-- Dissect: Reserved 4
lseg_turquoise_analytics_gtp_v24_4.reserved_4.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.reserved_4.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.reserved_4.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_4, range, value, display)

  return offset + length, value
end

-- Reserved 8
lseg_turquoise_analytics_gtp_v24_4.reserved_8 = {}

-- Size: Reserved 8
lseg_turquoise_analytics_gtp_v24_4.reserved_8.size = 8

-- Display: Reserved 8
lseg_turquoise_analytics_gtp_v24_4.reserved_8.display = function(value)
  return "Reserved 8: "..value
end

-- Dissect: Reserved 8
lseg_turquoise_analytics_gtp_v24_4.reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.reserved_8.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.reserved_8, range, value, display)

  return offset + length, value
end

-- Second Reserved 1
lseg_turquoise_analytics_gtp_v24_4.second_reserved_1 = {}

-- Size: Second Reserved 1
lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.size = 1

-- Display: Second Reserved 1
lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.second_reserved_1, range, value, display)

  return offset + length, value
end

-- Second Reserved 8
lseg_turquoise_analytics_gtp_v24_4.second_reserved_8 = {}

-- Size: Second Reserved 8
lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.size = 8

-- Display: Second Reserved 8
lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.display = function(value)
  return "Second Reserved 8: "..value
end

-- Dissect: Second Reserved 8
lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.second_reserved_8, range, value, display)
...
-- Third Reserved 8
lseg_turquoise_analytics_gtp_v24_4.third_reserved_8 = {}

-- Size: Third Reserved 8
lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.size = 8

-- Display: Third Reserved 8
lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.display = function(value)
  return "Third Reserved 8: "..value
end

-- Dissect: Third Reserved 8
lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.third_reserved_8, range, value, display)
...
-- Analytics Message
lseg_turquoise_analytics_gtp_v24_4.analytics_message = {}

-- Size: Analytics Message
lseg_turquoise_analytics_gtp_v24_4.analytics_message.size =
...
lseg_turquoise_analytics_gtp_v24_4.analytics_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Analytics Message
lseg_turquoise_analytics_gtp_v24_4.analytics_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_turquoise_analytics_gtp_v24_4.analytics_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.analytics_message, buffer(offset, 0))
    local index = lseg_turquoise_analytics_gtp_v24_4.analytics_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_turquoise_analytics_gtp_v24_4.analytics_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_turquoise_analytics_gtp_v24_4.analytics_message.fields(buffer, offset, packet, parent)
  end
end
...
lseg_turquoise_analytics_gtp_v24_4.allowed_book_types.display = function(range, value, packet, parent)
  local flags = {}
...
lseg_turquoise_analytics_gtp_v24_4.allowed_book_types.dissect = function(buffer, offset, packet, parent)
  local size = lseg_turquoise_analytics_gtp_v24_4.allowed_book_types.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = lseg_turquoise_analytics_gtp_v24_4.allowed_book_types.display(range, value, packet, parent)
  local element = parent:add(omi_lseg_turquoise_analytics_gtp_v24_4.fields.allowed_book_types, range, display)

  if show.structs then
    lseg_turquoise_analytics_gtp_v24_4.allowed_book_types.bits(range, value, packet, element)
  end
...
lseg_turquoise_analytics_gtp_v24_4.instrument_directory_message.size =
  ...
  lseg_turquoise_analytics_gtp_v24_4.reserved_12.size + 
  lseg_turquoise_analytics_gtp_v24_4.reserved_11.size + 
  lseg_turquoise_analytics_gtp_v24_4.currency.size + 
  lseg_turquoise_analytics_gtp_v24_4.reserved_1.size + 
  lseg_turquoise_analytics_gtp_v24_4.reserved_4.size + 
  lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.size + 
  lseg_turquoise_analytics_gtp_v24_4.reserved_8.size + 
  lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.size + 
  lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.size + 
  lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.size
...
lseg_turquoise_analytics_gtp_v24_4.instrument_directory_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Reserved 12: Alpha
  index, reserved_12 = lseg_turquoise_analytics_gtp_v24_4.reserved_12.dissect(buffer, index, packet, parent)

  -- Reserved 11: Alpha
  index, reserved_11 = lseg_turquoise_analytics_gtp_v24_4.reserved_11.dissect(buffer, index, packet, parent)

  -- Currency: Alpha
  index, currency = lseg_turquoise_analytics_gtp_v24_4.currency.dissect(buffer, index, packet, parent)

  -- Reserved 1: Byte
  index, reserved_1 = lseg_turquoise_analytics_gtp_v24_4.reserved_1.dissect(buffer, index, packet, parent)

  -- Reserved 4: Alpha
  index, reserved_4 = lseg_turquoise_analytics_gtp_v24_4.reserved_4.dissect(buffer, index, packet, parent)

  -- Average Daily Turnover Adt: Price4
  index, average_daily_turnover_adt = lseg_turquoise_analytics_gtp_v24_4.average_daily_turnover_adt.dissect(buffer, index, packet, parent)

  -- Reserved 8: Alpha
  index, reserved_8 = lseg_turquoise_analytics_gtp_v24_4.reserved_8.dissect(buffer, index, packet, parent)

  -- Second Reserved 1: Byte
  index, second_reserved_1 = lseg_turquoise_analytics_gtp_v24_4.second_reserved_1.dissect(buffer, index, packet, parent)

  -- Second Reserved 8: Alpha
  index, second_reserved_8 = lseg_turquoise_analytics_gtp_v24_4.second_reserved_8.dissect(buffer, index, packet, parent)

  -- Third Reserved 8: Alpha
  index, third_reserved_8 = lseg_turquoise_analytics_gtp_v24_4.third_reserved_8.dissect(buffer, index, packet, parent)
...
lseg_turquoise_analytics_gtp_v24_4.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0x61 then
    return lseg_turquoise_analytics_gtp_v24_4.analytics_message.dissect(buffer, offset, packet, parent)
  end
...
-- Dissector Heuristic for Lseg Turquoise Analytics Gtp 24.4 (Udp)
local function omi_lseg_turquoise_analytics_gtp_v24_4_udp_heuristic(buffer, packet, parent)
...
omi_lseg_turquoise_analytics_gtp_v24_4:register_heuristic("udp", omi_lseg_turquoise_analytics_gtp_v24_4_udp_heuristic)

-- Register Lseg Turquoise Analytics Gtp 24.4 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_lseg_turquoise_analytics_gtp_v24_4)
