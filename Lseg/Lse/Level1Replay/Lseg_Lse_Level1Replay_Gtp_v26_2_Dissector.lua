...
omi_lseg_lse_level1replay_gtp_v26_2.fields.reserved_1 = ProtoField.new("Reserved 1", "lseg.lse.level1replay.gtp.v26.2.reserved1", ftypes.BYTES)
...
omi_lseg_lse_level1replay_gtp_v26_2.fields.tcp_unit = ProtoField.new("Tcp Unit", "lseg.lse.level1replay.gtp.v26.2.tcpunit", ftypes.STRING)
...
omi_lseg_lse_level1replay_gtp_v26_2.fields.unused_1 = ProtoField.new("Unused 1", "lseg.lse.level1replay.gtp.v26.2.unused1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_lseg_lse_level1replay_gtp_v26_2.fields.unused_3 = ProtoField.new("Unused 3", "lseg.lse.level1replay.gtp.v26.2.unused3", ftypes.UINT8, nil, base.DEC, 0xE0)
omi_lseg_lse_level1replay_gtp_v26_2.fields.unused_6 = ProtoField.new("Unused 6", "lseg.lse.level1replay.gtp.v26.2.unused6", ftypes.UINT8, nil, base.DEC, 0xFC)
...
-- Lseg Lse Level1Replay Gtp 26.2 Framing
...
-- Display: Reserved 1
lseg_lse_level1replay_gtp_v26_2.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
lseg_lse_level1replay_gtp_v26_2.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = lseg_lse_level1replay_gtp_v26_2.reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_lse_level1replay_gtp_v26_2.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_lse_level1replay_gtp_v26_2.fields.reserved_1, range, value, display)
...
lseg_lse_level1replay_gtp_v26_2.trade_flags.bits = function(range, value, packet, parent)
  ...
  -- Unused 6: 6 Bit
  parent:add(omi_lseg_lse_level1replay_gtp_v26_2.fields.unused_6, range, value)
end
...
lseg_lse_level1replay_gtp_v26_2.allowed_book_types.bits = function(range, value, packet, parent)
  ...
  -- Unused 1: 1 Bit
  parent:add(omi_lseg_lse_level1replay_gtp_v26_2.fields.unused_1, range, value)
  ...
  -- Unused 3: 3 Bit
  parent:add(omi_lseg_lse_level1replay_gtp_v26_2.fields.unused_3, range, value)
end
...
-- Tcp Unit
lseg_lse_level1replay_gtp_v26_2.tcp_unit = {}

-- Display: Tcp Unit
lseg_lse_level1replay_gtp_v26_2.tcp_unit.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Tcp Unit
lseg_lse_level1replay_gtp_v26_2.tcp_unit.fields = function(buffer, offset, packet, parent, size_of_tcp_unit)
  local index = offset
...
-- Dissect: Tcp Unit
lseg_lse_level1replay_gtp_v26_2.tcp_unit.dissect = function(buffer, offset, packet, parent, size_of_tcp_unit)
  local index = offset + size_of_tcp_unit

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_lseg_lse_level1replay_gtp_v26_2.fields.tcp_unit, buffer(offset, 0))
    local current = lseg_lse_level1replay_gtp_v26_2.tcp_unit.fields(buffer, offset, packet, parent, size_of_tcp_unit)
    parent:set_len(size_of_tcp_unit)
    local display = lseg_lse_level1replay_gtp_v26_2.tcp_unit.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    lseg_lse_level1replay_gtp_v26_2.tcp_unit.fields(buffer, offset, packet, parent, size_of_tcp_unit)
...
local tcp_unit_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < lseg_lse_level1replay_gtp_v26_2.unit_header.size then
...
lseg_lse_level1replay_gtp_v26_2.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = lseg_lse_level1replay_gtp_v26_2.tcp_unit.dissect(buffer, index, packet, parent, size_of_tcp_unit)
    else
