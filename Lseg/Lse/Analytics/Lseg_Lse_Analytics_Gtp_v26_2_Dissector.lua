...
omi_lseg_lse_analytics_gtp_v26_2.fields.reserved_1 = ProtoField.new("Reserved 1", "lseg.lse.analytics.gtp.v26.2.reserved1", ftypes.BYTES)
...
omi_lseg_lse_analytics_gtp_v26_2.fields.unused_1 = ProtoField.new("Unused 1", "lseg.lse.analytics.gtp.v26.2.unused1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_lseg_lse_analytics_gtp_v26_2.fields.unused_3 = ProtoField.new("Unused 3", "lseg.lse.analytics.gtp.v26.2.unused3", ftypes.UINT8, nil, base.DEC, 0xE0)
...
-- Lseg Lse Analytics Gtp 26.2 Framing
...
-- Display: Reserved 1
lseg_lse_analytics_gtp_v26_2.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
lseg_lse_analytics_gtp_v26_2.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = lseg_lse_analytics_gtp_v26_2.reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = lseg_lse_analytics_gtp_v26_2.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_lseg_lse_analytics_gtp_v26_2.fields.reserved_1, range, value, display)
...
lseg_lse_analytics_gtp_v26_2.allowed_book_types.bits = function(range, value, packet, parent)
  ...
  -- Unused 1: 1 Bit
  parent:add(omi_lseg_lse_analytics_gtp_v26_2.fields.unused_1, range, value)
  ...
  -- Unused 3: 3 Bit
  parent:add(omi_lseg_lse_analytics_gtp_v26_2.fields.unused_3, range, value)
end
