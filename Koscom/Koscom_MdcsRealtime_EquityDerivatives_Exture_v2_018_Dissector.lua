...
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.call_reinvestment_index_krx = ProtoField.new("Call Re-Investment Index Krx", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.callreinvestmentindexkrx", ftypes.DOUBLE)
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.call_reinvestment_index_ktb = ProtoField.new("Call Re-Investment Index Ktb", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.callreinvestmentindexktb", ftypes.DOUBLE)
...
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.clean_price_index_krx = ProtoField.new("Clean Price Index Krx", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.cleanpriceindexkrx", ftypes.DOUBLE)
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.clean_price_index_ktb = ProtoField.new("Clean Price Index Ktb", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.cleanpriceindexktb", ftypes.DOUBLE)
...
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.coupon_payment_timing_code = ProtoField.new("Coupon Payment Timing Code", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.couponpaymenttimingcode", ftypes.STRING)
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.coupon_payment_type_code = ProtoField.new("Coupon Payment Type Code", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.couponpaymenttypecode", ftypes.STRING)
...
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.market_price_index_krx = ProtoField.new("Market Price Index Krx", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.marketpriceindexkrx", ftypes.DOUBLE)
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.market_price_index_ktb = ProtoField.new("Market Price Index Ktb", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.marketpriceindexktb", ftypes.DOUBLE)
...
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.zero_reinvestment_index_krx = ProtoField.new("Zero Re-Investment Index Krx", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.zeroreinvestmentindexkrx", ftypes.DOUBLE)
omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.zero_reinvestment_index_ktb = ProtoField.new("Zero Re-Investment Index Ktb", "koscom.mdcsrealtime.equityderivatives.exture.v2.018.zeroreinvestmentindexktb", ftypes.DOUBLE)

-- Koscom MdcsRealtime EquityDerivatives Exture 2.018 Framing
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_krx = {}

-- Size: Call Re-Investment Index Krx
koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_krx.size = 16
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_krx.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_krx.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.call_reinvestment_index_krx, range, value, display)

  return offset + length, value
end

-- Call Re-Investment Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_ktb = {}

-- Size: Call Re-Investment Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_ktb.size = 11
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_ktb.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_ktb.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.call_reinvestment_index_ktb, range, value, display)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_krx = {}

-- Size: Clean Price Index Krx
koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_krx.size = 16
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_krx.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_krx.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.clean_price_index_krx, range, value, display)

  return offset + length, value
end

-- Clean Price Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_ktb = {}

-- Size: Clean Price Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_ktb.size = 11
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_ktb.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_ktb.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.clean_price_index_ktb, range, value, display)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_timing_code = {}

-- Size: Coupon Payment Timing Code
koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_timing_code.size = 1
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code = {}

-- Size: Coupon Payment Type Code
koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code.size = 2
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string(koscom_mdcsrealtime_equityderivatives_exture_v2_018.text_encoding))
  local display = koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code.display(value, buffer, offset, packet, parent)

  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.coupon_payment_type_code, range, value, display)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_krx = {}

-- Size: Market Price Index Krx
koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_krx.size = 16
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_krx.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_krx.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.market_price_index_krx, range, value, display)

  return offset + length, value
end

-- Market Price Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_ktb = {}

-- Size: Market Price Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_ktb.size = 11
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_ktb.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_ktb.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.market_price_index_ktb, range, value, display)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_krx = {}

-- Size: Zero Re-Investment Index Krx
koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_krx.size = 16
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_krx.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_krx.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.zero_reinvestment_index_krx, range, value, display)

  return offset + length, value
end

-- Zero Re-Investment Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_ktb = {}

-- Size: Zero Re-Investment Index Ktb
koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_ktb.size = 11
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_ktb.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_ktb.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  parent:add(omi_koscom_mdcsrealtime_equityderivatives_exture_v2_018.fields.zero_reinvestment_index_ktb, range, value, display)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.corporate_bonds_reference_message.size =
  ...
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code.size + 
  ...
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_timing_code.size + 
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.corporate_bonds_reference_message.fields = function(buffer, offset, packet, parent)
  ...
  index, coupon_payment_type_code = koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_type_code.dissect(buffer, index, packet, parent)
  ...
  index, coupon_payment_timing_code = koscom_mdcsrealtime_equityderivatives_exture_v2_018.coupon_payment_timing_code.dissect(buffer, index, packet, parent)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.bond_index_krx_message.size =
  ...
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.index_id.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_krx.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.total_earnings_index.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_krx.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_krx.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_krx.size + 
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.bond_index_krx_message.fields = function(buffer, offset, packet, parent)
  ...
  index, clean_price_index_krx = koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_krx.dissect(buffer, index, packet, parent)
  ...
  index, market_price_index_krx = koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_krx.dissect(buffer, index, packet, parent)

  -- Zero Re-Investment Index Krx: FLOAT128
  index, zero_reinvestment_index_krx = koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_krx.dissect(buffer, index, packet, parent)

  -- Call Re-Investment Index Krx: FLOAT128
  index, call_reinvestment_index_krx = koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_krx.dissect(buffer, index, packet, parent)
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.bond_ktb_index_message.size =
  ...
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_ktb.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_ktb.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_ktb.size + 
  koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_ktb.size + 
...
koscom_mdcsrealtime_equityderivatives_exture_v2_018.bond_ktb_index_message.fields = function(buffer, offset, packet, parent)
  ...
  index, clean_price_index_ktb = koscom_mdcsrealtime_equityderivatives_exture_v2_018.clean_price_index_ktb.dissect(buffer, index, packet, parent)

  -- Market Price Index Ktb: Double
  index, market_price_index_ktb = koscom_mdcsrealtime_equityderivatives_exture_v2_018.market_price_index_ktb.dissect(buffer, index, packet, parent)

  -- Call Re-Investment Index Ktb: Double
  index, call_reinvestment_index_ktb = koscom_mdcsrealtime_equityderivatives_exture_v2_018.call_reinvestment_index_ktb.dissect(buffer, index, packet, parent)

  -- Zero Re-Investment Index Ktb: Double
  index, zero_reinvestment_index_ktb = koscom_mdcsrealtime_equityderivatives_exture_v2_018.zero_reinvestment_index_ktb.dissect(buffer, index, packet, parent)
