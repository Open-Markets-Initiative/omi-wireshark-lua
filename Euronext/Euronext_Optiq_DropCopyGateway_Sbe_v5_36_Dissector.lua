...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_trade_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.price.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_quote_message_offer_quoterep_group.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.size + 
