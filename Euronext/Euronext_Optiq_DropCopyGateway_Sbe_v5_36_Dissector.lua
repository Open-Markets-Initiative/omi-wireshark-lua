...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type = ProtoField.new("Account Type", "euronext.optiq.dropcopygateway.sbe.v5.36.accounttype", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type_internal = ProtoField.new("Account Type Internal", "euronext.optiq.dropcopygateway.sbe.v5.36.accounttypeinternal", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type_internal_optional = ProtoField.new("Account Type Internal Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.accounttypeinternaloptional", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type_optional = ProtoField.new("Account Type Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.accounttypeoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.block_length_short = ProtoField.new("Block Length Short", "euronext.optiq.dropcopygateway.sbe.v5.36.blocklengthshort", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.book_in_optional = ProtoField.new("Book In Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.bookinoptional", ftypes.UINT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.book_out_time = ProtoField.new("Book Out Time", "euronext.optiq.dropcopygateway.sbe.v5.36.bookouttime", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.book_out_time_optional = ProtoField.new("Book Out Time Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.bookouttimeoptional", ftypes.UINT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_firm_id = ProtoField.new("Clearing Firm Id", "euronext.optiq.dropcopygateway.sbe.v5.36.clearingfirmid", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_firm_id_optional = ProtoField.new("Clearing Firm Id Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.clearingfirmidoptional", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_instruction = ProtoField.new("Clearing Instruction", "euronext.optiq.dropcopygateway.sbe.v5.36.clearinginstruction", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_instruction_optional = ProtoField.new("Clearing Instruction Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.clearinginstructionoptional", ftypes.UINT16)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.client_order_id = ProtoField.new("Client Order Id", "euronext.optiq.dropcopygateway.sbe.v5.36.clientorderid", ftypes.INT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.client_order_id_optional = ProtoField.new("Client Order Id Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.clientorderidoptional", ftypes.INT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.cross_order_indicator = ProtoField.new("Cross Order Indicator", "euronext.optiq.dropcopygateway.sbe.v5.36.crossorderindicator", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.cross_order_indicator_optional = ProtoField.new("Cross Order Indicator Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.crossorderindicatoroptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.error_code = ProtoField.new("Error Code", "euronext.optiq.dropcopygateway.sbe.v5.36.errorcode", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.error_code_optional = ProtoField.new("Error Code Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.errorcodeoptional", ftypes.UINT16)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_id = ProtoField.new("Execution Id", "euronext.optiq.dropcopygateway.sbe.v5.36.executionid", ftypes.UINT32)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_id_optional = ProtoField.new("Execution Id Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.executionidoptional", ftypes.UINT32)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_instruction = ProtoField.new("Execution Instruction", "euronext.optiq.dropcopygateway.sbe.v5.36.executioninstruction", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_instruction_optional = ProtoField.new("Execution Instruction Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.executioninstructionoptional", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_phase = ProtoField.new("Execution Phase", "euronext.optiq.dropcopygateway.sbe.v5.36.executionphase", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_phase_optional = ProtoField.new("Execution Phase Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.executionphaseoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.guarantee_flag = ProtoField.new("Guarantee Flag", "euronext.optiq.dropcopygateway.sbe.v5.36.guaranteeflag", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.guarantee_flag_optional = ProtoField.new("Guarantee Flag Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.guaranteeflagoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_shares = ProtoField.new("Last Shares", "euronext.optiq.dropcopygateway.sbe.v5.36.lastshares", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_shares_optional = ProtoField.new("Last Shares Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.lastsharesoptional", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_traded_px = ProtoField.new("Last Traded Px", "euronext.optiq.dropcopygateway.sbe.v5.36.lasttradedpx", ftypes.INT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_traded_px_optional = ProtoField.new("Last Traded Px Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.lasttradedpxoptional", ftypes.INT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.logical_access_id = ProtoField.new("Logical Access Id", "euronext.optiq.dropcopygateway.sbe.v5.36.logicalaccessid", ftypes.UINT32)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.logical_access_id_optional = ProtoField.new("Logical Access Id Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.logicalaccessidoptional", ftypes.UINT32)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_additional_infos_group = ProtoField.new("Long Order Additional Infos Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderadditionalinfosgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_additional_infos_groups = ProtoField.new("Long Order Additional Infos Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderadditionalinfosgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_clearing_fields_group = ProtoField.new("Long Order Clearing Fields Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderclearingfieldsgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_clearing_fields_groups = ProtoField.new("Long Order Clearing Fields Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderclearingfieldsgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_commercial_fields_group = ProtoField.new("Long Order Commercial Fields Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordercommercialfieldsgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_commercial_fields_groups = ProtoField.new("Long Order Commercial Fields Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordercommercialfieldsgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_extended_clearing_account_group = ProtoField.new("Long Order Extended Clearing Account Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderextendedclearingaccountgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_extended_clearing_account_groups = ProtoField.new("Long Order Extended Clearing Account Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderextendedclearingaccountgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_free_text_section_group = ProtoField.new("Long Order Free Text Section Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderfreetextsectiongroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_free_text_section_groups = ProtoField.new("Long Order Free Text Section Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderfreetextsectiongroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_commercial_investor_field_group = ProtoField.new("Long Order Modifiable Commercial Investor Field Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermodifiablecommercialinvestorfieldgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_commercial_investor_field_groups = ProtoField.new("Long Order Modifiable Commercial Investor Field Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermodifiablecommercialinvestorfieldgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_short_codes_group = ProtoField.new("Long Order Modifiable Short Codes Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermodifiableshortcodesgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_short_codes_groups = ProtoField.new("Long Order Modifiable Short Codes Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermodifiableshortcodesgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_commercial_investor_field_group = ProtoField.new("Long Order Non Modifiable Commercial Investor Field Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiablecommercialinvestorfieldgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_commercial_investor_field_groups = ProtoField.new("Long Order Non Modifiable Commercial Investor Field Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiablecommercialinvestorfieldgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_opt_fields_group = ProtoField.new("Long Order Non Modifiable Opt Fields Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiableoptfieldsgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_opt_fields_groups = ProtoField.new("Long Order Non Modifiable Opt Fields Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiableoptfieldsgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_short_codes_group = ProtoField.new("Long Order Non Modifiable Short Codes Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiableshortcodesgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_short_codes_groups = ProtoField.new("Long Order Non Modifiable Short Codes Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiableshortcodesgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_derivatives_group = ProtoField.new("Long Order Optional Fields Derivatives Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderoptionalfieldsderivativesgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_derivatives_groups = ProtoField.new("Long Order Optional Fields Derivatives Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderoptionalfieldsderivativesgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_group = ProtoField.new("Long Order Optional Fields Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderoptionalfieldsgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_groups = ProtoField.new("Long Order Optional Fields Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderoptionalfieldsgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_modifiable_group = ProtoField.new("Long Order Short Codes Details Modifiable Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordershortcodesdetailsmodifiablegroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_modifiable_groups = ProtoField.new("Long Order Short Codes Details Modifiable Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordershortcodesdetailsmodifiablegroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_non_modifiable_group = ProtoField.new("Long Order Short Codes Details Non Modifiable Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longordershortcodesdetailsnonmodifiablegroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_non_modifiable_groups = ProtoField.new("Long Order Short Codes Details Non Modifiable Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longordershortcodesdetailsnonmodifiablegroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_strategy_fields_group = ProtoField.new("Long Order Strategy Fields Group", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderstrategyfieldsgroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_strategy_fields_groups = ProtoField.new("Long Order Strategy Fields Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderstrategyfieldsgroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.lp_role = ProtoField.new("Lp Role", "euronext.optiq.dropcopygateway.sbe.v5.36.lprole", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.lp_role_optional = ProtoField.new("Lp Role Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.lproleoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.mi_fid_indicators = ProtoField.new("Mi Fid Indicators", "euronext.optiq.dropcopygateway.sbe.v5.36.mifidindicators", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.mi_fid_indicators_optional = ProtoField.new("Mi Fid Indicators Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.mifidindicatorsoptional", ftypes.STRING)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_partition_id = ProtoField.new("Oe Partition Id", "euronext.optiq.dropcopygateway.sbe.v5.36.oepartitionid", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_partition_id_optional = ProtoField.new("Oe Partition Id Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.oepartitionidoptional", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_session_id = ProtoField.new("Oe Session Id", "euronext.optiq.dropcopygateway.sbe.v5.36.oesessionid", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_session_id_optional = ProtoField.new("Oe Session Id Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.oesessionidoptional", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegin_from_member = ProtoField.new("Oegin From Member", "euronext.optiq.dropcopygateway.sbe.v5.36.oeginfrommember", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegin_from_member_optional = ProtoField.new("Oegin From Member Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.oeginfrommemberoptional", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegout_time_to_me = ProtoField.new("Oegout Time To Me", "euronext.optiq.dropcopygateway.sbe.v5.36.oegouttimetome", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegout_time_to_me_optional = ProtoField.new("Oegout Time To Me Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.oegouttimetomeoptional", ftypes.UINT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.order_side = ProtoField.new("Order Side", "euronext.optiq.dropcopygateway.sbe.v5.36.orderside", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.order_side_optional = ProtoField.new("Order Side Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.ordersideoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.price = ProtoField.new("Price", "euronext.optiq.dropcopygateway.sbe.v5.36.price", ftypes.INT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.price_optional = ProtoField.new("Price Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.priceoptional", ftypes.INT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.quantity = ProtoField.new("Quantity", "euronext.optiq.dropcopygateway.sbe.v5.36.quantity", ftypes.UINT64)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.quantity_optional = ProtoField.new("Quantity Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.quantityoptional", ftypes.UINT64)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.rfe_answer = ProtoField.new("Rfe Answer", "euronext.optiq.dropcopygateway.sbe.v5.36.rfeanswer", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.rfe_answer_optional = ProtoField.new("Rfe Answer Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.rfeansweroptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.session = ProtoField.new("Session", "euronext.optiq.dropcopygateway.sbe.v5.36.session", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.session_optional = ProtoField.new("Session Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.sessionoptional", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_flag = ProtoField.new("Settlement Flag", "euronext.optiq.dropcopygateway.sbe.v5.36.settlementflag", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_flag_optional = ProtoField.new("Settlement Flag Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.settlementflagoptional", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_period = ProtoField.new("Settlement Period", "euronext.optiq.dropcopygateway.sbe.v5.36.settlementperiod", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_period_optional = ProtoField.new("Settlement Period Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.settlementperiodoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.time_in_force = ProtoField.new("Time In Force", "euronext.optiq.dropcopygateway.sbe.v5.36.timeinforce", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.time_in_force_optional = ProtoField.new("Time In Force Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.timeinforceoptional", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_modifiable_group = ProtoField.new("Trade Bust Notification Short Codes Details Modifiable Group", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationshortcodesdetailsmodifiablegroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_modifiable_groups = ProtoField.new("Trade Bust Notification Short Codes Details Modifiable Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationshortcodesdetailsmodifiablegroups", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_non_modifiable_group = ProtoField.new("Trade Bust Notification Short Codes Details Non Modifiable Group", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationshortcodesdetailsnonmodifiablegroup", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_non_modifiable_groups = ProtoField.new("Trade Bust Notification Short Codes Details Non Modifiable Groups", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationshortcodesdetailsnonmodifiablegroups", ftypes.STRING)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_qualifier = ProtoField.new("Trade Qualifier", "euronext.optiq.dropcopygateway.sbe.v5.36.tradequalifier", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_qualifier_optional = ProtoField.new("Trade Qualifier Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.tradequalifieroptional", ftypes.STRING)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trading_capacity = ProtoField.new("Trading Capacity", "euronext.optiq.dropcopygateway.sbe.v5.36.tradingcapacity", ftypes.UINT8)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trading_capacity_optional = ProtoField.new("Trading Capacity Optional", "euronext.optiq.dropcopygateway.sbe.v5.36.tradingcapacityoptional", ftypes.UINT8)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_message = ProtoField.new("Long Order Message", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermessage", ftypes.STRING)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_message = ProtoField.new("Trade Bust Notification Message", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationmessage", ftypes.STRING)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_additional_infos_group_index = ProtoField.new("Long Order Additional Infos Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderadditionalinfosgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_clearing_fields_group_index = ProtoField.new("Long Order Clearing Fields Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderclearingfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_commercial_fields_group_index = ProtoField.new("Long Order Commercial Fields Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordercommercialfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_extended_clearing_account_group_index = ProtoField.new("Long Order Extended Clearing Account Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderextendedclearingaccountgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_free_text_section_group_index = ProtoField.new("Long Order Free Text Section Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderfreetextsectiongroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_commercial_investor_field_group_index = ProtoField.new("Long Order Modifiable Commercial Investor Field Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermodifiablecommercialinvestorfieldgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_short_codes_group_index = ProtoField.new("Long Order Modifiable Short Codes Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordermodifiableshortcodesgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_commercial_investor_field_group_index = ProtoField.new("Long Order Non Modifiable Commercial Investor Field Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiablecommercialinvestorfieldgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_opt_fields_group_index = ProtoField.new("Long Order Non Modifiable Opt Fields Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiableoptfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_short_codes_group_index = ProtoField.new("Long Order Non Modifiable Short Codes Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordernonmodifiableshortcodesgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_derivatives_group_index = ProtoField.new("Long Order Optional Fields Derivatives Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderoptionalfieldsderivativesgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_group_index = ProtoField.new("Long Order Optional Fields Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderoptionalfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_modifiable_group_index = ProtoField.new("Long Order Short Codes Details Modifiable Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordershortcodesdetailsmodifiablegroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_non_modifiable_group_index = ProtoField.new("Long Order Short Codes Details Non Modifiable Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longordershortcodesdetailsnonmodifiablegroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_strategy_fields_group_index = ProtoField.new("Long Order Strategy Fields Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.longorderstrategyfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_modifiable_group_index = ProtoField.new("Trade Bust Notification Short Codes Details Modifiable Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationshortcodesdetailsmodifiablegroupindex", ftypes.UINT16)
omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_non_modifiable_group_index = ProtoField.new("Trade Bust Notification Short Codes Details Non Modifiable Group Index", "euronext.optiq.dropcopygateway.sbe.v5.36.tradebustnotificationshortcodesdetailsnonmodifiablegroupindex", ftypes.UINT16)
...
omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
...
function omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs_changed()
  ...
  if show.headers ~= omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_headers then
    show.headers = omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_headers
  end
  if show.repeating_groups ~= omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_repeating_groups then
    show.repeating_groups = omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_repeating_groups
  end
  if show.structs ~= omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_structs then
    show.structs = omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_structs
  end
  if show.indexes ~= omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_indexes then
    show.indexes = omi_euronext_optiq_dropcopygateway_sbe_v5_36.prefs.show_indexes
  end
end
...
-- Account Type
euronext_optiq_dropcopygateway_sbe_v5_36.account_type = {}

-- Size: Account Type
euronext_optiq_dropcopygateway_sbe_v5_36.account_type.size = 1

-- Display: Account Type
euronext_optiq_dropcopygateway_sbe_v5_36.account_type.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.account_type.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.account_type.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.account_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type, range, value, display)
...
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal = {}

-- Size: Account Type Internal
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.size = 1

-- Display: Account Type Internal
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type_internal, range, value, display)

  return offset + length, value
end

-- Account Type Internal Optional
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional = {}

-- Size: Account Type Internal Optional
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.size = 1

-- Display: Account Type Internal Optional
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type_internal_optional, range, value, display)

  return offset + length, value
end

-- Account Type Optional
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional = {}

-- Size: Account Type Optional
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.size = 1

-- Display: Account Type Optional
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.account_type_optional, range, value, display)
...
-- Block Length Short
euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short = {}

-- Size: Block Length Short
euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.size = 1

-- Display: Block Length Short
euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.display = function(value)
  return "Block Length Short: "..value
end

-- Dissect: Block Length Short
euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.block_length_short, range, value, display)
...
-- Book In Optional
euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional = {}

-- Size: Book In Optional
euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.size = 8

-- Display: Book In Optional
euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.book_in_optional, range, value, display)
...
-- Book Out Time
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time = {}

-- Size: Book Out Time
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.size = 8

-- Display: Book Out Time
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.display = function(value)
  return "Book Out Time: "..value
end

-- Dissect: Book Out Time
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.book_out_time, range, value, display)

  return offset + length, value
end

-- Book Out Time Optional
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional = {}

-- Size: Book Out Time Optional
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.size = 8

-- Display: Book Out Time Optional
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.book_out_time_optional, range, value, display)
...
-- Clearing Firm Id
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id = {}

-- Size: Clearing Firm Id
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.size = 8

-- Display: Clearing Firm Id
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.size
  local range = buffer(offset, length)
  ...
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_firm_id, range, value, display)

  return offset + length, value
end

-- Clearing Firm Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional = {}

-- Size: Clearing Firm Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size = 8

-- Display: Clearing Firm Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size
  local range = buffer(offset, length)
  ...
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_firm_id_optional, range, value, display)

  return offset + length, value
end

-- Clearing Instruction
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction = {}

-- Size: Clearing Instruction
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.size = 2

-- Display: Clearing Instruction
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.display = function(value)
  if value == 0 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_instruction, range, value, display)

  return offset + length, value
end

-- Clearing Instruction Optional
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional = {}

-- Size: Clearing Instruction Optional
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.size = 2

-- Display: Clearing Instruction Optional
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.display = function(value)
  if value == 0 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.clearing_instruction_optional, range, value, display)
...
-- Client Order Id
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id = {}

-- Size: Client Order Id
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.size = 8

-- Display: Client Order Id
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.display = function(value)
  return "Client Order Id: "..value
end

-- Dissect: Client Order Id
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.client_order_id, range, value, display)

  return offset + length, value
end

-- Client Order Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional = {}

-- Size: Client Order Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.size = 8

-- Display: Client Order Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.display = function(value)
  -- Check if field has value
  if value == Int64(0x00000000, 0x80000000) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.client_order_id_optional, range, value, display)
...
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator = {}

-- Size: Cross Order Indicator
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.size = 1

-- Display: Cross Order Indicator
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.display = function(value)
  return "Cross Order Indicator: "..value
end

-- Dissect: Cross Order Indicator
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.cross_order_indicator, range, value, display)

  return offset + length, value
end

-- Cross Order Indicator Optional
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional = {}

-- Size: Cross Order Indicator Optional
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.size = 1

-- Display: Cross Order Indicator Optional
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.display = function(value)
  -- Check if field has value
  if value == 255 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.cross_order_indicator_optional, range, value, display)
...
-- Error Code
euronext_optiq_dropcopygateway_sbe_v5_36.error_code = {}

-- Size: Error Code
euronext_optiq_dropcopygateway_sbe_v5_36.error_code.size = 2

-- Display: Error Code
euronext_optiq_dropcopygateway_sbe_v5_36.error_code.display = function(value)
  return "Error Code: "..value
end

-- Dissect: Error Code
euronext_optiq_dropcopygateway_sbe_v5_36.error_code.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.error_code.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.error_code.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.error_code, range, value, display)

  return offset + length, value
end

-- Error Code Optional
euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional = {}

-- Size: Error Code Optional
euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.size = 2

-- Display: Error Code Optional
euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.display = function(value)
  -- Check if field has value
  if value == 65535 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.error_code_optional, range, value, display)
...
-- Execution Id
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id = {}

-- Size: Execution Id
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.size = 4

-- Display: Execution Id
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.display = function(value)
  return "Execution Id: "..value
end

-- Dissect: Execution Id
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_id, range, value, display)

  return offset + length, value
end

-- Execution Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional = {}

-- Size: Execution Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.size = 4

-- Display: Execution Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.display = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_id_optional, range, value, display)

  return offset + length, value
end

-- Execution Phase
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase = {}

-- Size: Execution Phase
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.size = 1

-- Display: Execution Phase
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_phase, range, value, display)

  return offset + length, value
end

-- Execution Phase Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional = {}

-- Size: Execution Phase Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.size = 1

-- Display: Execution Phase Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_phase_optional, range, value, display)
...
-- Guarantee Flag
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag = {}

-- Size: Guarantee Flag
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.size = 1

-- Display: Guarantee Flag
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.guarantee_flag, range, value, display)

  return offset + length, value
end

-- Guarantee Flag Optional
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional = {}

-- Size: Guarantee Flag Optional
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.size = 1

-- Display: Guarantee Flag Optional
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.guarantee_flag_optional, range, value, display)
...
-- Last Shares
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares = {}

-- Size: Last Shares
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.size = 8

-- Display: Last Shares
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.display = function(value)
  return "Last Shares: "..value
end

-- Dissect: Last Shares
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_shares, range, value, display)

  return offset + length, value
end

-- Last Shares Optional
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional = {}

-- Size: Last Shares Optional
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.size = 8

-- Display: Last Shares Optional
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_shares_optional, range, value, display)

  return offset + length, value
end

-- Last Traded Px
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px = {}

-- Size: Last Traded Px
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.size = 8

-- Display: Last Traded Px
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.display = function(value)
  return "Last Traded Px: "..value
end

-- Dissect: Last Traded Px
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_traded_px, range, value, display)

  return offset + length, value
end

-- Last Traded Px Optional
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional = {}

-- Size: Last Traded Px Optional
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.size = 8

-- Display: Last Traded Px Optional
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.display = function(value)
  -- Check if field has value
  if value == Int64(0x00000000, 0x80000000) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.last_traded_px_optional, range, value, display)
...
-- Logical Access Id
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id = {}

-- Size: Logical Access Id
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.size = 4

-- Display: Logical Access Id
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.display = function(value)
  return "Logical Access Id: "..value
end

-- Dissect: Logical Access Id
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.logical_access_id, range, value, display)

  return offset + length, value
end

-- Logical Access Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional = {}

-- Size: Logical Access Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.size = 4

-- Display: Logical Access Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.display = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.logical_access_id_optional, range, value, display)
...
-- Lp Role
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role = {}

-- Size: Lp Role
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.size = 1

-- Display: Lp Role
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.display = function(value)
  if value == 1 then
...
-- Dissect: Lp Role
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.lp_role, range, value, display)

  return offset + length, value
end

-- Lp Role Optional
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional = {}

-- Size: Lp Role Optional
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.size = 1

-- Display: Lp Role Optional
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.lp_role_optional, range, value, display)
...
-- Oe Partition Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id = {}

-- Size: Oe Partition Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.size = 2

-- Display: Oe Partition Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.display = function(value)
  return "Oe Partition Id: "..value
end

-- Dissect: Oe Partition Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_partition_id, range, value, display)

  return offset + length, value
end

-- Oe Partition Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional = {}

-- Size: Oe Partition Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.size = 2

-- Display: Oe Partition Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.display = function(value)
  -- Check if field has value
  if value == 65535 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_partition_id_optional, range, value, display)

  return offset + length, value
end

-- Oe Session Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id = {}

-- Size: Oe Session Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.size = 8

-- Display: Oe Session Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.display = function(value)
  return "Oe Session Id: "..value
end

-- Dissect: Oe Session Id
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_session_id, range, value, display)

  return offset + length, value
end

-- Oe Session Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional = {}

-- Size: Oe Session Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.size = 8

-- Display: Oe Session Id Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oe_session_id_optional, range, value, display)

  return offset + length, value
end

-- Oegin From Member
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member = {}

-- Size: Oegin From Member
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.size = 8

-- Display: Oegin From Member
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.display = function(value)
  return "Oegin From Member: "..value
end

-- Dissect: Oegin From Member
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegin_from_member, range, value, display)

  return offset + length, value
end

-- Oegin From Member Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional = {}

-- Size: Oegin From Member Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.size = 8

-- Display: Oegin From Member Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegin_from_member_optional, range, value, display)

  return offset + length, value
end

-- Oegout Time To Me
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me = {}

-- Size: Oegout Time To Me
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.size = 8

-- Display: Oegout Time To Me
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.display = function(value)
  return "Oegout Time To Me: "..value
end

-- Dissect: Oegout Time To Me
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegout_time_to_me, range, value, display)

  return offset + length, value
end

-- Oegout Time To Me Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional = {}

-- Size: Oegout Time To Me Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.size = 8

-- Display: Oegout Time To Me Optional
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.oegout_time_to_me_optional, range, value, display)
...
-- Order Side
euronext_optiq_dropcopygateway_sbe_v5_36.order_side = {}

-- Size: Order Side
euronext_optiq_dropcopygateway_sbe_v5_36.order_side.size = 1

-- Display: Order Side
euronext_optiq_dropcopygateway_sbe_v5_36.order_side.display = function(value)
  if value == 1 then
...
-- Dissect: Order Side
euronext_optiq_dropcopygateway_sbe_v5_36.order_side.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.order_side.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.order_side.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.order_side, range, value, display)

  return offset + length, value
end

-- Order Side Optional
euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional = {}

-- Size: Order Side Optional
euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.size = 1

-- Display: Order Side Optional
euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.order_side_optional, range, value, display)
...
-- Price
euronext_optiq_dropcopygateway_sbe_v5_36.price = {}

-- Size: Price
euronext_optiq_dropcopygateway_sbe_v5_36.price.size = 8

-- Display: Price
euronext_optiq_dropcopygateway_sbe_v5_36.price.display = function(value)
  return "Price: "..value
end

-- Dissect: Price
euronext_optiq_dropcopygateway_sbe_v5_36.price.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.price.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.price.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.price, range, value, display)
...
-- Price Optional
euronext_optiq_dropcopygateway_sbe_v5_36.price_optional = {}

-- Size: Price Optional
euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.size = 8

-- Display: Price Optional
euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.display = function(value)
  -- Check if field has value
  if value == Int64(0x00000000, 0x80000000) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.price_optional, range, value, display)
...
-- Quantity
euronext_optiq_dropcopygateway_sbe_v5_36.quantity = {}

-- Size: Quantity
euronext_optiq_dropcopygateway_sbe_v5_36.quantity.size = 8

-- Display: Quantity
euronext_optiq_dropcopygateway_sbe_v5_36.quantity.display = function(value)
  return "Quantity: "..value
end

-- Dissect: Quantity
euronext_optiq_dropcopygateway_sbe_v5_36.quantity.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.quantity.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.quantity.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.quantity, range, value, display)

  return offset + length, value
end

-- Quantity Optional
euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional = {}

-- Size: Quantity Optional
euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.size = 8

-- Display: Quantity Optional
euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.quantity_optional, range, value, display)
...
-- Rfe Answer
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer = {}

-- Size: Rfe Answer
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.size = 1

-- Display: Rfe Answer
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.display = function(value)
  return "Rfe Answer: "..value
end

-- Dissect: Rfe Answer
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.rfe_answer, range, value, display)

  return offset + length, value
end

-- Rfe Answer Optional
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional = {}

-- Size: Rfe Answer Optional
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.size = 1

-- Display: Rfe Answer Optional
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.display = function(value)
  -- Check if field has value
  if value == 255 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.rfe_answer_optional, range, value, display)
...
-- Session
euronext_optiq_dropcopygateway_sbe_v5_36.session = {}

-- Size: Session
euronext_optiq_dropcopygateway_sbe_v5_36.session.size = 1

-- Display: Session
euronext_optiq_dropcopygateway_sbe_v5_36.session.display = function(value)
  if value == 0 then
...
-- Dissect: Session
euronext_optiq_dropcopygateway_sbe_v5_36.session.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.session.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.session.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.session, range, value, display)

  return offset + length, value
end

-- Session Optional
euronext_optiq_dropcopygateway_sbe_v5_36.session_optional = {}

-- Size: Session Optional
euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.size = 1

-- Display: Session Optional
euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.display = function(value)
  if value == 0 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.session_optional, range, value, display)

  return offset + length, value
end

-- Settlement Flag
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag = {}

-- Size: Settlement Flag
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.size = 1

-- Display: Settlement Flag
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.display = function(value)
  return "Settlement Flag: "..value
end

-- Dissect: Settlement Flag
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_flag, range, value, display)

  return offset + length, value
end

-- Settlement Flag Optional
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional = {}

-- Size: Settlement Flag Optional
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.size = 1

-- Display: Settlement Flag Optional
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.display = function(value)
  -- Check if field has value
  if value == 255 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_flag_optional, range, value, display)

  return offset + length, value
end

-- Settlement Period
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period = {}

-- Size: Settlement Period
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.size = 1

-- Display: Settlement Period
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.display = function(value)
  return "Settlement Period: "..value
end

-- Dissect: Settlement Period
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_period, range, value, display)

  return offset + length, value
end

-- Settlement Period Optional
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional = {}

-- Size: Settlement Period Optional
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.size = 1

-- Display: Settlement Period Optional
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.display = function(value)
  -- Check if field has value
  if value == 255 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.settlement_period_optional, range, value, display)
...
-- Time In Force
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force = {}

-- Size: Time In Force
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.size = 1

-- Display: Time In Force
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.display = function(value)
  if value == 0 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.time_in_force, range, value, display)

  return offset + length, value
end

-- Time In Force Optional
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional = {}

-- Size: Time In Force Optional
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.size = 1

-- Display: Time In Force Optional
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.display = function(value)
  if value == 0 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.time_in_force_optional, range, value, display)
...
-- Trading Capacity
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity = {}

-- Size: Trading Capacity
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.size = 1

-- Display: Trading Capacity
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trading_capacity, range, value, display)

  return offset + length, value
end

-- Trading Capacity Optional
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional = {}

-- Size: Trading Capacity Optional
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.size = 1

-- Display: Trading Capacity Optional
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.display = function(value)
  if value == 1 then
...
euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.dissect = function(buffer, offset, packet, parent)
  local length = euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trading_capacity_optional, range, value, display)
...
euronext_optiq_dropcopygateway_sbe_v5_36.group_size_encoding.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.group_size_encoding.fields = function(buffer, offset, packet, parent)
  ...
  index, block_length_short = euronext_optiq_dropcopygateway_sbe_v5_36.block_length_short.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_quote_request_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_quote_request_message.fields = function(buffer, offset, packet, parent)
  ...
  index, book_out_time = euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.dissect(buffer, index, packet, parent)

  -- Client Order Id: int64_t
  index, client_order_id = euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.dissect(buffer, index, packet, parent)
  ...
  index, oe_session_id = euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.dissect(buffer, index, packet, parent)

  -- Oegin From Member: uint64_t
  index, oegin_from_member = euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.dissect(buffer, index, packet, parent)

  -- Oegout Time To Me: uint64_t
  index, oegout_time_to_me = euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.dissect(buffer, index, packet, parent)
  ...
  index, order_side_optional = euronext_optiq_dropcopygateway_sbe_v5_36.order_side_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_declaration_fill_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.book_in.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me.size + 
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.price.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.quantity.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.side.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.size + 
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.trade_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.firm_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.size + 
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_account.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.account_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.free_text.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_declaration_fill_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Price: int64_t
  index, price = euronext_optiq_dropcopygateway_sbe_v5_36.price.dissect(buffer, index, packet, parent)

  -- Quantity: uint64_t
  index, quantity = euronext_optiq_dropcopygateway_sbe_v5_36.quantity.dissect(buffer, index, packet, parent)
  ...
  index, cross_order_indicator = euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.dissect(buffer, index, packet, parent)
  ...
  index, session_optional = euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.dissect(buffer, index, packet, parent)
  ...
  index, oe_partition_id = euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id.dissect(buffer, index, packet, parent)

  -- Logical Access Id: uint32_t
  index, logical_access_id = euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id.dissect(buffer, index, packet, parent)
  ...
  index, clearing_firm_id_optional = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.dissect(buffer, index, packet, parent)
  ...
  index, account_type = euronext_optiq_dropcopygateway_sbe_v5_36.account_type.dissect(buffer, index, packet, parent)
  ...
  index, settlement_period_optional = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.dissect(buffer, index, packet, parent)

  -- Settlement Flag Optional: unsigned_char
  index, settlement_flag_optional = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.dissect(buffer, index, packet, parent)

  -- Guarantee Flag Optional: GuaranteeFlag_enum
  index, guarantee_flag_optional = euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_trade_message_matched_declarations_group.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.operation_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.firm_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.free_text.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_account.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.principal_code.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.trader_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.investor_id.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_trade_message_matched_declarations_group.fields = function(buffer, offset, packet, parent, d_c_trade_message_matched_declarations_group_index)
  ...
  index, oe_partition_id_optional = euronext_optiq_dropcopygateway_sbe_v5_36.oe_partition_id_optional.dissect(buffer, index, packet, parent)

  -- Logical Access Id Optional: uint32_t
  index, logical_access_id_optional = euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.dissect(buffer, index, packet, parent)

  -- Book In Optional: uint64_t
  index, book_in_optional = euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.dissect(buffer, index, packet, parent)

  -- Account Type Optional: AccountType_enum
  index, account_type_optional = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_optional.dissect(buffer, index, packet, parent)
  ...
  index, cross_order_indicator_optional = euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional = {}

-- Size: Trade Qualifier Optional
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.size = 1

-- Display: Trade Qualifier Optional
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.bits = function(range, value, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_qualifier_optional, range, display)

  if show.structs then
    euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.bits(range, value, packet, element)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.open_close.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.open_close, range, display)
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_trade_message_matched_orders_group.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.order_side.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.order_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.size + 
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.logical_access_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_account.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.free_text.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.trader_id.size + 
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_trade_message_matched_orders_group.fields = function(buffer, offset, packet, parent, d_c_trade_message_matched_orders_group_index)
  ...
  index, order_side = euronext_optiq_dropcopygateway_sbe_v5_36.order_side.dissect(buffer, index, packet, parent)
  ...
  index, time_in_force = euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.dissect(buffer, index, packet, parent)
  ...
  index, trade_qualifier_optional = euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.dissect(buffer, index, packet, parent)

  -- Account Type Internal Optional: AccountTypeInternal_enum
  index, account_type_internal_optional = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal_optional.dissect(buffer, index, packet, parent)

  -- Lp Role Optional: LPRole_enum
  index, lp_role_optional = euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.dissect(buffer, index, packet, parent)
  ...
  index, clearing_instruction = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction.dissect(buffer, index, packet, parent)
...
-- Trade Qualifier
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier = {}

-- Size: Trade Qualifier
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.size = 1

-- Display: Trade Qualifier
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.bits = function(range, value, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_qualifier, range, display)

  if show.structs then
    euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.bits(range, value, packet, element)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_trade_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.quantity.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.session_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag_optional.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_trade_message.fields = function(buffer, offset, packet, parent)
  ...
  index, execution_id = euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.dissect(buffer, index, packet, parent)

  -- Quantity: uint64_t
  index, quantity = euronext_optiq_dropcopygateway_sbe_v5_36.quantity.dissect(buffer, index, packet, parent)

  -- Price Optional: int64_t
  index, price_optional = euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.dissect(buffer, index, packet, parent)
  ...
  index, trade_qualifier = euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_trade_bust_declaration_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.declaration_event_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.firm_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.account_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.emm.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.declaration_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.declaration_status.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.price_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.side.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.symbol_index.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.operation_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.entering_counterparty.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_trade_bust_declaration_message.fields = function(buffer, offset, packet, parent)
  ...
  index, quantity_optional = euronext_optiq_dropcopygateway_sbe_v5_36.quantity_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_trade_declaration_cancellation_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.event_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.emm.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.execution_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.symbol_index.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.price.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.quantity.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_trade_declaration_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.cross_order_indicator.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_declaration_reject_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.declaration_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.symbol_index.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.error_code.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_declaration_reject_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Error Code: uint16_t
  index, error_code = euronext_optiq_dropcopygateway_sbe_v5_36.error_code.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_declaration_new_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_account.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_declaration_new_message.fields = function(buffer, offset, packet, parent)
  ...
  index, settlement_period = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_period.dissect(buffer, index, packet, parent)

  -- Settlement Flag: unsigned_char
  index, settlement_flag = euronext_optiq_dropcopygateway_sbe_v5_36.settlement_flag.dissect(buffer, index, packet, parent)

  -- Guarantee Flag: GuaranteeFlag_enum
  index, guarantee_flag = euronext_optiq_dropcopygateway_sbe_v5_36.guarantee_flag.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_quote_message_clearing_dataset_group.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.technical_origin.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.open_close.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.free_text.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_quote_message_clearing_dataset_group.fields = function(buffer, offset, packet, parent, d_c_quote_message_clearing_dataset_group_index)
  ...
  index, clearing_instruction_optional = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_quote_message_offer_quoterep_group.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.d_c_quote_message_offer_quoterep_group.fields = function(buffer, offset, packet, parent, d_c_quote_message_offer_quoterep_group_index)
  ...
  index, rfe_answer_optional = euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional = {}

-- Size: Execution Instruction Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.size = 1

-- Display: Execution Instruction Optional
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.bits = function(range, value, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_instruction_optional, range, display)

  if show.structs then
    euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.bits(range, value, packet, element)
  end
...
-- Mi Fid Indicators
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators = {}

-- Size: Mi Fid Indicators
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.size = 1

-- Display: Mi Fid Indicators
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.bits = function(range, value, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.mi_fid_indicators, range, display)

  if show.structs then
    euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.bits(range, value, packet, element)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_quote_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.account_type.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.firm_id.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, trading_capacity = euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.dissect(buffer, index, packet, parent)

  -- Account Type: AccountType_enum
  index, account_type = euronext_optiq_dropcopygateway_sbe_v5_36.account_type.dissect(buffer, index, packet, parent)

  -- Lp Role: LPRole_enum
  index, lp_role = euronext_optiq_dropcopygateway_sbe_v5_36.lp_role.dissect(buffer, index, packet, parent)

  -- Mi Fid Indicators: Struct of 7 fields
  index, mi_fid_indicators = euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.dissect(buffer, index, packet, parent)

  -- Rfe Answer: unsigned_char
  index, rfe_answer = euronext_optiq_dropcopygateway_sbe_v5_36.rfe_answer.dissect(buffer, index, packet, parent)

  -- Firm Id: char8
  index, firm_id = euronext_optiq_dropcopygateway_sbe_v5_36.firm_id.dissect(buffer, index, packet, parent)

  -- Execution Instruction Optional: Struct of 8 fields
  index, execution_instruction_optional = euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group = {}

-- Size: Trade Bust Notification Short Codes Details Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.size =
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Bust Notification Short Codes Details Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.fields = function(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_modifiable_group_index)
  local index = offset
  ...
  if trade_bust_notification_short_codes_details_modifiable_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_modifiable_group_index, trade_bust_notification_short_codes_details_modifiable_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.dissect = function(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_modifiable_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_modifiable_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.fields(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_modifiable_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.fields(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_modifiable_group_index)
  end
end

-- Trade Bust Notification Short Codes Details Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups = {}

-- Calculate size of: Trade Bust Notification Short Codes Details Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Bust Notification Short Codes Details Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_bust_notification_short_codes_details_modifiable_group_index = 1, num_in_group do
    index, trade_bust_notification_short_codes_details_modifiable_group = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_group.dissect(buffer, index, packet, parent, trade_bust_notification_short_codes_details_modifiable_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_modifiable_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.fields(buffer, offset, packet, parent)
  end
end

-- Trade Bust Notification Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group = {}

-- Size: Trade Bust Notification Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.original_short_code_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.short_code_role.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.short_code_role_qualifier.size

-- Display: Trade Bust Notification Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Bust Notification Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.fields = function(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_non_modifiable_group_index)
  local index = offset
  ...
  if trade_bust_notification_short_codes_details_non_modifiable_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_non_modifiable_group_index, trade_bust_notification_short_codes_details_non_modifiable_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.dissect = function(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_non_modifiable_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_non_modifiable_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.fields(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_non_modifiable_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.fields(buffer, offset, packet, parent, trade_bust_notification_short_codes_details_non_modifiable_group_index)
  end
end

-- Trade Bust Notification Short Codes Details Non Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups = {}

-- Calculate size of: Trade Bust Notification Short Codes Details Non Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Bust Notification Short Codes Details Non Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_bust_notification_short_codes_details_non_modifiable_group_index = 1, num_in_group do
    index, trade_bust_notification_short_codes_details_non_modifiable_group = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_group.dissect(buffer, index, packet, parent, trade_bust_notification_short_codes_details_non_modifiable_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_short_codes_details_non_modifiable_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.fields(buffer, offset, packet, parent)
  end
end

-- Trade Bust Notification Message
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message = {}

-- Calculate size of: Trade Bust Notification Message
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.order_side.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.order_id.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.clearing_instruction_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.lp_role_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.size(buffer, offset + index)

  return index
end

-- Display: Trade Bust Notification Message
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Bust Notification Message
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, last_shares = euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.dissect(buffer, index, packet, parent)

  -- Last Traded Px: int64_t
  index, last_traded_px = euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.dissect(buffer, index, packet, parent)
  ...
  index, clearing_firm_id = euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id.dissect(buffer, index, packet, parent)
  ...
  index, execution_phase = euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase.dissect(buffer, index, packet, parent)
  ...
  index, time_in_force_optional = euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force_optional.dissect(buffer, index, packet, parent)
  ...
  index, trade_bust_notification_short_codes_details_non_modifiable_groups = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_non_modifiable_groups.dissect(buffer, index, packet, parent)

  -- Trade Bust Notification Short Codes Details Modifiable Groups: Struct of 2 fields
  index, trade_bust_notification_short_codes_details_modifiable_groups = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_short_codes_details_modifiable_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trade Bust Notification Message
euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.trade_bust_notification_message, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_trade_cancellation_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.symbol_index.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.book_in.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.last_shares.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional = {}

-- Size: Mi Fid Indicators Optional
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.size = 1

-- Display: Mi Fid Indicators Optional
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.bits = function(range, value, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.mi_fid_indicators_optional, range, display)

  if show.structs then
    euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.bits(range, value, packet, element)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_order_reject_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.error_code.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_short_order_reject_message.fields = function(buffer, offset, packet, parent)
  ...
  index, oegin_from_member_optional = euronext_optiq_dropcopygateway_sbe_v5_36.oegin_from_member_optional.dissect(buffer, index, packet, parent)
  ...
  index, mi_fid_indicators_optional = euronext_optiq_dropcopygateway_sbe_v5_36.mi_fid_indicators_optional.dissect(buffer, index, packet, parent)

  -- Oe Session Id Optional: uint64_t
  index, oe_session_id_optional = euronext_optiq_dropcopygateway_sbe_v5_36.oe_session_id_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group = {}

-- Size: Long Order Short Codes Details Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.event_short_code_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.short_code_role.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.short_code_role_qualifier.size

-- Display: Long Order Short Codes Details Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Short Codes Details Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.fields = function(buffer, offset, packet, parent, long_order_short_codes_details_modifiable_group_index)
  local index = offset
  ...
  if long_order_short_codes_details_modifiable_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_modifiable_group_index, long_order_short_codes_details_modifiable_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.dissect = function(buffer, offset, packet, parent, long_order_short_codes_details_modifiable_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_modifiable_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.fields(buffer, offset, packet, parent, long_order_short_codes_details_modifiable_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.fields(buffer, offset, packet, parent, long_order_short_codes_details_modifiable_group_index)
  end
end

-- Long Order Short Codes Details Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups = {}

-- Calculate size of: Long Order Short Codes Details Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Short Codes Details Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_short_codes_details_modifiable_group_index = 1, num_in_group do
    index, long_order_short_codes_details_modifiable_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_group.dissect(buffer, index, packet, parent, long_order_short_codes_details_modifiable_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_modifiable_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group = {}

-- Size: Long Order Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.original_short_code_type.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.short_code_role.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.short_code_role_qualifier.size

-- Display: Long Order Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Short Codes Details Non Modifiable Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.fields = function(buffer, offset, packet, parent, long_order_short_codes_details_non_modifiable_group_index)
  local index = offset
  ...
  if long_order_short_codes_details_non_modifiable_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_non_modifiable_group_index, long_order_short_codes_details_non_modifiable_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.dissect = function(buffer, offset, packet, parent, long_order_short_codes_details_non_modifiable_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_non_modifiable_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.fields(buffer, offset, packet, parent, long_order_short_codes_details_non_modifiable_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.fields(buffer, offset, packet, parent, long_order_short_codes_details_non_modifiable_group_index)
  end
end

-- Long Order Short Codes Details Non Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups = {}

-- Calculate size of: Long Order Short Codes Details Non Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Short Codes Details Non Modifiable Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_short_codes_details_non_modifiable_group_index = 1, num_in_group do
    index, long_order_short_codes_details_non_modifiable_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_group.dissect(buffer, index, packet, parent, long_order_short_codes_details_non_modifiable_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_short_codes_details_non_modifiable_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Additional Infos Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group = {}

-- Size: Long Order Additional Infos Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.long_client_id.size

-- Display: Long Order Additional Infos Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Additional Infos Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.fields = function(buffer, offset, packet, parent, long_order_additional_infos_group_index)
  local index = offset

  -- Implicit Long Order Additional Infos Group Index
  if long_order_additional_infos_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_additional_infos_group_index, long_order_additional_infos_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.dissect = function(buffer, offset, packet, parent, long_order_additional_infos_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_additional_infos_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.fields(buffer, offset, packet, parent, long_order_additional_infos_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.fields(buffer, offset, packet, parent, long_order_additional_infos_group_index)
  end
end

-- Long Order Additional Infos Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups = {}

-- Calculate size of: Long Order Additional Infos Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Additional Infos Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_additional_infos_group_index = 1, num_in_group do
    index, long_order_additional_infos_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_group.dissect(buffer, index, packet, parent, long_order_additional_infos_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_additional_infos_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Optional Fields Derivatives Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group = {}

-- Size: Long Order Optional Fields Derivatives Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.size =
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Optional Fields Derivatives Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.fields = function(buffer, offset, packet, parent, long_order_optional_fields_derivatives_group_index)
  local index = offset
  ...
  if long_order_optional_fields_derivatives_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_derivatives_group_index, long_order_optional_fields_derivatives_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.dissect = function(buffer, offset, packet, parent, long_order_optional_fields_derivatives_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_derivatives_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.fields(buffer, offset, packet, parent, long_order_optional_fields_derivatives_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.fields(buffer, offset, packet, parent, long_order_optional_fields_derivatives_group_index)
  end
end

-- Long Order Optional Fields Derivatives Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups = {}

-- Calculate size of: Long Order Optional Fields Derivatives Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Optional Fields Derivatives Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_optional_fields_derivatives_group_index = 1, num_in_group do
    index, long_order_optional_fields_derivatives_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_group.dissect(buffer, index, packet, parent, long_order_optional_fields_derivatives_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_derivatives_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Strategy Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group = {}

-- Size: Long Order Strategy Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.trade_unique_identifier.size

-- Display: Long Order Strategy Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Strategy Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.fields = function(buffer, offset, packet, parent, long_order_strategy_fields_group_index)
  local index = offset

  -- Implicit Long Order Strategy Fields Group Index
  if long_order_strategy_fields_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_strategy_fields_group_index, long_order_strategy_fields_group_index)
    iteration:set_generated()
  end
  ...
  index, execution_id_optional = euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.dissect = function(buffer, offset, packet, parent, long_order_strategy_fields_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_strategy_fields_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.fields(buffer, offset, packet, parent, long_order_strategy_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.fields(buffer, offset, packet, parent, long_order_strategy_fields_group_index)
  end
end

-- Long Order Strategy Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups = {}

-- Calculate size of: Long Order Strategy Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Strategy Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_strategy_fields_group_index = 1, num_in_group do
    index, long_order_strategy_fields_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_group.dissect(buffer, index, packet, parent, long_order_strategy_fields_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_strategy_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Extended Clearing Account Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group = {}

-- Size: Long Order Extended Clearing Account Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_account.size

-- Display: Long Order Extended Clearing Account Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Extended Clearing Account Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.fields = function(buffer, offset, packet, parent, long_order_extended_clearing_account_group_index)
  local index = offset
  ...
  if long_order_extended_clearing_account_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_extended_clearing_account_group_index, long_order_extended_clearing_account_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.dissect = function(buffer, offset, packet, parent, long_order_extended_clearing_account_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_extended_clearing_account_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.fields(buffer, offset, packet, parent, long_order_extended_clearing_account_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.fields(buffer, offset, packet, parent, long_order_extended_clearing_account_group_index)
  end
end

-- Long Order Extended Clearing Account Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups = {}

-- Calculate size of: Long Order Extended Clearing Account Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Extended Clearing Account Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_extended_clearing_account_group_index = 1, num_in_group do
    index, long_order_extended_clearing_account_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_group.dissect(buffer, index, packet, parent, long_order_extended_clearing_account_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_extended_clearing_account_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Non Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group = {}

-- Size: Long Order Non Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.original_investor_id.size

-- Display: Long Order Non Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Non Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.fields = function(buffer, offset, packet, parent, long_order_non_modifiable_commercial_investor_field_group_index)
  local index = offset
  ...
  if long_order_non_modifiable_commercial_investor_field_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_commercial_investor_field_group_index, long_order_non_modifiable_commercial_investor_field_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.dissect = function(buffer, offset, packet, parent, long_order_non_modifiable_commercial_investor_field_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_commercial_investor_field_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.fields(buffer, offset, packet, parent, long_order_non_modifiable_commercial_investor_field_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.fields(buffer, offset, packet, parent, long_order_non_modifiable_commercial_investor_field_group_index)
  end
end

-- Long Order Non Modifiable Commercial Investor Field Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups = {}

-- Calculate size of: Long Order Non Modifiable Commercial Investor Field Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Non Modifiable Commercial Investor Field Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_non_modifiable_commercial_investor_field_group_index = 1, num_in_group do
    index, long_order_non_modifiable_commercial_investor_field_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_group.dissect(buffer, index, packet, parent, long_order_non_modifiable_commercial_investor_field_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_commercial_investor_field_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group = {}

-- Size: Long Order Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.size =
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Modifiable Commercial Investor Field Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.fields = function(buffer, offset, packet, parent, long_order_modifiable_commercial_investor_field_group_index)
  local index = offset
  ...
  if long_order_modifiable_commercial_investor_field_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_commercial_investor_field_group_index, long_order_modifiable_commercial_investor_field_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.dissect = function(buffer, offset, packet, parent, long_order_modifiable_commercial_investor_field_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_commercial_investor_field_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.fields(buffer, offset, packet, parent, long_order_modifiable_commercial_investor_field_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.fields(buffer, offset, packet, parent, long_order_modifiable_commercial_investor_field_group_index)
  end
end

-- Long Order Modifiable Commercial Investor Field Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups = {}

-- Calculate size of: Long Order Modifiable Commercial Investor Field Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Modifiable Commercial Investor Field Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_modifiable_commercial_investor_field_group_index = 1, num_in_group do
    index, long_order_modifiable_commercial_investor_field_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_group.dissect(buffer, index, packet, parent, long_order_modifiable_commercial_investor_field_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_commercial_investor_field_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Commercial Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group = {}

-- Size: Long Order Commercial Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.size =
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Commercial Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.fields = function(buffer, offset, packet, parent, long_order_commercial_fields_group_index)
  local index = offset

  -- Implicit Long Order Commercial Fields Group Index
  if long_order_commercial_fields_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_commercial_fields_group_index, long_order_commercial_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.dissect = function(buffer, offset, packet, parent, long_order_commercial_fields_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_commercial_fields_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.fields(buffer, offset, packet, parent, long_order_commercial_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.fields(buffer, offset, packet, parent, long_order_commercial_fields_group_index)
  end
end

-- Long Order Commercial Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups = {}

-- Calculate size of: Long Order Commercial Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Commercial Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_commercial_fields_group_index = 1, num_in_group do
    index, long_order_commercial_fields_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_group.dissect(buffer, index, packet, parent, long_order_commercial_fields_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_commercial_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group = {}

-- Size: Long Order Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.event_client_id_short_code.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.event_exec_w_firm_short_code.size

-- Display: Long Order Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.fields = function(buffer, offset, packet, parent, long_order_modifiable_short_codes_group_index)
  local index = offset
  ...
  if long_order_modifiable_short_codes_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_short_codes_group_index, long_order_modifiable_short_codes_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.dissect = function(buffer, offset, packet, parent, long_order_modifiable_short_codes_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_short_codes_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.fields(buffer, offset, packet, parent, long_order_modifiable_short_codes_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.fields(buffer, offset, packet, parent, long_order_modifiable_short_codes_group_index)
  end
end

-- Long Order Modifiable Short Codes Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups = {}

-- Calculate size of: Long Order Modifiable Short Codes Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Modifiable Short Codes Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_modifiable_short_codes_group_index = 1, num_in_group do
    index, long_order_modifiable_short_codes_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_group.dissect(buffer, index, packet, parent, long_order_modifiable_short_codes_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_modifiable_short_codes_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Non Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group = {}

-- Size: Long Order Non Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.original_client_id_short_code.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.original_exec_w_firm_short_code.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.original_invest_decis_w_firm_short_code.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.original_non_exec_broker_short_code.size
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Non Modifiable Short Codes Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.fields = function(buffer, offset, packet, parent, long_order_non_modifiable_short_codes_group_index)
  local index = offset
  ...
  if long_order_non_modifiable_short_codes_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_short_codes_group_index, long_order_non_modifiable_short_codes_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.dissect = function(buffer, offset, packet, parent, long_order_non_modifiable_short_codes_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_short_codes_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.fields(buffer, offset, packet, parent, long_order_non_modifiable_short_codes_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.fields(buffer, offset, packet, parent, long_order_non_modifiable_short_codes_group_index)
  end
end

-- Long Order Non Modifiable Short Codes Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups = {}

-- Calculate size of: Long Order Non Modifiable Short Codes Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Non Modifiable Short Codes Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_non_modifiable_short_codes_group_index = 1, num_in_group do
    index, long_order_non_modifiable_short_codes_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_group.dissect(buffer, index, packet, parent, long_order_non_modifiable_short_codes_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_short_codes_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Non Modifiable Opt Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group = {}

-- Size: Long Order Non Modifiable Opt Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Non Modifiable Opt Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.fields = function(buffer, offset, packet, parent, long_order_non_modifiable_opt_fields_group_index)
  local index = offset
  ...
  if long_order_non_modifiable_opt_fields_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_opt_fields_group_index, long_order_non_modifiable_opt_fields_group_index)
    iteration:set_generated()
  end

  -- Trading Capacity Optional: TradingCapacity_enum
  index, trading_capacity_optional = euronext_optiq_dropcopygateway_sbe_v5_36.trading_capacity_optional.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.dissect = function(buffer, offset, packet, parent, long_order_non_modifiable_opt_fields_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_opt_fields_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.fields(buffer, offset, packet, parent, long_order_non_modifiable_opt_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.fields(buffer, offset, packet, parent, long_order_non_modifiable_opt_fields_group_index)
  end
end

-- Long Order Non Modifiable Opt Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups = {}

-- Calculate size of: Long Order Non Modifiable Opt Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Non Modifiable Opt Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_non_modifiable_opt_fields_group_index = 1, num_in_group do
    index, long_order_non_modifiable_opt_fields_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_group.dissect(buffer, index, packet, parent, long_order_non_modifiable_opt_fields_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_non_modifiable_opt_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Clearing Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group = {}

-- Size: Long Order Clearing Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.clearing_firm_id_optional.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.client_id.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.account_number.size + 
  euronext_optiq_dropcopygateway_sbe_v5_36.technical_origin.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Clearing Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.fields = function(buffer, offset, packet, parent, long_order_clearing_fields_group_index)
  local index = offset

  -- Implicit Long Order Clearing Fields Group Index
  if long_order_clearing_fields_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_clearing_fields_group_index, long_order_clearing_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.dissect = function(buffer, offset, packet, parent, long_order_clearing_fields_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_clearing_fields_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.fields(buffer, offset, packet, parent, long_order_clearing_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.fields(buffer, offset, packet, parent, long_order_clearing_fields_group_index)
  end
end

-- Long Order Clearing Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups = {}

-- Calculate size of: Long Order Clearing Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Clearing Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_clearing_fields_group_index = 1, num_in_group do
    index, long_order_clearing_fields_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_group.dissect(buffer, index, packet, parent, long_order_clearing_fields_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_clearing_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group = {}

-- Size: Long Order Optional Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.size =
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Optional Fields Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.fields = function(buffer, offset, packet, parent, long_order_optional_fields_group_index)
  local index = offset

  -- Implicit Long Order Optional Fields Group Index
  if long_order_optional_fields_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_group_index, long_order_optional_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.dissect = function(buffer, offset, packet, parent, long_order_optional_fields_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.fields(buffer, offset, packet, parent, long_order_optional_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.fields(buffer, offset, packet, parent, long_order_optional_fields_group_index)
  end
end

-- Long Order Optional Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups = {}

-- Calculate size of: Long Order Optional Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Optional Fields Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_optional_fields_group_index = 1, num_in_group do
    index, long_order_optional_fields_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_group.dissect(buffer, index, packet, parent, long_order_optional_fields_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_optional_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.fields(buffer, offset, packet, parent)
  end
end

-- Long Order Free Text Section Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group = {}

-- Size: Long Order Free Text Section Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.size =
  euronext_optiq_dropcopygateway_sbe_v5_36.free_text.size

-- Display: Long Order Free Text Section Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Free Text Section Group
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.fields = function(buffer, offset, packet, parent, long_order_free_text_section_group_index)
  local index = offset

  -- Implicit Long Order Free Text Section Group Index
  if long_order_free_text_section_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_free_text_section_group_index, long_order_free_text_section_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.dissect = function(buffer, offset, packet, parent, long_order_free_text_section_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_free_text_section_group, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.fields(buffer, offset, packet, parent, long_order_free_text_section_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.fields(buffer, offset, packet, parent, long_order_free_text_section_group_index)
  end
end

-- Long Order Free Text Section Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups = {}

-- Calculate size of: Long Order Free Text Section Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Free Text Section Groups
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for long_order_free_text_section_group_index = 1, num_in_group do
    index, long_order_free_text_section_group = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_group.dissect(buffer, index, packet, parent, long_order_free_text_section_group_index)
  end
...
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_free_text_section_groups, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.fields(buffer, offset, packet, parent)
  end
end

-- Execution Instruction
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction = {}

-- Size: Execution Instruction
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.size = 1

-- Display: Execution Instruction
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.bits = function(range, value, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.execution_instruction, range, display)

  if show.structs then
    euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.bits(range, value, packet, element)
  end
...
-- Long Order Message
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message = {}

-- Calculate size of: Long Order Message
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.book_in_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.time_in_force.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.execution_id_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.leaves_qty.size

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.trade_qualifier_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.size
  ...
  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.size(buffer, offset + index)

  index = index + euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.size(buffer, offset + index)

  return index
end

-- Display: Long Order Message
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Order Message
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, account_type_internal = euronext_optiq_dropcopygateway_sbe_v5_36.account_type_internal.dissect(buffer, index, packet, parent)
  ...
  index, book_out_time_optional = euronext_optiq_dropcopygateway_sbe_v5_36.book_out_time_optional.dissect(buffer, index, packet, parent)

  -- Client Order Id Optional: int64_t
  index, client_order_id_optional = euronext_optiq_dropcopygateway_sbe_v5_36.client_order_id_optional.dissect(buffer, index, packet, parent)
  ...
  index, execution_instruction = euronext_optiq_dropcopygateway_sbe_v5_36.execution_instruction.dissect(buffer, index, packet, parent)
  ...
  index, oegout_time_to_me_optional = euronext_optiq_dropcopygateway_sbe_v5_36.oegout_time_to_me_optional.dissect(buffer, index, packet, parent)
  ...
  index, execution_phase_optional = euronext_optiq_dropcopygateway_sbe_v5_36.execution_phase_optional.dissect(buffer, index, packet, parent)

  -- Last Shares Optional: uint64_t
  index, last_shares_optional = euronext_optiq_dropcopygateway_sbe_v5_36.last_shares_optional.dissect(buffer, index, packet, parent)

  -- Last Traded Px Optional: int64_t
  index, last_traded_px_optional = euronext_optiq_dropcopygateway_sbe_v5_36.last_traded_px_optional.dissect(buffer, index, packet, parent)
  ...
  index, error_code_optional = euronext_optiq_dropcopygateway_sbe_v5_36.error_code_optional.dissect(buffer, index, packet, parent)
  ...
  index, long_order_free_text_section_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_free_text_section_groups.dissect(buffer, index, packet, parent)

  -- Long Order Optional Fields Groups: Struct of 2 fields
  index, long_order_optional_fields_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_groups.dissect(buffer, index, packet, parent)

  -- Long Order Clearing Fields Groups: Struct of 2 fields
  index, long_order_clearing_fields_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_clearing_fields_groups.dissect(buffer, index, packet, parent)

  -- Long Order Non Modifiable Opt Fields Groups: Struct of 2 fields
  index, long_order_non_modifiable_opt_fields_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_opt_fields_groups.dissect(buffer, index, packet, parent)

  -- Long Order Non Modifiable Short Codes Groups: Struct of 2 fields
  index, long_order_non_modifiable_short_codes_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_short_codes_groups.dissect(buffer, index, packet, parent)

  -- Long Order Modifiable Short Codes Groups: Struct of 2 fields
  index, long_order_modifiable_short_codes_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_short_codes_groups.dissect(buffer, index, packet, parent)

  -- Long Order Commercial Fields Groups: Struct of 2 fields
  index, long_order_commercial_fields_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_commercial_fields_groups.dissect(buffer, index, packet, parent)

  -- Long Order Modifiable Commercial Investor Field Groups: Struct of 2 fields
  index, long_order_modifiable_commercial_investor_field_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_modifiable_commercial_investor_field_groups.dissect(buffer, index, packet, parent)

  -- Long Order Non Modifiable Commercial Investor Field Groups: Struct of 2 fields
  index, long_order_non_modifiable_commercial_investor_field_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_non_modifiable_commercial_investor_field_groups.dissect(buffer, index, packet, parent)

  -- Long Order Extended Clearing Account Groups: Struct of 2 fields
  index, long_order_extended_clearing_account_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_extended_clearing_account_groups.dissect(buffer, index, packet, parent)

  -- Long Order Strategy Fields Groups: Struct of 2 fields
  index, long_order_strategy_fields_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_strategy_fields_groups.dissect(buffer, index, packet, parent)

  -- Long Order Optional Fields Derivatives Groups: Struct of 2 fields
  index, long_order_optional_fields_derivatives_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_optional_fields_derivatives_groups.dissect(buffer, index, packet, parent)

  -- Long Order Additional Infos Groups: Struct of 2 fields
  index, long_order_additional_infos_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_additional_infos_groups.dissect(buffer, index, packet, parent)

  -- Long Order Short Codes Details Non Modifiable Groups: Struct of 2 fields
  index, long_order_short_codes_details_non_modifiable_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_non_modifiable_groups.dissect(buffer, index, packet, parent)

  -- Long Order Short Codes Details Modifiable Groups: Struct of 2 fields
  index, long_order_short_codes_details_modifiable_groups = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_short_codes_details_modifiable_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Long Order Message
euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.long_order_message, buffer(offset, 0))
    local index = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_dropcopygateway_sbe_v5_36.phase_qualifier.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_euronext_optiq_dropcopygateway_sbe_v5_36.fields.phase_qualifier, range, display)
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_market_status_change_message.size =
  ...
  euronext_optiq_dropcopygateway_sbe_v5_36.session.size + 
...
euronext_optiq_dropcopygateway_sbe_v5_36.dc_market_status_change_message.fields = function(buffer, offset, packet, parent)
  ...
  index, session = euronext_optiq_dropcopygateway_sbe_v5_36.session.dissect(buffer, index, packet, parent)
...
euronext_optiq_dropcopygateway_sbe_v5_36.payload.dissect = function(buffer, offset, packet, parent, template_id)
  ...
  if template_id == 16006 then
    return euronext_optiq_dropcopygateway_sbe_v5_36.long_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Dc Short Order Reject Message
  ...
  if template_id == 16021 then
    return euronext_optiq_dropcopygateway_sbe_v5_36.trade_bust_notification_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Dc Quote Message
...
-- Register Euronext Optiq DropCopyGateway Sbe 5.36 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_euronext_optiq_dropcopygateway_sbe_v5_36)
