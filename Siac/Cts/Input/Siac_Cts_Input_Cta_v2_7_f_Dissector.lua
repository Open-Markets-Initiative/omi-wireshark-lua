...
omi_siac_cts_input_cta_v2_7_f.fields.bid_index_value = ProtoField.new("Bid Index Value", "siac.cts.input.cta.v2.7.f.bidindexvalue", ftypes.INT64)
...
omi_siac_cts_input_cta_v2_7_f.fields.corrected_prior_day_trade_date_and_time = ProtoField.new("Corrected Prior Day Trade Date And Time", "siac.cts.input.cta.v2.7.f.correctedpriordaytradedateandtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_siac_cts_input_cta_v2_7_f.fields.corrected_prior_day_trade_date_and_time_utc = ProtoField.new("Corrected Prior Day Trade Date And Time", "siac.cts.input.cta.v2.7.f.correctedpriordaytradedateandtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
omi_siac_cts_input_cta_v2_7_f.fields.indices_message = ProtoField.new("Indices Message", "siac.cts.input.cta.v2.7.f.indicesmessage", ftypes.STRING)
omi_siac_cts_input_cta_v2_7_f.fields.indices_message_type = ProtoField.new("Indices Message Type", "siac.cts.input.cta.v2.7.f.indicesmessagetype", ftypes.STRING)
...
omi_siac_cts_input_cta_v2_7_f.fields.offer_index_value = ProtoField.new("Offer Index Value", "siac.cts.input.cta.v2.7.f.offerindexvalue", ftypes.INT64)
...
omi_siac_cts_input_cta_v2_7_f.fields.original_prior_day_trade_date_and_time = ProtoField.new("Original Prior Day Trade Date And Time", "siac.cts.input.cta.v2.7.f.originalpriordaytradedateandtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_siac_cts_input_cta_v2_7_f.fields.original_prior_day_trade_date_and_time_utc = ProtoField.new("Original Prior Day Trade Date And Time", "siac.cts.input.cta.v2.7.f.originalpriordaytradedateandtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
omi_siac_cts_input_cta_v2_7_f.fields.prior_day_trade_date_and_time = ProtoField.new("Prior Day Trade Date And Time", "siac.cts.input.cta.v2.7.f.priordaytradedateandtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_siac_cts_input_cta_v2_7_f.fields.prior_day_trade_date_and_time_utc = ProtoField.new("Prior Day Trade Date And Time", "siac.cts.input.cta.v2.7.f.priordaytradedateandtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
omi_siac_cts_input_cta_v2_7_f.fields.timestamp_2 = ProtoField.new("Timestamp 2", "siac.cts.input.cta.v2.7.f.timestamp2", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_siac_cts_input_cta_v2_7_f.fields.timestamp_2_utc = ProtoField.new("Timestamp 2", "siac.cts.input.cta.v2.7.f.timestamp2.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
omi_siac_cts_input_cta_v2_7_f.fields.timestamp_1 = ProtoField.new("Timestamp 1", "siac.cts.input.cta.v2.7.f.timestamp1", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_siac_cts_input_cta_v2_7_f.fields.timestamp_1_utc = ProtoField.new("Timestamp 1", "siac.cts.input.cta.v2.7.f.timestamp1.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-----------------------------------------------------------------------
-- Siac Cts Input Cta 2.7.f Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
siac_cts_input_cta_v2_7_f.absolute_time_base = 0
...
omi_siac_cts_input_cta_v2_7_f.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)
...
function omi_siac_cts_input_cta_v2_7_f.prefs_changed()
  ...
  if siac_cts_input_cta_v2_7_f.absolute_time_base ~= omi_siac_cts_input_cta_v2_7_f.prefs.absolute_time_base then
    siac_cts_input_cta_v2_7_f.absolute_time_base = omi_siac_cts_input_cta_v2_7_f.prefs.absolute_time_base
  end
end
...
-- Bid Index Value
siac_cts_input_cta_v2_7_f.bid_index_value = {}

-- Size: Bid Index Value
siac_cts_input_cta_v2_7_f.bid_index_value.size = 8

-- Display: Bid Index Value
siac_cts_input_cta_v2_7_f.bid_index_value.display = function(value)
  return "Bid Index Value: "..value
end

-- Dissect: Bid Index Value
siac_cts_input_cta_v2_7_f.bid_index_value.dissect = function(buffer, offset, packet, parent)
  local length = siac_cts_input_cta_v2_7_f.bid_index_value.size
  local range = buffer(offset, length)
  local value = range:int64()
  local display = siac_cts_input_cta_v2_7_f.bid_index_value.display(value, buffer, offset, packet, parent)

  parent:add(omi_siac_cts_input_cta_v2_7_f.fields.bid_index_value, range, value, display)
...
siac_cts_input_cta_v2_7_f.indices_message_type = {}

-- Size: Indices Message Type
siac_cts_input_cta_v2_7_f.indices_message_type.size = 1

-- Display: Indices Message Type
siac_cts_input_cta_v2_7_f.indices_message_type.display = function(value)
  return "Indices Message Type: "..value
end

-- Dissect: Indices Message Type
siac_cts_input_cta_v2_7_f.indices_message_type.dissect = function(buffer, offset, packet, parent)
  local length = siac_cts_input_cta_v2_7_f.indices_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_cts_input_cta_v2_7_f.indices_message_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_siac_cts_input_cta_v2_7_f.fields.indices_message_type, range, value, display)
...
-- Offer Index Value
siac_cts_input_cta_v2_7_f.offer_index_value = {}

-- Size: Offer Index Value
siac_cts_input_cta_v2_7_f.offer_index_value.size = 8

-- Display: Offer Index Value
siac_cts_input_cta_v2_7_f.offer_index_value.display = function(value)
  return "Offer Index Value: "..value
end

-- Dissect: Offer Index Value
siac_cts_input_cta_v2_7_f.offer_index_value.dissect = function(buffer, offset, packet, parent)
  local length = siac_cts_input_cta_v2_7_f.offer_index_value.size
  local range = buffer(offset, length)
  local value = range:int64()
  local display = siac_cts_input_cta_v2_7_f.offer_index_value.display(value, buffer, offset, packet, parent)

  parent:add(omi_siac_cts_input_cta_v2_7_f.fields.offer_index_value, range, value, display)
...
siac_cts_input_cta_v2_7_f.timestamp_2.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = siac_cts_input_cta_v2_7_f.timestamp_2.size
...
siac_cts_input_cta_v2_7_f.prior_day_trade_date_and_time.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
siac_cts_input_cta_v2_7_f.prior_day_trade_date_and_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local seconds = buffer(offset, 4):uint()
    local nanoseconds = buffer(offset + 4, 4):uint()
    local length = siac_cts_input_cta_v2_7_f.prior_day_trade_date_and_time.size
    -- A field's absolute time base is fixed when it is declared, so the
    -- protocol declares one per base and the preference picks between them
    local field = omi_siac_cts_input_cta_v2_7_f.fields.prior_day_trade_date_and_time
    if siac_cts_input_cta_v2_7_f.absolute_time_base == 1 then field = omi_siac_cts_input_cta_v2_7_f.fields.prior_day_trade_date_and_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
...
siac_cts_input_cta_v2_7_f.original_prior_day_trade_date_and_time.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
siac_cts_input_cta_v2_7_f.original_prior_day_trade_date_and_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local seconds = buffer(offset, 4):uint()
    local nanoseconds = buffer(offset + 4, 4):uint()
    local length = siac_cts_input_cta_v2_7_f.original_prior_day_trade_date_and_time.size
    -- A field's absolute time base is fixed when it is declared, so the
    -- protocol declares one per base and the preference picks between them
    local field = omi_siac_cts_input_cta_v2_7_f.fields.original_prior_day_trade_date_and_time
    if siac_cts_input_cta_v2_7_f.absolute_time_base == 1 then field = omi_siac_cts_input_cta_v2_7_f.fields.original_prior_day_trade_date_and_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
...
siac_cts_input_cta_v2_7_f.corrected_prior_day_trade_date_and_time.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
siac_cts_input_cta_v2_7_f.corrected_prior_day_trade_date_and_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local seconds = buffer(offset, 4):uint()
    local nanoseconds = buffer(offset + 4, 4):uint()
    local length = siac_cts_input_cta_v2_7_f.corrected_prior_day_trade_date_and_time.size
    -- A field's absolute time base is fixed when it is declared, so the
    -- protocol declares one per base and the preference picks between them
    local field = omi_siac_cts_input_cta_v2_7_f.fields.corrected_prior_day_trade_date_and_time
    if siac_cts_input_cta_v2_7_f.absolute_time_base == 1 then field = omi_siac_cts_input_cta_v2_7_f.fields.corrected_prior_day_trade_date_and_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
...
siac_cts_input_cta_v2_7_f.bid_and_offer_index_message = {}

-- Size: Bid And Offer Index Message
siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.size =
  siac_cts_input_cta_v2_7_f.index_symbol.size + 
  siac_cts_input_cta_v2_7_f.bid_index_value.size + 
  siac_cts_input_cta_v2_7_f.offer_index_value.size

-- Display: Bid And Offer Index Message
siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Bid And Offer Index Message
siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, bid_index_value = siac_cts_input_cta_v2_7_f.bid_index_value.dissect(buffer, index, packet, parent)

  -- Offer Index Value: Signed Long
  index, offer_index_value = siac_cts_input_cta_v2_7_f.offer_index_value.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Bid And Offer Index Message
siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_siac_cts_input_cta_v2_7_f.fields.bid_and_offer_index_message, buffer(offset, 0))
    local index = siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.fields(buffer, offset, packet, parent)
  end
end
...
siac_cts_input_cta_v2_7_f.indices_message_payload = {}

-- Dissect: Indices Message Payload
siac_cts_input_cta_v2_7_f.indices_message_payload.dissect = function(buffer, offset, packet, parent, indices_message_type)
  -- Dissect Index Message
  ...
  if indices_message_type == "Q" then
    return siac_cts_input_cta_v2_7_f.bid_and_offer_index_message.dissect(buffer, offset, packet, parent)
  end
...
-- Indices Message
siac_cts_input_cta_v2_7_f.indices_message = {}

-- Calculate size of: Indices Message
siac_cts_input_cta_v2_7_f.indices_message.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_input_cta_v2_7_f.indices_message_type.size
  ...
  index = index + siac_cts_input_cta_v2_7_f.indices_message_payload.size(buffer, indices_message_payload_offset, indices_message_payload_type)

  return index
end

-- Display: Indices Message
siac_cts_input_cta_v2_7_f.indices_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Indices Message
siac_cts_input_cta_v2_7_f.indices_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Indices Message Type: Char
  index, indices_message_type = siac_cts_input_cta_v2_7_f.indices_message_type.dissect(buffer, index, packet, parent)

  -- Indices Message Payload: Runtime Type with 2 branches
  index = siac_cts_input_cta_v2_7_f.indices_message_payload.dissect(buffer, index, packet, parent, indices_message_type)
...
siac_cts_input_cta_v2_7_f.indices_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = siac_cts_input_cta_v2_7_f.indices_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_cts_input_cta_v2_7_f.indices_message.fields(buffer, offset, packet, parent)
  end
end
...
siac_cts_input_cta_v2_7_f.category_payload.dissect = function(buffer, offset, packet, parent, message_category)
  ...
  if message_category == "I" then
    return siac_cts_input_cta_v2_7_f.indices_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Market Status Message
...
-- Display: Timestamp 1
siac_cts_input_cta_v2_7_f.timestamp_1.display = function(packet, parent, value)
  -- Check null value
  if value == nil then
    return "No Value"
...
siac_cts_input_cta_v2_7_f.timestamp_1.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    ...
    local seconds = buffer(offset, 4):uint()
    local nanoseconds = buffer(offset + 4, 4):uint()
    local length = siac_cts_input_cta_v2_7_f.timestamp_1.size
    -- A field's absolute time base is fixed when it is declared, so the
    -- protocol declares one per base and the preference picks between them
    local field = omi_siac_cts_input_cta_v2_7_f.fields.timestamp_1
    if siac_cts_input_cta_v2_7_f.absolute_time_base == 1 then field = omi_siac_cts_input_cta_v2_7_f.fields.timestamp_1_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
