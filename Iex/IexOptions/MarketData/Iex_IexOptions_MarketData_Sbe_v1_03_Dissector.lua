...
omi_iex_iexoptions_marketdata_sbe_v1_03.fields.message = ProtoField.new("Message", "iex.iexoptions.marketdata.sbe.v1.03.message", ftypes.STRING)
omi_iex_iexoptions_marketdata_sbe_v1_03.fields.message_data = ProtoField.new("Message Data", "iex.iexoptions.marketdata.sbe.v1.03.messagedata", ftypes.BYTES)
omi_iex_iexoptions_marketdata_sbe_v1_03.fields.message_length = ProtoField.new("Message Length", "iex.iexoptions.marketdata.sbe.v1.03.messagelength", ftypes.UINT16)
...
omi_iex_iexoptions_marketdata_sbe_v1_03.fields.sequenced_packet_message_messages_group = ProtoField.new("Sequenced Packet Message messages Group", "iex.iexoptions.marketdata.sbe.v1.03.sequencedpacketmessagemessagesgroup", ftypes.STRING)
...
omi_iex_iexoptions_marketdata_sbe_v1_03.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
...
function omi_iex_iexoptions_marketdata_sbe_v1_03.prefs_changed()
  ...
  if show.repeating_groups ~= omi_iex_iexoptions_marketdata_sbe_v1_03.prefs.show_repeating_groups then
    show.repeating_groups = omi_iex_iexoptions_marketdata_sbe_v1_03.prefs.show_repeating_groups
  end
...
-- Message Data
iex_iexoptions_marketdata_sbe_v1_03.message_data = {}

-- Display: Message Data
iex_iexoptions_marketdata_sbe_v1_03.message_data.display = function(value)
  return "Message Data: "..value
end

-- Dissect runtime sized field: Message Data
iex_iexoptions_marketdata_sbe_v1_03.message_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = iex_iexoptions_marketdata_sbe_v1_03.message_data.display(value, packet, parent, size)

  parent:add(omi_iex_iexoptions_marketdata_sbe_v1_03.fields.message_data, range, value, display)

  return offset + size, value
end

-- Message Length
iex_iexoptions_marketdata_sbe_v1_03.message_length = {}

-- Size: Message Length
iex_iexoptions_marketdata_sbe_v1_03.message_length.size = 2

-- Display: Message Length
iex_iexoptions_marketdata_sbe_v1_03.message_length.display = function(value)
  return "Message Length: "..value
end

-- Dissect: Message Length
iex_iexoptions_marketdata_sbe_v1_03.message_length.dissect = function(buffer, offset, packet, parent)
  local length = iex_iexoptions_marketdata_sbe_v1_03.message_length.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = iex_iexoptions_marketdata_sbe_v1_03.message_length.display(value, buffer, offset, packet, parent)

  parent:add(omi_iex_iexoptions_marketdata_sbe_v1_03.fields.message_length, range, value, display)
...
-- Message
iex_iexoptions_marketdata_sbe_v1_03.message = {}

-- Calculate size of: Message
iex_iexoptions_marketdata_sbe_v1_03.message.size = function(buffer, offset)
  local index = 0

  index = index + iex_iexoptions_marketdata_sbe_v1_03.message_length.size
...
-- Display: Message
iex_iexoptions_marketdata_sbe_v1_03.message.display = function(buffer, offset, value, packet, parent)
  return ""..value
end

-- Dissect Fields: Message
iex_iexoptions_marketdata_sbe_v1_03.message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Length: uint16
  index, message_length = iex_iexoptions_marketdata_sbe_v1_03.message_length.dissect(buffer, index, packet, parent)
  ...
  if message_data_exists then
    ...
    index, message_data = iex_iexoptions_marketdata_sbe_v1_03.message_data.dissect(buffer, index, packet, parent, message_length)
  end
...
-- Dissect: Message
iex_iexoptions_marketdata_sbe_v1_03.message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_iex_iexoptions_marketdata_sbe_v1_03.fields.message, buffer(offset, 0))
    local index = iex_iexoptions_marketdata_sbe_v1_03.message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = iex_iexoptions_marketdata_sbe_v1_03.message.display(packet, parent, length)
    parent:append_text(display)

    return index, value
  else
    -- Skip element, add fields directly
    return iex_iexoptions_marketdata_sbe_v1_03.message.fields(buffer, offset, packet, parent)
  end
end

-- Sequenced Packet Message messages Group
iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group = {}

-- Calculate size of: Sequenced Packet Message messages Group
iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.size = function(buffer, offset)
  local index = 0

  index = index + iex_iexoptions_marketdata_sbe_v1_03.message.size(buffer, offset + index)

  return index
end

-- Display: Sequenced Packet Message messages Group
iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Packet Message messages Group
iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.fields = function(buffer, offset, packet, parent, sequenced_packet_message_messages_group_index)
  local index = offset
  ...
  if sequenced_packet_message_messages_group_index ~= nil and show.indexes then
    local iteration = parent:add(omi_iex_iexoptions_marketdata_sbe_v1_03.fields.sequenced_packet_message_messages_group_index, sequenced_packet_message_messages_group_index)
    iteration:set_generated()
  end

  -- Message: Struct of 2 fields
  index, message = iex_iexoptions_marketdata_sbe_v1_03.message.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Sequenced Packet Message messages Group
iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.dissect = function(buffer, offset, packet, parent, sequenced_packet_message_messages_group_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_iex_iexoptions_marketdata_sbe_v1_03.fields.sequenced_packet_message_messages_group, buffer(offset, 0))
    local index = iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.fields(buffer, offset, packet, parent, sequenced_packet_message_messages_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.fields(buffer, offset, packet, parent, sequenced_packet_message_messages_group_index)
  end
end
...
iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_groups.size = function(buffer, offset)
  ...
  for i = 1, sequenced_packet_message_messages_group_count do
    index = index + iex_iexoptions_marketdata_sbe_v1_03.sequenced_packet_message_messages_group.size(buffer, offset + index)
  end
  return index
end
