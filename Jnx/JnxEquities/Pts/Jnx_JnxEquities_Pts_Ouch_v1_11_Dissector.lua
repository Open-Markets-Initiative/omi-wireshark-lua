...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.accepted_sequence_number = ProtoField.new("Accepted Sequence Number", "jnx.jnxequities.pts.ouch.v1.11.acceptedsequencenumber", ftypes.STRING)
omi_jnx_jnxequities_pts_ouch_v1_11.fields.accepted_session = ProtoField.new("Accepted Session", "jnx.jnxequities.pts.ouch.v1.11.acceptedsession", ftypes.STRING)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.debug_text = ProtoField.new("Debug Text", "jnx.jnxequities.pts.ouch.v1.11.debugtext", ftypes.STRING)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.client_heartbeat = ProtoField.new("Client Heartbeat", "jnx.jnxequities.pts.ouch.v1.11.clientheartbeat", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.end_of_session = ProtoField.new("End Of Session", "jnx.jnxequities.pts.ouch.v1.11.endofsession", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.logout_request = ProtoField.new("Logout Request", "jnx.jnxequities.pts.ouch.v1.11.logoutrequest", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.server_heartbeat = ProtoField.new("Server Heartbeat", "jnx.jnxequities.pts.ouch.v1.11.serverheartbeat", ftypes.BYTES)
...
jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number = {}

-- Size: Accepted Sequence Number
jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.size = 20

-- Display: Accepted Sequence Number
jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.display = function(value)
  return "Accepted Sequence Number: "..value
end

-- Dissect: Accepted Sequence Number
jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.size
  ...
  parent:add(omi_jnx_jnxequities_pts_ouch_v1_11.fields.accepted_sequence_number, range, value, display)

  return offset + length, value
end

-- Accepted Session
jnx_jnxequities_pts_ouch_v1_11.accepted_session = {}

-- Size: Accepted Session
jnx_jnxequities_pts_ouch_v1_11.accepted_session.size = 10

-- Display: Accepted Session
jnx_jnxequities_pts_ouch_v1_11.accepted_session.display = function(value)
  return "Accepted Session: "..value
end

-- Dissect: Accepted Session
jnx_jnxequities_pts_ouch_v1_11.accepted_session.dissect = function(buffer, offset, packet, parent)
  local length = jnx_jnxequities_pts_ouch_v1_11.accepted_session.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = jnx_jnxequities_pts_ouch_v1_11.accepted_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_jnx_jnxequities_pts_ouch_v1_11.fields.accepted_session, range, value, display)
...
-- Debug Text
jnx_jnxequities_pts_ouch_v1_11.debug_text = {}

-- Size: Debug Text
jnx_jnxequities_pts_ouch_v1_11.debug_text.size = 1

-- Display: Debug Text
jnx_jnxequities_pts_ouch_v1_11.debug_text.display = function(value)
  return "Debug Text: "..value
end

-- Dissect: Debug Text
jnx_jnxequities_pts_ouch_v1_11.debug_text.dissect = function(buffer, offset, packet, parent)
  local length = jnx_jnxequities_pts_ouch_v1_11.debug_text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_jnxequities_pts_ouch_v1_11.debug_text.display(value, buffer, offset, packet, parent)

  parent:add(omi_jnx_jnxequities_pts_ouch_v1_11.fields.debug_text, range, value, display)
  ...
  if flow ~= nil then
    ...
    if not packet.visited then
      if flow.sequence.next == nil then
        flow.sequence.next = tonumber(jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.current)
      end
...
jnx_jnxequities_pts_ouch_v1_11.login_accepted_packet.size =
  jnx_jnxequities_pts_ouch_v1_11.accepted_session.size + 
  jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.size
...
jnx_jnxequities_pts_ouch_v1_11.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, accepted_session = jnx_jnxequities_pts_ouch_v1_11.accepted_session.dissect(buffer, index, packet, parent)

  -- Accepted Sequence Number: 20 Byte Ascii String
  index, accepted_sequence_number = jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.dissect(buffer, index, packet, parent)

  -- Store Accepted Sequence Number Value
  jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.current = accepted_sequence_number

  if not packet.visited then
    jnx_jnxequities_pts_ouch_v1_11.conversation.current.accepted_sequence_number.last = accepted_sequence_number
  end
...
jnx_jnxequities_pts_ouch_v1_11.debug_packet.size =
  jnx_jnxequities_pts_ouch_v1_11.debug_text.size
...
jnx_jnxequities_pts_ouch_v1_11.debug_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, debug_text = jnx_jnxequities_pts_ouch_v1_11.debug_text.dissect(buffer, index, packet, parent)
...
jnx_jnxequities_pts_ouch_v1_11.server_packet.dissect = function(buffer, packet, parent)
  ...
  jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.current = data.accepted_sequence_number.frames[packet.number]
...
function omi_jnx_jnxequities_pts_ouch_v1_11.init()
  jnx_jnxequities_pts_ouch_v1_11.accepted_sequence_number.current = nil
  jnx_jnxequities_pts_ouch_v1_11.conversation.current = nil
  jnx_jnxequities_pts_ouch_v1_11.conversation.flows = {}
end
...
jnx_jnxequities_pts_ouch_v1_11.role = function(packet)
  ...
  local acceptor_port = omi_jnx_jnxequities_pts_ouch_v1_11.prefs.acceptor_port
...
local function omi_jnx_jnxequities_pts_ouch_v1_11_tcp_heuristic(buffer, packet, parent)
  local role = jnx_jnxequities_pts_ouch_v1_11.role(packet)
  local initiator = omi_jnx_jnxequities_pts_ouch_v1_11_tcp_initiator_heuristic
  local acceptor = omi_jnx_jnxequities_pts_ouch_v1_11_tcp_acceptor_heuristic
