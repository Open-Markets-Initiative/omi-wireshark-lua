...
-- Odx OdxEquities Pts Ouch 2.0 Framing
...
omi_odx_odxequities_pts_ouch_v2_0.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
omi_odx_odxequities_pts_ouch_v2_0.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 9, "Hours ahead of UTC (JST) for midnight calculation")
...
function omi_odx_odxequities_pts_ouch_v2_0.prefs_changed()
  ...
  if show.headers ~= omi_odx_odxequities_pts_ouch_v2_0.prefs.show_headers then
    show.headers = omi_odx_odxequities_pts_ouch_v2_0.prefs.show_headers
  end
...
local function omi_odx_odxequities_pts_ouch_v2_0_tcp_heuristic(buffer, packet, parent)
  local role = odx_odxequities_pts_ouch_v2_0.role(packet)
  local initiator = omi_odx_odxequities_pts_ouch_v2_0_tcp_initiator_heuristic
  local acceptor = omi_odx_odxequities_pts_ouch_v2_0_tcp_acceptor_heuristic
