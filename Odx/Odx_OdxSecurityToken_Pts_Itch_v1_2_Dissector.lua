...
-- Odx OdxSecurityToken Pts Itch 1.2 Framing
...
omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs_changed()
  ...
  if show.headers ~= omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_headers then
    show.headers = omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_headers
  end
