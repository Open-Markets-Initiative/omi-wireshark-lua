...
omi_cboe_c1options_flex_spin_v1_1_30.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "cboe.c1options.flex.spin.v1.1.30.secondreserved1", ftypes.BYTES)
...
-- Cboe C1Options Flex Spin 1.1.30 Framing
...
omi_cboe_c1options_flex_spin_v1_1_30.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_cboe_c1options_flex_spin_v1_1_30.prefs_changed()
  ...
  if show.headers ~= omi_cboe_c1options_flex_spin_v1_1_30.prefs.show_headers then
    show.headers = omi_cboe_c1options_flex_spin_v1_1_30.prefs.show_headers
  end
...
-- Second Reserved 1
cboe_c1options_flex_spin_v1_1_30.second_reserved_1 = {}

-- Size: Second Reserved 1
cboe_c1options_flex_spin_v1_1_30.second_reserved_1.size = 1

-- Display: Second Reserved 1
cboe_c1options_flex_spin_v1_1_30.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
cboe_c1options_flex_spin_v1_1_30.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = cboe_c1options_flex_spin_v1_1_30.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = cboe_c1options_flex_spin_v1_1_30.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_c1options_flex_spin_v1_1_30.fields.second_reserved_1, range, value, display)
...
cboe_c1options_flex_spin_v1_1_30.trading_status_message.size =
  ...
  cboe_c1options_flex_spin_v1_1_30.second_reserved_1.size
...
cboe_c1options_flex_spin_v1_1_30.trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_reserved_1 = cboe_c1options_flex_spin_v1_1_30.second_reserved_1.dissect(buffer, index, packet, parent)
...
cboe_c1options_flex_spin_v1_1_30.instrument_definition_finished_message = {}

-- Display: Instrument Definition Finished Message
cboe_c1options_flex_spin_v1_1_30.instrument_definition_finished_message.display = function(packet, parent, length)
  return "Instrument Definition Finished Message"
end


-- Dissect: Instrument Definition Finished Message
cboe_c1options_flex_spin_v1_1_30.instrument_definition_finished_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_c1options_flex_spin_v1_1_30.instrument_definition_finished_message.display(packet, parent, 0)
...
cboe_c1options_flex_spin_v1_1_30.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0x86 then
    return cboe_c1options_flex_spin_v1_1_30.instrument_definition_finished_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Time Message
