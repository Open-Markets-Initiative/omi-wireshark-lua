...
-- Cboe EdgxOptions BinaryOrderEntry Boe3 1.0.10 Framing
...
-- Cboe EdgxOptions BinaryOrderEntry 1.0.10 Application Messages
...
-----------------------------------------------------------------------
-- Cboe EdgxOptions BinaryOrderEntry Boe3 1.0.10 Formatting
-----------------------------------------------------------------------
...
omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_session_messages = Pref.bool("Show Session Messages", show.session_messages, "Parse and add Session Messages to protocol tree")
...
function omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs_changed()
  ...
  if show.application_messages ~= omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_application_messages then
    show.application_messages = omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_application_messages
  end
  if show.headers ~= omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_headers then
    show.headers = omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_headers
  end
  if show.session_messages ~= omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_session_messages then
    show.session_messages = omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.show_session_messages
  end
...
cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.role = function(packet)
  ...
  local acceptor_port = omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.prefs.acceptor_port
...
local function omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10_tcp_heuristic(buffer, packet, parent)
  local role = cboe_edgxoptions_binaryorderentry_boe3_v1_0_10.role(packet)
  local initiator = omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10_tcp_initiator_heuristic
  local acceptor = omi_cboe_edgxoptions_binaryorderentry_boe3_v1_0_10_tcp_acceptor_heuristic
