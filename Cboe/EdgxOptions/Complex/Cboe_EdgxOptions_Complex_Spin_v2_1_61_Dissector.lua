...
-- Cboe EdgxOptions Complex Spin 2.1.61 Framing
...
omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs_changed()
  ...
  if show.headers ~= omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_headers then
    show.headers = omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_headers
  end
  if show.repeating_groups ~= omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_repeating_groups then
    show.repeating_groups = omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_repeating_groups
  end
  if show.structs ~= omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_structs then
    show.structs = omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_indexes then
    show.indexes = omi_cboe_edgxoptions_complex_spin_v2_1_61.prefs.show_indexes
  end
end
...
-- Second Reserved 1
cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1 = {}

-- Size: Second Reserved 1
cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.size = 1

-- Display: Second Reserved 1
cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_edgxoptions_complex_spin_v2_1_61.fields.second_reserved_1, range, value, display)
...
cboe_edgxoptions_complex_spin_v2_1_61.trading_status_message.size =
  ...
  cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.size
...
cboe_edgxoptions_complex_spin_v2_1_61.trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_reserved_1 = cboe_edgxoptions_complex_spin_v2_1_61.second_reserved_1.dissect(buffer, index, packet, parent)
...
cboe_edgxoptions_complex_spin_v2_1_61.instrument_definition_finished_message = {}

-- Display: Instrument Definition Finished Message
cboe_edgxoptions_complex_spin_v2_1_61.instrument_definition_finished_message.display = function(packet, parent, length)
  return "Instrument Definition Finished Message"
end


-- Dissect: Instrument Definition Finished Message
cboe_edgxoptions_complex_spin_v2_1_61.instrument_definition_finished_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_edgxoptions_complex_spin_v2_1_61.instrument_definition_finished_message.display(packet, parent, 0)
...
cboe_edgxoptions_complex_spin_v2_1_61.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0x86 then
    return cboe_edgxoptions_complex_spin_v2_1_61.instrument_definition_finished_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Time Message
