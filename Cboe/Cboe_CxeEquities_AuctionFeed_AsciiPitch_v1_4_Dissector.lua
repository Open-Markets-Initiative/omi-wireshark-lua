...
-- Cboe CxeEquities AuctionFeed AsciiPitch 1.4 Framing
...
omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs_changed()
  ...
  if show.headers ~= omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.show_headers then
    show.headers = omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.show_headers
  end
