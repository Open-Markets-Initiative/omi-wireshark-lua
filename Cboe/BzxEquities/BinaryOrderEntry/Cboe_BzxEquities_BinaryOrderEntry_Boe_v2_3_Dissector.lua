...
omi_cboe_bzxequities_binaryorderentry_boe_v2_3.fields.no_unspecified_unit_replay = ProtoField.new("No Unspecified Unit Replay", "cboe.bzxequities.binaryorderentry.boe.v2.3.nounspecifiedunitreplay", ftypes.UINT8)
...
omi_cboe_bzxequities_binaryorderentry_boe_v2_3.fields.reserved_1 = ProtoField.new("Reserved 1", "cboe.bzxequities.binaryorderentry.boe.v2.3.reserved1", ftypes.BYTES)
...
-- Cboe BzxEquities BinaryOrderEntry Boe 2.3 Framing
...
function omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs_changed()
  ...
  if show.headers ~= omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_headers then
    show.headers = omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_headers
  end
...
cboe_bzxequities_binaryorderentry_boe_v2_3.replay_complete_message = {}

-- Display: Replay Complete Message
cboe_bzxequities_binaryorderentry_boe_v2_3.replay_complete_message.display = function(packet, parent, length)
  return "Replay Complete Message"
end


-- Dissect: Replay Complete Message
cboe_bzxequities_binaryorderentry_boe_v2_3.replay_complete_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_binaryorderentry_boe_v2_3.replay_complete_message.display(packet, parent, 0)
...
cboe_bzxequities_binaryorderentry_boe_v2_3.server_heartbeat_message = {}

-- Display: Server Heartbeat Message
cboe_bzxequities_binaryorderentry_boe_v2_3.server_heartbeat_message.display = function(packet, parent, length)
  return "Server Heartbeat Message"
end


-- Dissect: Server Heartbeat Message
cboe_bzxequities_binaryorderentry_boe_v2_3.server_heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_binaryorderentry_boe_v2_3.server_heartbeat_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_bzxequities_binaryorderentry_boe_v2_3.client_heartbeat_message = {}

-- Display: Client Heartbeat Message
cboe_bzxequities_binaryorderentry_boe_v2_3.client_heartbeat_message.display = function(packet, parent, length)
  return "Client Heartbeat Message"
end


-- Dissect: Client Heartbeat Message
cboe_bzxequities_binaryorderentry_boe_v2_3.client_heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_binaryorderentry_boe_v2_3.client_heartbeat_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_bzxequities_binaryorderentry_boe_v2_3.logout_request_message = {}

-- Display: Logout Request Message
cboe_bzxequities_binaryorderentry_boe_v2_3.logout_request_message.display = function(packet, parent, length)
  return "Logout Request Message"
end


-- Dissect: Logout Request Message
cboe_bzxequities_binaryorderentry_boe_v2_3.logout_request_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_binaryorderentry_boe_v2_3.logout_request_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_bzxequities_binaryorderentry_boe_v2_3.message.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0x02 then
    return cboe_bzxequities_binaryorderentry_boe_v2_3.logout_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat Message
  if message_type == 0x03 then
    return cboe_bzxequities_binaryorderentry_boe_v2_3.client_heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Response Message
  ...
  if message_type == 0x09 then
    return cboe_bzxequities_binaryorderentry_boe_v2_3.server_heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replay Complete Message
  if message_type == 0x13 then
    return cboe_bzxequities_binaryorderentry_boe_v2_3.replay_complete_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect New Order Message
