...
-- Cboe BzxEquities Top AsciiPitch 1.3.9 Protocol
local omi_cboe_bzxequities_top_asciipitch_v1_3_9 = Proto("Omi.Cboe.BzxEquities.Top.AsciiPitch.v1.3.9", "Cboe BzxEquities Top AsciiPitch 1.3.9")

-- Protocol table
local cboe_bzxequities_top_asciipitch_v1_3_9 = {}
...
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.milliseconds = ProtoField.new("Milliseconds", "cboe.bzxequities.top.asciipitch.v1.3.9.milliseconds", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.password = ProtoField.new("Password", "cboe.bzxequities.top.asciipitch.v1.3.9.password", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reg_sho_action = ProtoField.new("Reg SHO Action", "cboe.bzxequities.top.asciipitch.v1.3.9.regshoaction", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reject_reason = ProtoField.new("Reject Reason", "cboe.bzxequities.top.asciipitch.v1.3.9.rejectreason", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reserved_1 = ProtoField.new("Reserved 1", "cboe.bzxequities.top.asciipitch.v1.3.9.reserved1", ftypes.STRING)
...
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.client_heartbeat_message = ProtoField.new("Client Heartbeat Message", "cboe.bzxequities.top.asciipitch.v1.3.9.clientheartbeatmessage", ftypes.BYTES)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_ask_update_message = ProtoField.new("Expanded Ask Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.expandedaskupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_bid_update_message = ProtoField.new("Expanded Bid Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.expandedbidupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_spin_message = ProtoField.new("Expanded Spin Message", "cboe.bzxequities.top.asciipitch.v1.3.9.expandedspinmessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_trade_message = ProtoField.new("Expanded Trade Message", "cboe.bzxequities.top.asciipitch.v1.3.9.expandedtrademessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_two_sided_update_message = ProtoField.new("Expanded Two Sided Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.expandedtwosidedupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_ask_update_message = ProtoField.new("Extended Ask Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.extendedaskupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_bid_update_message = ProtoField.new("Extended Bid Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.extendedbidupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_spin_message = ProtoField.new("Extended Spin Message", "cboe.bzxequities.top.asciipitch.v1.3.9.extendedspinmessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_trade_message = ProtoField.new("Extended Trade Message", "cboe.bzxequities.top.asciipitch.v1.3.9.extendedtrademessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_two_sided_update_message = ProtoField.new("Extended Two Sided Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.extendedtwosidedupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.logon_accepted_message = ProtoField.new("Logon Accepted Message", "cboe.bzxequities.top.asciipitch.v1.3.9.logonacceptedmessage", ftypes.BYTES)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.logon_message = ProtoField.new("Logon Message", "cboe.bzxequities.top.asciipitch.v1.3.9.logonmessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.logon_rejected_message = ProtoField.new("Logon Rejected Message", "cboe.bzxequities.top.asciipitch.v1.3.9.logonrejectedmessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_ask_update_message = ProtoField.new("Long Ask Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.longaskupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_bid_update_message = ProtoField.new("Long Bid Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.longbidupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_trade_message = ProtoField.new("Long Trade Message", "cboe.bzxequities.top.asciipitch.v1.3.9.longtrademessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_two_sided_update_message = ProtoField.new("Long Two Sided Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.longtwosidedupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.milliseconds_message = ProtoField.new("Milliseconds Message", "cboe.bzxequities.top.asciipitch.v1.3.9.millisecondsmessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.seconds_message = ProtoField.new("Seconds Message", "cboe.bzxequities.top.asciipitch.v1.3.9.secondsmessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.server_heartbeat_message = ProtoField.new("Server Heartbeat Message", "cboe.bzxequities.top.asciipitch.v1.3.9.serverheartbeatmessage", ftypes.BYTES)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_ask_update_message = ProtoField.new("Short Ask Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.shortaskupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_bid_update_message = ProtoField.new("Short Bid Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.shortbidupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_trade_message = ProtoField.new("Short Trade Message", "cboe.bzxequities.top.asciipitch.v1.3.9.shorttrademessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_two_sided_update_message = ProtoField.new("Short Two Sided Update Message", "cboe.bzxequities.top.asciipitch.v1.3.9.shorttwosidedupdatemessage", ftypes.STRING)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.spin_done_message = ProtoField.new("Spin Done Message", "cboe.bzxequities.top.asciipitch.v1.3.9.spindonemessage", ftypes.BYTES)
omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.trading_status_message = ProtoField.new("Trading Status Message", "cboe.bzxequities.top.asciipitch.v1.3.9.tradingstatusmessage", ftypes.STRING)
...
-- Cboe BzxEquities Top AsciiPitch 1.3.9 Element Dissection Options
show.application_messages = true
show.structs = true

-- Register Cboe BzxEquities Top AsciiPitch 1.3.9 Show Options
omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")

-- Handle changed preferences
function omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs_changed()

  -- Check if preferences have changed
  if show.application_messages ~= omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs.show_application_messages then
    show.application_messages = omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs.show_application_messages
  end
  if show.structs ~= omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs.show_structs then
    show.structs = omi_cboe_bzxequities_top_asciipitch_v1_3_9.prefs.show_structs
  end
end
...
-- Halt Status
cboe_bzxequities_top_asciipitch_v1_3_9.halt_status = {}

-- Size: Halt Status
cboe_bzxequities_top_asciipitch_v1_3_9.halt_status.size = 1

-- Display: Halt Status
cboe_bzxequities_top_asciipitch_v1_3_9.halt_status.display = function(value)
  return "Halt Status: "..value
end

-- Dissect: Halt Status
cboe_bzxequities_top_asciipitch_v1_3_9.halt_status.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.halt_status.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.halt_status.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.halt_status, range, value, display)
...
-- Last Trade Size
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_size = {}

-- Size: Last Trade Size
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_size.size = 6

-- Display: Last Trade Size
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_size.display = function(value)
  return "Last Trade Size: "..value
end

-- Dissect: Last Trade Size
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_size.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_size.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_size.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.last_trade_size, range, value, display)

  return offset + length, value
end

-- Last Trade Time
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_time = {}

-- Size: Last Trade Time
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_time.size = 8

-- Display: Last Trade Time
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_time.display = function(value)
  return "Last Trade Time: "..value
end

-- Dissect: Last Trade Time
cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_time.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_time.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.last_trade_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.last_trade_time, range, value, display)

  return offset + length, value
end

-- Message Type
cboe_bzxequities_top_asciipitch_v1_3_9.message_type = {}

-- Size: Message Type
cboe_bzxequities_top_asciipitch_v1_3_9.message_type.size = 1

-- Display: Message Type
cboe_bzxequities_top_asciipitch_v1_3_9.message_type.display = function(value)
  if value == "L" then
...
cboe_bzxequities_top_asciipitch_v1_3_9.message_type.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.message_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.message_type, range, value, display)

  return offset + length, value
end

-- Milliseconds
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds = {}

-- Size: Milliseconds
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.size = 3

-- Display: Milliseconds
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.display = function(value)
  return "Milliseconds: "..value
end

-- Dissect: Milliseconds
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.milliseconds, range, value, display)

  return offset + length, value
end

-- Password
cboe_bzxequities_top_asciipitch_v1_3_9.password = {}

-- Size: Password
cboe_bzxequities_top_asciipitch_v1_3_9.password.size = 10

-- Display: Password
cboe_bzxequities_top_asciipitch_v1_3_9.password.display = function(value)
  return "Password: "..value
end

-- Dissect: Password
cboe_bzxequities_top_asciipitch_v1_3_9.password.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.password.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.password.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.password, range, value, display)

  return offset + length, value
end

-- Reg SHO Action
cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action = {}

-- Size: Reg SHO Action
cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action.size = 1

-- Display: Reg SHO Action
cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action.display = function(value)
  if value == "0" then
...
cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reg_sho_action, range, value, display)

  return offset + length, value
end

-- Reject Reason
cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason = {}

-- Size: Reject Reason
cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.size = 1

-- Display: Reject Reason
cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.display = function(value)
  return "Reject Reason: "..value
end

-- Dissect: Reject Reason
cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reject_reason, range, value, display)

  return offset + length, value
end

-- Reserved 1
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1 = {}

-- Size: Reserved 1
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1.size = 1

-- Display: Reserved 1
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reserved_1, range, value, display)

  return offset + length, value
end

-- Reserved 2
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2 = {}

-- Size: Reserved 2
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.size = 1

-- Display: Reserved 2
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.display = function(value)
  return "Reserved 2: "..value
end

-- Dissect: Reserved 2
cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.reserved_2, range, value, display)

  return offset + length, value
end

-- Seconds
cboe_bzxequities_top_asciipitch_v1_3_9.seconds = {}

-- Size: Seconds
cboe_bzxequities_top_asciipitch_v1_3_9.seconds.size = 5

-- Display: Seconds
cboe_bzxequities_top_asciipitch_v1_3_9.seconds.display = function(value)
  return "Seconds: "..value
end

-- Dissect: Seconds
cboe_bzxequities_top_asciipitch_v1_3_9.seconds.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.seconds.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.seconds, range, value, display)

  return offset + length, value
end

-- Spin Flag
cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag = {}

-- Size: Spin Flag
cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.size = 1

-- Display: Spin Flag
cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.display = function(value)
  return "Spin Flag: "..value
end

-- Dissect: Spin Flag
cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.spin_flag, range, value, display)
...
-- Timestamp
cboe_bzxequities_top_asciipitch_v1_3_9.timestamp = {}

-- Size: Timestamp
cboe_bzxequities_top_asciipitch_v1_3_9.timestamp.size = 8

-- Display: Timestamp
cboe_bzxequities_top_asciipitch_v1_3_9.timestamp.display = function(value)
  return "Timestamp: "..value
end

-- Dissect: Timestamp
cboe_bzxequities_top_asciipitch_v1_3_9.timestamp.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.timestamp.size
  local range = buffer(offset, length)
  local value = tonumber(range:string())
  ...
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.timestamp.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.timestamp, range, value, display)

  return offset + length, value
end

-- Top Lf
cboe_bzxequities_top_asciipitch_v1_3_9.top_lf = {}

-- Size: Top Lf
cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.size = 1

-- Display: Top Lf
cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.display = function(value)
  if value == 10 then
...
-- Dissect: Top Lf
cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.top_lf, range, value, display)

  return offset + length, value
end

-- Username
cboe_bzxequities_top_asciipitch_v1_3_9.username = {}

-- Size: Username
cboe_bzxequities_top_asciipitch_v1_3_9.username.size = 6

-- Display: Username
cboe_bzxequities_top_asciipitch_v1_3_9.username.display = function(value)
  return "Username: "..value
end

-- Dissect: Username
cboe_bzxequities_top_asciipitch_v1_3_9.username.dissect = function(buffer, offset, packet, parent)
  local length = cboe_bzxequities_top_asciipitch_v1_3_9.username.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.username.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.username, range, value, display)
...
-----------------------------------------------------------------------
-- Dissect Cboe BzxEquities Top AsciiPitch 1.3.9
-----------------------------------------------------------------------

-- Trading Status Message
cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.size =
  ...
  cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.size

-- Display: Trading Status Message
cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.display = function(packet, parent, length)
  return ""
end
...
cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, reg_sho_action = cboe_bzxequities_top_asciipitch_v1_3_9.reg_sho_action.dissect(buffer, index, packet, parent)

  -- Reserved 1: Alpha
  index, reserved_1 = cboe_bzxequities_top_asciipitch_v1_3_9.reserved_1.dissect(buffer, index, packet, parent)

  -- Reserved 2: Alpha
  index, reserved_2 = cboe_bzxequities_top_asciipitch_v1_3_9.reserved_2.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trading Status Message
cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.trading_status_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.fields(buffer, offset, packet, parent)
  end
end

-- Extended Trade Message
cboe_bzxequities_top_asciipitch_v1_3_9.extended_trade_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_trade_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.extended_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.extended_trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_trade_message.fields(buffer, offset, packet, parent)
  end
end

-- Short Trade Message
cboe_bzxequities_top_asciipitch_v1_3_9.short_trade_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.short_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_trade_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.short_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.short_trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_trade_message.fields(buffer, offset, packet, parent)
  end
end

-- Long Trade Message
cboe_bzxequities_top_asciipitch_v1_3_9.long_trade_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.long_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_trade_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.long_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.long_trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_trade_message.fields(buffer, offset, packet, parent)
  end
end

-- Expanded Trade Message
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_trade_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_trade_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_trade_message.fields(buffer, offset, packet, parent)
  end
end

-- Extended Two Sided Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.extended_two_sided_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_two_sided_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_two_sided_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.extended_two_sided_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.extended_two_sided_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_two_sided_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Short Two Sided Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.short_two_sided_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.short_two_sided_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_two_sided_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.short_two_sided_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.short_two_sided_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_two_sided_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Long Two Sided Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.long_two_sided_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.long_two_sided_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_two_sided_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.long_two_sided_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.long_two_sided_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_two_sided_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Expanded Two Sided Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_two_sided_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_two_sided_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_two_sided_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_two_sided_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_two_sided_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_two_sided_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Extended Ask Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.extended_ask_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_ask_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_ask_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.extended_ask_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.extended_ask_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_ask_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Short Ask Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.short_ask_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.short_ask_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_ask_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.short_ask_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.short_ask_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_ask_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Long Ask Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.long_ask_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.long_ask_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_ask_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.long_ask_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.long_ask_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_ask_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Expanded Ask Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_ask_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_ask_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_ask_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_ask_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_ask_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_ask_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Extended Bid Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.extended_bid_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_bid_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_bid_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.extended_bid_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.extended_bid_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_bid_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Short Bid Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.short_bid_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.short_bid_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.short_bid_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.short_bid_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.short_bid_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_bid_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Long Bid Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.long_bid_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.long_bid_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.long_bid_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.long_bid_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.long_bid_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_bid_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Expanded Bid Update Message
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_bid_update_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_bid_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_bid_update_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_bid_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_bid_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_bid_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Client Heartbeat Message
cboe_bzxequities_top_asciipitch_v1_3_9.client_heartbeat_message = {}

-- Display: Client Heartbeat Message
cboe_bzxequities_top_asciipitch_v1_3_9.client_heartbeat_message.display = function(packet, parent, length)
  return "Client Heartbeat Message"
end


-- Dissect: Client Heartbeat Message
cboe_bzxequities_top_asciipitch_v1_3_9.client_heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.client_heartbeat_message.display(packet, parent, 0)
...
cboe_bzxequities_top_asciipitch_v1_3_9.server_heartbeat_message = {}

-- Display: Server Heartbeat Message
cboe_bzxequities_top_asciipitch_v1_3_9.server_heartbeat_message.display = function(packet, parent, length)
  return "Server Heartbeat Message"
end


-- Dissect: Server Heartbeat Message
cboe_bzxequities_top_asciipitch_v1_3_9.server_heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.server_heartbeat_message.display(packet, parent, 0)
  packet.cols.info = display
...
-- Spin Done Message
cboe_bzxequities_top_asciipitch_v1_3_9.spin_done_message = {}

-- Display: Spin Done Message
cboe_bzxequities_top_asciipitch_v1_3_9.spin_done_message.display = function(packet, parent, length)
  return "Spin Done Message"
end


-- Dissect: Spin Done Message
cboe_bzxequities_top_asciipitch_v1_3_9.spin_done_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.spin_done_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Extended Spin Message
cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.extended_spin_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.fields(buffer, offset, packet, parent)
  end
end

-- Expanded Spin Message
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message = {}
...
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Expanded Spin Message
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.expanded_spin_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.fields(buffer, offset, packet, parent)
  end
end

-- Logon Accepted Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_accepted_message = {}

-- Display: Logon Accepted Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_accepted_message.display = function(packet, parent, length)
  return "Logon Accepted Message"
end


-- Dissect: Logon Accepted Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_accepted_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_bzxequities_top_asciipitch_v1_3_9.logon_accepted_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message = {}

-- Size: Milliseconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.size =
  cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.size

-- Display: Milliseconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Milliseconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Milliseconds: Numeric
  index, milliseconds = cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Milliseconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.milliseconds_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.fields(buffer, offset, packet, parent)
  end
end

-- Seconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message = {}

-- Size: Seconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.size =
  cboe_bzxequities_top_asciipitch_v1_3_9.seconds.size

-- Display: Seconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Seconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seconds: Numeric
  index, seconds = cboe_bzxequities_top_asciipitch_v1_3_9.seconds.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Seconds Message
cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.seconds_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.fields(buffer, offset, packet, parent)
  end
end

-- Logon Rejected Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message = {}

-- Size: Logon Rejected Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.size =
  cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.size

-- Display: Logon Rejected Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Logon Rejected Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Reject Reason: Alpha
  index, reject_reason = cboe_bzxequities_top_asciipitch_v1_3_9.reject_reason.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Logon Rejected Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.logon_rejected_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.fields(buffer, offset, packet, parent)
  end
end

-- Logon Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_message = {}

-- Size: Logon Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.size =
  cboe_bzxequities_top_asciipitch_v1_3_9.username.size + 
  cboe_bzxequities_top_asciipitch_v1_3_9.password.size + 
  cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.size

-- Display: Logon Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Logon Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Username: Alphanumeric
  index, username = cboe_bzxequities_top_asciipitch_v1_3_9.username.dissect(buffer, index, packet, parent)

  -- Password: Alphanumeric
  index, password = cboe_bzxequities_top_asciipitch_v1_3_9.password.dissect(buffer, index, packet, parent)

  -- Spin Flag: Boolean
  index, spin_flag = cboe_bzxequities_top_asciipitch_v1_3_9.spin_flag.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Logon Message
cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9.fields.logon_message, buffer(offset, 0))
    local index = cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.fields(buffer, offset, packet, parent)
  end
end

-- Payload
cboe_bzxequities_top_asciipitch_v1_3_9.payload = {}

-- Dissect: Payload
cboe_bzxequities_top_asciipitch_v1_3_9.payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect Logon Message
  if message_type == "L" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.logon_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logon Rejected Message
  if message_type == "J" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.logon_rejected_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Seconds Message
  if message_type == "T" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.seconds_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Milliseconds Message
  if message_type == "M" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.milliseconds_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logon Accepted Message
  if message_type == "C" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.logon_accepted_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Spin Message
  if message_type == "s" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_spin_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Extended Spin Message
  if message_type == "S" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_spin_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Spin Done Message
  if message_type == "D" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.spin_done_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat Message
  if message_type == "H" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.server_heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat Message
  if message_type == "R" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.client_heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Bid Update Message
  if message_type == "E" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_bid_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Long Bid Update Message
  if message_type == "B" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_bid_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Short Bid Update Message
  if message_type == "b" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_bid_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Extended Bid Update Message
  if message_type == "N" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_bid_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Ask Update Message
  if message_type == "e" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_ask_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Long Ask Update Message
  if message_type == "A" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_ask_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Short Ask Update Message
  if message_type == "a" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_ask_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Extended Ask Update Message
  if message_type == "n" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_ask_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Two Sided Update Message
  if message_type == "F" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_two_sided_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Long Two Sided Update Message
  if message_type == "U" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_two_sided_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Short Two Sided Update Message
  if message_type == "u" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_two_sided_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Extended Two Sided Update Message
  if message_type == "d" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_two_sided_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Trade Message
  if message_type == "f" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.expanded_trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Long Trade Message
  if message_type == "V" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.long_trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Short Trade Message
  if message_type == "v" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.short_trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Extended Trade Message
  if message_type == "r" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.extended_trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trading Status Message
  if message_type == "t" then
    return cboe_bzxequities_top_asciipitch_v1_3_9.trading_status_message.dissect(buffer, offset, packet, parent)
  end
...
-- Packet
cboe_bzxequities_top_asciipitch_v1_3_9.packet = {}

-- Verify required size of Tcp packet
cboe_bzxequities_top_asciipitch_v1_3_9.packet.requiredsize = function(buffer)
  return buffer:len() >= cboe_bzxequities_top_asciipitch_v1_3_9.message_type.size
end

-- Dissect Packet
cboe_bzxequities_top_asciipitch_v1_3_9.packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    index, message_type = cboe_bzxequities_top_asciipitch_v1_3_9.message_type.dissect(buffer, index, packet, parent)

    -- Payload: Runtime Type with 27 branches
    index = cboe_bzxequities_top_asciipitch_v1_3_9.payload.dissect(buffer, index, packet, parent, message_type)

    -- Top Lf: 1 Byte Fixed Width Integer Static
    index, top_lf = cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.dissect(buffer, index, packet, parent)
  end
...
function omi_cboe_bzxequities_top_asciipitch_v1_3_9.init()
end

-- Dissector for Cboe BzxEquities Top AsciiPitch 1.3.9
function omi_cboe_bzxequities_top_asciipitch_v1_3_9.dissector(buffer, packet, parent)
  -- Set protocol name
  packet.cols.protocol = omi_cboe_bzxequities_top_asciipitch_v1_3_9.name

  -- Dissect protocol
  local protocol = parent:add(omi_cboe_bzxequities_top_asciipitch_v1_3_9, buffer(), omi_cboe_bzxequities_top_asciipitch_v1_3_9.description, "("..buffer:len().." Bytes)")
  return cboe_bzxequities_top_asciipitch_v1_3_9.packet.dissect(buffer, packet, protocol)
end
...
-- Dissector Heuristic for Cboe BzxEquities Top AsciiPitch 1.3.9 (Tcp)
local function omi_cboe_bzxequities_top_asciipitch_v1_3_9_tcp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not cboe_bzxequities_top_asciipitch_v1_3_9.packet.requiredsize(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = omi_cboe_bzxequities_top_asciipitch_v1_3_9
  omi_cboe_bzxequities_top_asciipitch_v1_3_9.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Cboe BzxEquities Top AsciiPitch 1.3.9
omi_cboe_bzxequities_top_asciipitch_v1_3_9:register_heuristic("tcp", omi_cboe_bzxequities_top_asciipitch_v1_3_9_tcp_heuristic)

-- Register Cboe BzxEquities Top AsciiPitch 1.3.9 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_cboe_bzxequities_top_asciipitch_v1_3_9)
