...
cboe_byxequities_top_asciipitch_v1_3_2.client_heartbeat_message = {}

-- Display: Client Heartbeat Message
cboe_byxequities_top_asciipitch_v1_3_2.client_heartbeat_message.display = function(packet, parent, length)
  return "Client Heartbeat Message"
end


-- Dissect: Client Heartbeat Message
cboe_byxequities_top_asciipitch_v1_3_2.client_heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_byxequities_top_asciipitch_v1_3_2.client_heartbeat_message.display(packet, parent, 0)
...
cboe_byxequities_top_asciipitch_v1_3_2.server_heartbeat_message = {}

-- Display: Server Heartbeat Message
cboe_byxequities_top_asciipitch_v1_3_2.server_heartbeat_message.display = function(packet, parent, length)
  return "Server Heartbeat Message"
end


-- Dissect: Server Heartbeat Message
cboe_byxequities_top_asciipitch_v1_3_2.server_heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_byxequities_top_asciipitch_v1_3_2.server_heartbeat_message.display(packet, parent, 0)
  packet.cols.info = display
...
-- Spin Done Message
cboe_byxequities_top_asciipitch_v1_3_2.spin_done_message = {}

-- Display: Spin Done Message
cboe_byxequities_top_asciipitch_v1_3_2.spin_done_message.display = function(packet, parent, length)
  return "Spin Done Message"
end


-- Dissect: Spin Done Message
cboe_byxequities_top_asciipitch_v1_3_2.spin_done_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_byxequities_top_asciipitch_v1_3_2.spin_done_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_byxequities_top_asciipitch_v1_3_2.logon_accepted_message = {}

-- Display: Logon Accepted Message
cboe_byxequities_top_asciipitch_v1_3_2.logon_accepted_message.display = function(packet, parent, length)
  return "Logon Accepted Message"
end


-- Dissect: Logon Accepted Message
cboe_byxequities_top_asciipitch_v1_3_2.logon_accepted_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_byxequities_top_asciipitch_v1_3_2.logon_accepted_message.display(packet, parent, 0)
  packet.cols.info = display
...
cboe_byxequities_top_asciipitch_v1_3_2.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == "C" then
    return cboe_byxequities_top_asciipitch_v1_3_2.logon_accepted_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Spin Message
  ...
  if message_type == "D" then
    return cboe_byxequities_top_asciipitch_v1_3_2.spin_done_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat Message
  if message_type == "H" then
    return cboe_byxequities_top_asciipitch_v1_3_2.server_heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat Message
  if message_type == "R" then
    return cboe_byxequities_top_asciipitch_v1_3_2.client_heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Expanded Bid Update Message
