...
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.price_long = ProtoField.new("Price Long", "cboe.byxequities.summarydepth.pitch.v1.0.4.pricelong", ftypes.DOUBLE)
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.price_short = ProtoField.new("Price Short", "cboe.byxequities.summarydepth.pitch.v1.0.4.priceshort", ftypes.DOUBLE)
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.quantity_long = ProtoField.new("Quantity Long", "cboe.byxequities.summarydepth.pitch.v1.0.4.quantitylong", ftypes.UINT64)
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.quantity_short = ProtoField.new("Quantity Short", "cboe.byxequities.summarydepth.pitch.v1.0.4.quantityshort", ftypes.UINT32)
...
-- Price Long
cboe_byxequities_summarydepth_pitch_v1_0_4.price_long = {}

-- Size: Price Long
cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.size = 8

-- Display: Price Long
cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.display = function(value)
  return "Price Long: "..value
end

-- Translate: Price Long
cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.translate = function(raw)
  return raw:tonumber()/10000
end

-- Dissect: Price Long
cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.size
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.translate(raw)
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.price_long, range, value, display)

  return offset + length, value
end

-- Price Short
cboe_byxequities_summarydepth_pitch_v1_0_4.price_short = {}

-- Size: Price Short
cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.size = 4

-- Display: Price Short
cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.display = function(value)
  return "Price Short: "..value
end

-- Translate: Price Short
cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.translate = function(raw)
  return raw/10000
end

-- Dissect: Price Short
cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.size
  local range = buffer(offset, length)
  local raw = range:le_uint()
  local value = cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.translate(raw)
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.price_short, range, value, display)

  return offset + length, value
end

-- Quantity Long
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long = {}

-- Size: Quantity Long
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.size = 8

-- Display: Quantity Long
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.display = function(value)
  return "Quantity Long: "..value
end

-- Dissect: Quantity Long
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.quantity_long, range, value, display)

  return offset + length, value
end

-- Quantity Short
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short = {}

-- Size: Quantity Short
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.size = 4

-- Display: Quantity Short
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.display = function(value)
  return "Quantity Short: "..value
end

-- Dissect: Quantity Short
cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.quantity_short, range, value, display)
...
cboe_byxequities_summarydepth_pitch_v1_0_4.long_update_adap_block.size =
  ...
  cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.size + 
  cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.size
...
cboe_byxequities_summarydepth_pitch_v1_0_4.long_update_adap_block.fields = function(buffer, offset, packet, parent)
  ...
  index, price_long = cboe_byxequities_summarydepth_pitch_v1_0_4.price_long.dissect(buffer, index, packet, parent)

  -- Quantity Long: Binary
  index, quantity_long = cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_long.dissect(buffer, index, packet, parent)
...
cboe_byxequities_summarydepth_pitch_v1_0_4.short_update_adap_block.size =
  cboe_byxequities_summarydepth_pitch_v1_0_4.side.size + 
  cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.size + 
  cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.size
...
cboe_byxequities_summarydepth_pitch_v1_0_4.short_update_adap_block.fields = function(buffer, offset, packet, parent)
  ...
  index, price_short = cboe_byxequities_summarydepth_pitch_v1_0_4.price_short.dissect(buffer, index, packet, parent)

  -- Quantity Short: Binary
  index, quantity_short = cboe_byxequities_summarydepth_pitch_v1_0_4.quantity_short.dissect(buffer, index, packet, parent)
