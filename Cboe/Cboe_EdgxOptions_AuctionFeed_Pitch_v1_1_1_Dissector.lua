...
-- Cboe EdgxOptions AuctionFeed Pitch 1.1.1 Framing
...
omi_cboe_edgxoptions_auctionfeed_pitch_v1_1_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_cboe_edgxoptions_auctionfeed_pitch_v1_1_1.prefs_changed()
  ...
  if show.headers ~= omi_cboe_edgxoptions_auctionfeed_pitch_v1_1_1.prefs.show_headers then
    show.headers = omi_cboe_edgxoptions_auctionfeed_pitch_v1_1_1.prefs.show_headers
  end
