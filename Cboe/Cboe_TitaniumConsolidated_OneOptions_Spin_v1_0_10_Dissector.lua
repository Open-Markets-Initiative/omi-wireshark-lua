...
-- Cboe TitaniumConsolidated OneOptions Spin 1.0.10 Framing
...
omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs_changed()
  ...
  if show.headers ~= omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_headers then
    show.headers = omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_headers
  end
  if show.structs ~= omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_structs then
    show.structs = omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_indexes then
    show.indexes = omi_cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.prefs.show_indexes
  end
end
...
-- Heartbeat
cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.heartbeat = {}

-- Display: Heartbeat
cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = cboe_titaniumconsolidated_oneoptions_spin_v1_0_10.heartbeat.display(packet, parent, 0)
