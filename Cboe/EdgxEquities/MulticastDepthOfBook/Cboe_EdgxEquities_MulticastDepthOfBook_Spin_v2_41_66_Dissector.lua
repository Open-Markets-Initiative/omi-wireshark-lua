...
cboe_edgxequities_multicastdepthofbook_spin_v2_41_66.instrument_definition_finished_message = {}

-- Display: Instrument Definition Finished Message
cboe_edgxequities_multicastdepthofbook_spin_v2_41_66.instrument_definition_finished_message.display = function(packet, parent, length)
  return "Instrument Definition Finished Message"
end


-- Dissect: Instrument Definition Finished Message
cboe_edgxequities_multicastdepthofbook_spin_v2_41_66.instrument_definition_finished_message.dissect = function(buffer, offset, packet, parent)
  local display = cboe_edgxequities_multicastdepthofbook_spin_v2_41_66.instrument_definition_finished_message.display(packet, parent, 0)
...
cboe_edgxequities_multicastdepthofbook_spin_v2_41_66.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0x86 then
    return cboe_edgxequities_multicastdepthofbook_spin_v2_41_66.instrument_definition_finished_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Time Message
