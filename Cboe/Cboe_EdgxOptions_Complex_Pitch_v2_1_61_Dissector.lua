...
omi_cboe_edgxoptions_complex_pitch_v2_1_61.fields.signed_price_long = ProtoField.new("Signed Price Long", "cboe.edgxoptions.complex.pitch.v2.1.61.signedpricelong", ftypes.DOUBLE)
omi_cboe_edgxoptions_complex_pitch_v2_1_61.fields.signed_price_short = ProtoField.new("Signed Price Short", "cboe.edgxoptions.complex.pitch.v2.1.61.signedpriceshort", ftypes.DOUBLE)
...
-- Signed Price Long
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long = {}

-- Size: Signed Price Long
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.size = 8

-- Display: Signed Price Long
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.display = function(value)
  return "Signed Price Long: "..value
end

-- Translate: Signed Price Long
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.translate = function(raw)
  return raw:tonumber()/10000
end

-- Dissect: Signed Price Long
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.dissect = function(buffer, offset, packet, parent)
  local length = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.size
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.translate(raw)
  local display = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_edgxoptions_complex_pitch_v2_1_61.fields.signed_price_long, range, value, display)

  return offset + length, value
end

-- Signed Price Short
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short = {}

-- Size: Signed Price Short
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.size = 2

-- Display: Signed Price Short
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.display = function(value)
  return "Signed Price Short: "..value
end

-- Translate: Signed Price Short
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.translate = function(raw)
  return raw/100
end

-- Dissect: Signed Price Short
cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.dissect = function(buffer, offset, packet, parent)
  local length = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.size
  local range = buffer(offset, length)
  local raw = range:le_int()
  local value = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.translate(raw)
  local display = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_edgxoptions_complex_pitch_v2_1_61.fields.signed_price_short, range, value, display)
...
cboe_edgxoptions_complex_pitch_v2_1_61.auction_summary_message.size =
  ...
  cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.size + 
...
cboe_edgxoptions_complex_pitch_v2_1_61.auction_summary_message.fields = function(buffer, offset, packet, parent)
  ...
  index, signed_price_long = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_long.dissect(buffer, index, packet, parent)
...
cboe_edgxoptions_complex_pitch_v2_1_61.trade_short_message.size =
  ...
  cboe_edgxoptions_complex_pitch_v2_1_61.complex_instrument_id_short.size + 
  cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.size + 
  cboe_edgxoptions_complex_pitch_v2_1_61.execution_id.size + 
...
cboe_edgxoptions_complex_pitch_v2_1_61.trade_short_message.fields = function(buffer, offset, packet, parent)
  ...
  index, signed_price_short = cboe_edgxoptions_complex_pitch_v2_1_61.signed_price_short.dissect(buffer, index, packet, parent)
