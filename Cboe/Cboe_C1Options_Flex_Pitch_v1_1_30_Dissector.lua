...
-- Cboe C1Options Flex Pitch 1.1.30 Framing
...
omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_cboe_c1options_flex_pitch_v1_1_30.prefs_changed()
  ...
  if show.headers ~= omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_headers then
    show.headers = omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_headers
  end
