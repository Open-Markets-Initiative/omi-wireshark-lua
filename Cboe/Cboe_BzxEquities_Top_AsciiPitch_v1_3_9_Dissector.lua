...
-- Verify Top Lf Field
cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.verify = function(buffer)
...
local function omi_cboe_bzxequities_top_asciipitch_v1_3_9_tcp_heuristic(buffer, packet, parent)
  ...
  -- Verify Top Lf
  if not cboe_bzxequities_top_asciipitch_v1_3_9.top_lf.verify(buffer) then return false end
