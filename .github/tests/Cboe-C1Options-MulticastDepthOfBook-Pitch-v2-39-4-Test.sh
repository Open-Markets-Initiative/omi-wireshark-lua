...
grep "cboe.c1options.multicastdepthofbook.pitch.v2.39.4.timeoffset" Cboe.C1Options.MulticastDepthOfBook.Pitch.v2.39.4.AddOrderLongMessage.json
...
grep "cboe.c1options.multicastdepthofbook.pitch.v2.39.4.timeoffset" Cboe.C1Options.MulticastDepthOfBook.Pitch.v2.39.4.DeleteOrderMessage.json
...
grep "cboe.c1options.multicastdepthofbook.pitch.v2.39.4.timeoffset" Cboe.C1Options.MulticastDepthOfBook.Pitch.v2.39.4.ModifyOrderLongMessage.json
