...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/AddOrderMpidAttributionMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/NonCrossTradeMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/OrderCancelMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/OrderExecutedMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/OrderExecutedWithPriceMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/RegShoShortSalePriceTestRestrictedIndicatorMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/RetailInterestMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/StockTradingActionMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/NtxEquities.TotalView.Itch.v5.0/SystemEventMessage.pcap" \
  -X "lua_script:Nasdaq/NtxEquities/TotalView/Nasdaq_NtxEquities_TotalView_Itch_v5_0_Dissector.lua" \
  -T json \
