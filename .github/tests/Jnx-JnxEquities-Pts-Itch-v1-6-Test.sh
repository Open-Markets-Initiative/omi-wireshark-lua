...
grep "jnx.jnxequities.pts.itch.v1.6.nanoseconds" Jnx.JnxEquities.Pts.Itch.v1.6.OrderDeletedMessage.json
...
grep "jnx.jnxequities.pts.itch.v1.6.nanoseconds" Jnx.JnxEquities.Pts.Itch.v1.6.OrderExecutedMessage.json
...
grep "jnx.jnxequities.pts.itch.v1.6.nanoseconds" Jnx.JnxEquities.Pts.Itch.v1.6.OrderReplacedMessage.json
...
grep "jnx.jnxequities.pts.itch.v1.6.nanoseconds" Jnx.JnxEquities.Pts.Itch.v1.6.ShortSellingPriceRestrictionStateMessage.json
