...
runuser -u tester -- tshark \
  ...
  -X "lua_script:Siac/Opra/Output/Siac_Opra_Output_Obi_v6_2_Dissector.lua" \
  -T json \
...
grep "siac.opra.output.obi.v6.2.expirationmonth" Siac.Opra.Output.Obi.v6.2.LongEquityAndIndexQuoteMessage.json
grep "siac.opra.output.obi.v6.2.expirationday" Siac.Opra.Output.Obi.v6.2.LongEquityAndIndexQuoteMessage.json
grep "siac.opra.output.obi.v6.2.expirationyear" Siac.Opra.Output.Obi.v6.2.LongEquityAndIndexQuoteMessage.json
...
grep "siac.opra.output.obi.v6.2.expirationmonth" Siac.Opra.Output.Obi.v6.2.ShortEquityAndIndexQuoteMessage.json
grep "siac.opra.output.obi.v6.2.expirationday" Siac.Opra.Output.Obi.v6.2.ShortEquityAndIndexQuoteMessage.json
grep "siac.opra.output.obi.v6.2.expirationyear" Siac.Opra.Output.Obi.v6.2.ShortEquityAndIndexQuoteMessage.json
