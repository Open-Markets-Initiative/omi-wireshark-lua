...
runuser -u tester -- tshark \
  ...
  -X "lua_script:Cboe/C1Options/Complex/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
grep "cboe.c1options.complex.pitch.v2.1.18.complexinstrumenttype" Cboe.C1Options.Complex.Pitch.v2.1.18.ComplexInstrumentDefinitionExpandedMessage.json
