...
-- Miax MiaxOptions TopOfMarket Mach 2.5 Framing
...
-----------------------------------------------------------------------
-- Miax MiaxOptions TopOfMarket Mach 2.5 Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
miax_miaxoptions_topofmarket_mach_v2_5.format_timestamp = true
...
omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs_changed()
  ...
  if show.headers ~= omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs.show_headers then
    show.headers = omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs.show_headers
  end
  ...
  if miax_miaxoptions_topofmarket_mach_v2_5.format_timestamp ~= omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs.format_timestamp then
    miax_miaxoptions_topofmarket_mach_v2_5.format_timestamp = omi_miax_miaxoptions_topofmarket_mach_v2_5.prefs.format_timestamp
  end
end
...
miax_miaxoptions_topofmarket_mach_v2_5.timestamp.dissect = function(buffer, offset, packet, parent)
  if miax_miaxoptions_topofmarket_mach_v2_5.format_timestamp then
...
-- Client Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.client_heartbeat = {}

-- Display: Client Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.client_heartbeat.display = function(packet, parent, length)
  return "Client Heartbeat"
end


-- Dissect: Client Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.client_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_topofmarket_mach_v2_5.client_heartbeat.display(packet, parent, 0)
...
-- Server Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.server_heartbeat = {}

-- Display: Server Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.server_heartbeat.display = function(packet, parent, length)
  return "Server Heartbeat"
end


-- Dissect: Server Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.server_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_topofmarket_mach_v2_5.server_heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_topofmarket_mach_v2_5.trading_session_update = {}

-- Display: Trading Session Update
miax_miaxoptions_topofmarket_mach_v2_5.trading_session_update.display = function(packet, parent, length)
  return "Trading Session Update"
end


-- Dissect: Trading Session Update
miax_miaxoptions_topofmarket_mach_v2_5.trading_session_update.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_topofmarket_mach_v2_5.trading_session_update.display(packet, parent, 0)
  packet.cols.info = display
...
-- Unsequenced Message
miax_miaxoptions_topofmarket_mach_v2_5.unsequenced_message = {}

-- Dissect: Unsequenced Message
miax_miaxoptions_topofmarket_mach_v2_5.unsequenced_message.dissect = function(buffer, offset, packet, parent, unsequenced_message_type)
  -- Dissect Refresh Request Message
...
miax_miaxoptions_topofmarket_mach_v2_5.unsequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  ...
  index = miax_miaxoptions_topofmarket_mach_v2_5.unsequenced_message.dissect(buffer, index, packet, parent, unsequenced_message_type)
...
miax_miaxoptions_topofmarket_mach_v2_5.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  -- Sequenced Message
  index, sequenced_message = miax_miaxoptions_topofmarket_mach_v2_5.sequenced_message.dissect(buffer, index, packet, parent)
...
-- Sesm Payload
miax_miaxoptions_topofmarket_mach_v2_5.sesm_payload = {}

-- Dissect: Sesm Payload
miax_miaxoptions_topofmarket_mach_v2_5.sesm_payload.dissect = function(buffer, offset, packet, parent, sesm_packet_type)
  -- Dissect Sequenced Data Packet
  ...
  -- Dissect Trading Session Update
  if sesm_packet_type == "u" then
    return miax_miaxoptions_topofmarket_mach_v2_5.trading_session_update.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat
  if sesm_packet_type == "0" then
    return miax_miaxoptions_topofmarket_mach_v2_5.server_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat
  if sesm_packet_type == "1" then
    return miax_miaxoptions_topofmarket_mach_v2_5.client_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Packet
...
miax_miaxoptions_topofmarket_mach_v2_5.sesm_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_sesm_tcp_packet)
  ...
  index = miax_miaxoptions_topofmarket_mach_v2_5.sesm_payload.dissect(buffer, index, packet, parent, sesm_packet_type)
...
-- End Of Session
miax_miaxoptions_topofmarket_mach_v2_5.end_of_session = {}

-- Display: End Of Session
miax_miaxoptions_topofmarket_mach_v2_5.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
miax_miaxoptions_topofmarket_mach_v2_5.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_topofmarket_mach_v2_5.end_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Start Of Session
miax_miaxoptions_topofmarket_mach_v2_5.start_of_session = {}

-- Display: Start Of Session
miax_miaxoptions_topofmarket_mach_v2_5.start_of_session.display = function(packet, parent, length)
  return "Start Of Session"
end


-- Dissect: Start Of Session
miax_miaxoptions_topofmarket_mach_v2_5.start_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_topofmarket_mach_v2_5.start_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.heartbeat = {}

-- Display: Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
miax_miaxoptions_topofmarket_mach_v2_5.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_topofmarket_mach_v2_5.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_topofmarket_mach_v2_5.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  ...
  if packet_type == 0 then
    return miax_miaxoptions_topofmarket_mach_v2_5.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session
  if packet_type == 1 then
    return miax_miaxoptions_topofmarket_mach_v2_5.start_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if packet_type == 2 then
    return miax_miaxoptions_topofmarket_mach_v2_5.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Application Message
...
-- Register Miax MiaxOptions TopOfMarket Mach 2.5 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_miax_miaxoptions_topofmarket_mach_v2_5)

-- Register Miax MiaxOptions TopOfMarket Mach 2.5 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_miax_miaxoptions_topofmarket_mach_v2_5)
