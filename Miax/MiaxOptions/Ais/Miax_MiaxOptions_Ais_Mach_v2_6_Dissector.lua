...
omi_miax_miaxoptions_ais_mach_v2_6.fields.leg_definition_0 = ProtoField.new("Leg Definition 0", "miax.miaxoptions.ais.mach.v2.6.legdefinition0", ftypes.STRING)
...
-- Miax MiaxOptions Ais Mach 2.6 Framing
...
omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_miax_miaxoptions_ais_mach_v2_6.prefs_changed()
  ...
  if show.headers ~= omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_headers then
    show.headers = omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_headers
  end
...
-- Leg Definition 0
miax_miaxoptions_ais_mach_v2_6.leg_definition_0 = {}

-- Size: Leg Definition 0
miax_miaxoptions_ais_mach_v2_6.leg_definition_0.size = 0

-- Display: Leg Definition 0
miax_miaxoptions_ais_mach_v2_6.leg_definition_0.display = function(value)
  return "Leg Definition 0: "..value
end

-- Dissect: Leg Definition 0
miax_miaxoptions_ais_mach_v2_6.leg_definition_0.dissect = function(buffer, offset, packet, parent)
  local length = miax_miaxoptions_ais_mach_v2_6.leg_definition_0.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = miax_miaxoptions_ais_mach_v2_6.leg_definition_0.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_miaxoptions_ais_mach_v2_6.fields.leg_definition_0, range, value, display)
...
-- Client Heartbeat
miax_miaxoptions_ais_mach_v2_6.client_heartbeat = {}

-- Display: Client Heartbeat
miax_miaxoptions_ais_mach_v2_6.client_heartbeat.display = function(packet, parent, length)
  return "Client Heartbeat"
end


-- Dissect: Client Heartbeat
miax_miaxoptions_ais_mach_v2_6.client_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_ais_mach_v2_6.client_heartbeat.display(packet, parent, 0)
...
-- Server Heartbeat
miax_miaxoptions_ais_mach_v2_6.server_heartbeat = {}

-- Display: Server Heartbeat
miax_miaxoptions_ais_mach_v2_6.server_heartbeat.display = function(packet, parent, length)
  return "Server Heartbeat"
end


-- Dissect: Server Heartbeat
miax_miaxoptions_ais_mach_v2_6.server_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_ais_mach_v2_6.server_heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_ais_mach_v2_6.trading_session_update = {}

-- Display: Trading Session Update
miax_miaxoptions_ais_mach_v2_6.trading_session_update.display = function(packet, parent, length)
  return "Trading Session Update"
end


-- Dissect: Trading Session Update
miax_miaxoptions_ais_mach_v2_6.trading_session_update.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_ais_mach_v2_6.trading_session_update.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_ais_mach_v2_6.complex_strategy_definition_update_message.size =
  miax_miaxoptions_ais_mach_v2_6.nanoseconds.size + 
  miax_miaxoptions_ais_mach_v2_6.strategy_id.size + 
  miax_miaxoptions_ais_mach_v2_6.underlying_symbol.size + 
  miax_miaxoptions_ais_mach_v2_6.active_on_miax.size + 
  miax_miaxoptions_ais_mach_v2_6.reserved_1.size + 
  miax_miaxoptions_ais_mach_v2_6.update_reason.size + 
  miax_miaxoptions_ais_mach_v2_6.reserved_10.size + 
  miax_miaxoptions_ais_mach_v2_6.number_of_legs.size + 
  miax_miaxoptions_ais_mach_v2_6.leg_definition_0.size
...
miax_miaxoptions_ais_mach_v2_6.complex_strategy_definition_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, leg_definition_0 = miax_miaxoptions_ais_mach_v2_6.leg_definition_0.dissect(buffer, index, packet, parent)
...
miax_miaxoptions_ais_mach_v2_6.sesm_payload.dissect = function(buffer, offset, packet, parent, sesm_packet_type)
  ...
  -- Dissect Trading Session Update
  if sesm_packet_type == "u" then
    return miax_miaxoptions_ais_mach_v2_6.trading_session_update.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat
  if sesm_packet_type == "0" then
    return miax_miaxoptions_ais_mach_v2_6.server_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat
  if sesm_packet_type == "1" then
    return miax_miaxoptions_ais_mach_v2_6.client_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Packet
