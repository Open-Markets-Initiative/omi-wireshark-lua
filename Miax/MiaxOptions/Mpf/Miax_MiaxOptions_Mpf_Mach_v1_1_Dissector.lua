...
omi_miax_miaxoptions_mpf_mach_v1_1.fields.reserved_16 = ProtoField.new("Reserved 16", "miax.miaxoptions.mpf.mach.v1.1.reserved16", ftypes.BYTES)
omi_miax_miaxoptions_mpf_mach_v1_1.fields.reserved_8 = ProtoField.new("Reserved 8", "miax.miaxoptions.mpf.mach.v1.1.reserved8", ftypes.BYTES)
...
-- Miax MiaxOptions Mpf Mach 1.1 Framing
...
-----------------------------------------------------------------------
-- Miax MiaxOptions Mpf Mach 1.1 Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
miax_miaxoptions_mpf_mach_v1_1.format_timestamp = true
...
omi_miax_miaxoptions_mpf_mach_v1_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_miax_miaxoptions_mpf_mach_v1_1.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_miax_miaxoptions_mpf_mach_v1_1.prefs_changed()
  ...
  if show.headers ~= omi_miax_miaxoptions_mpf_mach_v1_1.prefs.show_headers then
    show.headers = omi_miax_miaxoptions_mpf_mach_v1_1.prefs.show_headers
  end
  if show.structs ~= omi_miax_miaxoptions_mpf_mach_v1_1.prefs.show_structs then
    show.structs = omi_miax_miaxoptions_mpf_mach_v1_1.prefs.show_structs
  end
  if miax_miaxoptions_mpf_mach_v1_1.format_timestamp ~= omi_miax_miaxoptions_mpf_mach_v1_1.prefs.format_timestamp then
    miax_miaxoptions_mpf_mach_v1_1.format_timestamp = omi_miax_miaxoptions_mpf_mach_v1_1.prefs.format_timestamp
  end
end
...
miax_miaxoptions_mpf_mach_v1_1.timestamp.dissect = function(buffer, offset, packet, parent)
  if miax_miaxoptions_mpf_mach_v1_1.format_timestamp then
...
-- Client Heartbeat
miax_miaxoptions_mpf_mach_v1_1.client_heartbeat = {}

-- Display: Client Heartbeat
miax_miaxoptions_mpf_mach_v1_1.client_heartbeat.display = function(packet, parent, length)
  return "Client Heartbeat"
end


-- Dissect: Client Heartbeat
miax_miaxoptions_mpf_mach_v1_1.client_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_mpf_mach_v1_1.client_heartbeat.display(packet, parent, 0)
...
-- Server Heartbeat
miax_miaxoptions_mpf_mach_v1_1.server_heartbeat = {}

-- Display: Server Heartbeat
miax_miaxoptions_mpf_mach_v1_1.server_heartbeat.display = function(packet, parent, length)
  return "Server Heartbeat"
end


-- Dissect: Server Heartbeat
miax_miaxoptions_mpf_mach_v1_1.server_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_mpf_mach_v1_1.server_heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_mpf_mach_v1_1.trading_session_update = {}

-- Display: Trading Session Update
miax_miaxoptions_mpf_mach_v1_1.trading_session_update.display = function(packet, parent, length)
  return "Trading Session Update"
end


-- Dissect: Trading Session Update
miax_miaxoptions_mpf_mach_v1_1.trading_session_update.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_mpf_mach_v1_1.trading_session_update.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_mpf_mach_v1_1.sesm_payload.dissect = function(buffer, offset, packet, parent, sesm_packet_type)
  ...
  -- Dissect Trading Session Update
  if sesm_packet_type == "u" then
    return miax_miaxoptions_mpf_mach_v1_1.trading_session_update.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat
  if sesm_packet_type == "0" then
    return miax_miaxoptions_mpf_mach_v1_1.server_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat
  if sesm_packet_type == "1" then
    return miax_miaxoptions_mpf_mach_v1_1.client_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Packet
