...
local omi_miax_miaxoptions_complextopofmarket_mach_v1_3 = Proto("Omi.Miax.MiaxOptions.ComplexTopOfMarket.Mach.v1.3", "Miax MiaxOptions ComplexTopOfMarket Mach 1.3")
...
omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.nanoseconds = ProtoField.new("Nanoseconds", "miax.miaxoptions.complextopofmarket.mach.v1.3.nanoseconds", ftypes.UINT32)
...
miax_miaxoptions_complextopofmarket_mach_v1_3.conversation = {}
miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.data = function(packet)
  local key = miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.key(packet)
  local data = miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.flows[key]
  if data == nil then
    data = { seconds = { last = nil, frames = {} } }
    miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.flows[key] = data
  end
  return data
end
...
miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.current = nil
...
-- Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds = {}

-- Size: Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.size = 4

-- Display: Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.display = function(value)
  return "Nanoseconds: "..value
end

-- Dissect: Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.dissect = function(buffer, offset, packet, parent)
  local length = miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.nanoseconds, range, value, display)
...
-- Seconds
miax_miaxoptions_complextopofmarket_mach_v1_3.seconds = {}

-- Size: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.size = 4

-- Store: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.current = nil

-- Generated: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.generated = function(value, range, packet, parent)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.display(value)
  local seconds = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.seconds, range, value, display)
...
-- Dissect: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.dissect = function(buffer, offset, packet, parent)
  local length = miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.seconds, range, value, display)
...
-- Translate: Timestamp
miax_miaxoptions_complextopofmarket_mach_v1_3.timestamp.translate = function(nanoseconds, stored_seconds)
  return UInt64.new(stored_seconds * 1000000000 + nanoseconds)
end

-- Display: Timestamp
miax_miaxoptions_complextopofmarket_mach_v1_3.timestamp.display = function(nanoseconds, stored_seconds)
  return "Timestamp: "..os.date("%Y-%m-%d %H:%M:%S.", stored_seconds)..string.format("%09d", nanoseconds)
end

-- Composite: Timestamp
miax_miaxoptions_complextopofmarket_mach_v1_3.timestamp.composite = function(buffer, offset, stored_seconds, packet, parent)
  local length = miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.size
  local range = buffer(offset, length)
  local nanoseconds = range:le_uint()
  local value = miax_miaxoptions_complextopofmarket_mach_v1_3.timestamp.translate(nanoseconds, stored_seconds)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.timestamp.display(nanoseconds, stored_seconds, packet)
  parent = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.timestamp, range, value, display)

  miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.generated(stored_seconds, range, packet, parent)

  display = miax_miaxoptions_complextopofmarket_mach_v1_3.nanoseconds.display(nanoseconds)
  parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.nanoseconds, range, nanoseconds, display)
...
miax_miaxoptions_complextopofmarket_mach_v1_3.underlying_trading_status_notification_message.fields = function(buffer, offset, packet, parent)
  ...
  index, nanoseconds = miax_miaxoptions_complextopofmarket_mach_v1_3.timestamp.dissect(buffer, index, packet, parent)
...
miax_miaxoptions_complextopofmarket_mach_v1_3.leg_definition.display = function(packet, parent, length)
  return ""
end
...
miax_miaxoptions_complextopofmarket_mach_v1_3.system_time_message.size =
  miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.size
...
miax_miaxoptions_complextopofmarket_mach_v1_3.system_time_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Seconds: SecTime
  index, seconds = miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.dissect(buffer, index, packet, parent)

  -- Store Seconds Value
  miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.current = seconds

  if not packet.visited then
    miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.current.seconds.last = seconds
  end
...
miax_miaxoptions_complextopofmarket_mach_v1_3.application_message.dissect = function(buffer, offset, packet, parent, size_of_application_message)
  ...
  if show.structs then
    parent = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.application_message, buffer(offset, 0))
    local current = miax_miaxoptions_complextopofmarket_mach_v1_3.application_message.fields(buffer, offset, packet, parent, size_of_application_message)
...
-- End Of Session
miax_miaxoptions_complextopofmarket_mach_v1_3.end_of_session = {}

-- Display: End Of Session
miax_miaxoptions_complextopofmarket_mach_v1_3.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
miax_miaxoptions_complextopofmarket_mach_v1_3.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.end_of_session.display(packet, parent, 0)
...
-- Start Of Session
miax_miaxoptions_complextopofmarket_mach_v1_3.start_of_session = {}

-- Display: Start Of Session
miax_miaxoptions_complextopofmarket_mach_v1_3.start_of_session.display = function(packet, parent, length)
  return "Start Of Session"
end


-- Dissect: Start Of Session
miax_miaxoptions_complextopofmarket_mach_v1_3.start_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.start_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Heartbeat
miax_miaxoptions_complextopofmarket_mach_v1_3.heartbeat = {}

-- Display: Heartbeat
miax_miaxoptions_complextopofmarket_mach_v1_3.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
miax_miaxoptions_complextopofmarket_mach_v1_3.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_3.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_miaxoptions_complextopofmarket_mach_v1_3.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  ...
  if packet_type == 0 then
    return miax_miaxoptions_complextopofmarket_mach_v1_3.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session
  if packet_type == 1 then
    return miax_miaxoptions_complextopofmarket_mach_v1_3.start_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if packet_type == 2 then
    return miax_miaxoptions_complextopofmarket_mach_v1_3.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Application Message
...
-- Mach Message
miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message = {}

-- Calculate size of: Mach Message
miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.size = function(buffer, offset)
  local index = 0
...
miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mach Message
miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_3.fields.mach_message, buffer(offset, 0))
    local index = miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.fields(buffer, offset, packet, parent)
  end
end
...
miax_miaxoptions_complextopofmarket_mach_v1_3.packet.requiredsize = function(buffer)
  return buffer:len() >= miax_miaxoptions_complextopofmarket_mach_v1_3.sequence_number.size + miax_miaxoptions_complextopofmarket_mach_v1_3.packet_length.size + miax_miaxoptions_complextopofmarket_mach_v1_3.packet_type.size + miax_miaxoptions_complextopofmarket_mach_v1_3.session_number.size
end

-- Dissect Packet
miax_miaxoptions_complextopofmarket_mach_v1_3.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.data(packet)
  if not packet.visited then
    data.seconds.frames[packet.number] = data.seconds.last
  end
  miax_miaxoptions_complextopofmarket_mach_v1_3.seconds.current = data.seconds.frames[packet.number]
  miax_miaxoptions_complextopofmarket_mach_v1_3.conversation.current = data
  ...
  while index < end_of_payload do
    ...
    index, mach_message = miax_miaxoptions_complextopofmarket_mach_v1_3.mach_message.dissect(buffer, index, packet, parent)
  end
...
-- Dissector Heuristic for Miax MiaxOptions ComplexTopOfMarket Mach 1.3 (Udp)
local function omi_miax_miaxoptions_complextopofmarket_mach_v1_3_udp_heuristic(buffer, packet, parent)
...
omi_miax_miaxoptions_complextopofmarket_mach_v1_3:register_heuristic("udp", omi_miax_miaxoptions_complextopofmarket_mach_v1_3_udp_heuristic)

-- Register Miax MiaxOptions ComplexTopOfMarket Mach 1.3 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_miax_miaxoptions_complextopofmarket_mach_v1_3)
