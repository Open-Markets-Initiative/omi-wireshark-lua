...
local omi_miax_pearlequities_depthofmarket_mach_v1_3_a = Proto("Omi.Miax.PearlEquities.DepthOfMarket.Mach.v1.3.a", "Miax PearlEquities DepthOfMarket Mach 1.3.a")
...
-----------------------------------------------------------------------
-- Miax PearlEquities DepthOfMarket Mach 1.3.a Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
miax_pearlequities_depthofmarket_mach_v1_3_a.format_timestamp = true
...
omi_miax_pearlequities_depthofmarket_mach_v1_3_a.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_miax_pearlequities_depthofmarket_mach_v1_3_a.prefs_changed()
  ...
  if show.structs ~= omi_miax_pearlequities_depthofmarket_mach_v1_3_a.prefs.show_structs then
    show.structs = omi_miax_pearlequities_depthofmarket_mach_v1_3_a.prefs.show_structs
  end
  if miax_pearlequities_depthofmarket_mach_v1_3_a.format_timestamp ~= omi_miax_pearlequities_depthofmarket_mach_v1_3_a.prefs.format_timestamp then
    miax_pearlequities_depthofmarket_mach_v1_3_a.format_timestamp = omi_miax_pearlequities_depthofmarket_mach_v1_3_a.prefs.format_timestamp
  end
end
...
miax_pearlequities_depthofmarket_mach_v1_3_a.timestamp.dissect = function(buffer, offset, packet, parent)
  if miax_pearlequities_depthofmarket_mach_v1_3_a.format_timestamp then
...
miax_pearlequities_depthofmarket_mach_v1_3_a.application_message.dissect = function(buffer, offset, packet, parent, size_of_application_message)
  ...
  if show.structs then
    parent = parent:add(omi_miax_pearlequities_depthofmarket_mach_v1_3_a.fields.application_message, buffer(offset, 0))
    local current = miax_pearlequities_depthofmarket_mach_v1_3_a.application_message.fields(buffer, offset, packet, parent, size_of_application_message)
...
-- End Of Session
miax_pearlequities_depthofmarket_mach_v1_3_a.end_of_session = {}

-- Display: End Of Session
miax_pearlequities_depthofmarket_mach_v1_3_a.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
miax_pearlequities_depthofmarket_mach_v1_3_a.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_depthofmarket_mach_v1_3_a.end_of_session.display(packet, parent, 0)
...
-- Start Of Session
miax_pearlequities_depthofmarket_mach_v1_3_a.start_of_session = {}

-- Display: Start Of Session
miax_pearlequities_depthofmarket_mach_v1_3_a.start_of_session.display = function(packet, parent, length)
  return "Start Of Session"
end


-- Dissect: Start Of Session
miax_pearlequities_depthofmarket_mach_v1_3_a.start_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_depthofmarket_mach_v1_3_a.start_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Heartbeat
miax_pearlequities_depthofmarket_mach_v1_3_a.heartbeat = {}

-- Display: Heartbeat
miax_pearlequities_depthofmarket_mach_v1_3_a.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
miax_pearlequities_depthofmarket_mach_v1_3_a.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_depthofmarket_mach_v1_3_a.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_pearlequities_depthofmarket_mach_v1_3_a.payload.dissect = function(buffer, offset, packet, parent, mach_packet_type)
  ...
  if mach_packet_type == 0 then
    return miax_pearlequities_depthofmarket_mach_v1_3_a.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session
  if mach_packet_type == 1 then
    return miax_pearlequities_depthofmarket_mach_v1_3_a.start_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if mach_packet_type == 2 then
    return miax_pearlequities_depthofmarket_mach_v1_3_a.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Application Message
