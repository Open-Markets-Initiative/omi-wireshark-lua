...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_10 = ProtoField.new("Reserved 10", "miax.pearlequities.expressorders.meo.v2.7.b.reserved10", ftypes.BYTES)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_11 = ProtoField.new("Reserved 11", "miax.pearlequities.expressorders.meo.v2.7.b.reserved11", ftypes.BYTES)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_12 = ProtoField.new("Reserved 12", "miax.pearlequities.expressorders.meo.v2.7.b.reserved12", ftypes.BYTES)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_17 = ProtoField.new("Reserved 17", "miax.pearlequities.expressorders.meo.v2.7.b.reserved17", ftypes.BYTES)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_19 = ProtoField.new("Reserved 19", "miax.pearlequities.expressorders.meo.v2.7.b.reserved19", ftypes.BYTES)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_8 = ProtoField.new("Reserved 8", "miax.pearlequities.expressorders.meo.v2.7.b.reserved8", ftypes.BYTES)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.reserved_9 = ProtoField.new("Reserved 9", "miax.pearlequities.expressorders.meo.v2.7.b.reserved9", ftypes.BYTES)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "miax.pearlequities.expressorders.meo.v2.7.b.secondreserved1", ftypes.BYTES)
...
-- Miax PearlEquities ExpressOrders Meo 2.7.b Framing
...
function omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs_changed()
  ...
  if show.headers ~= omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs.show_headers then
    show.headers = omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs.show_headers
  end
...
-- Client Heartbeat
miax_pearlequities_expressorders_meo_v2_7_b.client_heartbeat = {}

-- Display: Client Heartbeat
miax_pearlequities_expressorders_meo_v2_7_b.client_heartbeat.display = function(packet, parent, length)
  return "Client Heartbeat"
end


-- Dissect: Client Heartbeat
miax_pearlequities_expressorders_meo_v2_7_b.client_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_expressorders_meo_v2_7_b.client_heartbeat.display(packet, parent, 0)
...
-- Server Heartbeat
miax_pearlequities_expressorders_meo_v2_7_b.server_heartbeat = {}

-- Display: Server Heartbeat
miax_pearlequities_expressorders_meo_v2_7_b.server_heartbeat.display = function(packet, parent, length)
  return "Server Heartbeat"
end


-- Dissect: Server Heartbeat
miax_pearlequities_expressorders_meo_v2_7_b.server_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_expressorders_meo_v2_7_b.server_heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_pearlequities_expressorders_meo_v2_7_b.trading_session_update = {}

-- Display: Trading Session Update
miax_pearlequities_expressorders_meo_v2_7_b.trading_session_update.display = function(packet, parent, length)
  return "Trading Session Update"
end


-- Dissect: Trading Session Update
miax_pearlequities_expressorders_meo_v2_7_b.trading_session_update.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_expressorders_meo_v2_7_b.trading_session_update.display(packet, parent, 0)
  packet.cols.info = display
...
miax_pearlequities_expressorders_meo_v2_7_b.additional_liquidity_indicator.bits = function(range, value, packet, parent)
  ...
  -- Nbbo Setter Joiner: 3 Bit Unsigned Fixed Width Integer Enum with 7 values
...
miax_pearlequities_expressorders_meo_v2_7_b.execution_order_instructions.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.execution_order_instructions, range, display)
...
miax_pearlequities_expressorders_meo_v2_7_b.routing.bits = function(range, value, packet, parent)
  ...
  -- Routing Strategy: 5 Bit Unsigned Fixed Width Integer Enum with 3 values
...
miax_pearlequities_expressorders_meo_v2_7_b.new_order_instructions.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.new_order_instructions, range, display)
...
miax_pearlequities_expressorders_meo_v2_7_b.esesm_payload.dissect = function(buffer, offset, packet, parent, esesm_packet_type)
  ...
  -- Dissect Trading Session Update
  if esesm_packet_type == "u" then
    return miax_pearlequities_expressorders_meo_v2_7_b.trading_session_update.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat
  if esesm_packet_type == "0" then
    return miax_pearlequities_expressorders_meo_v2_7_b.server_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat
  if esesm_packet_type == "1" then
    return miax_pearlequities_expressorders_meo_v2_7_b.client_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Packet
