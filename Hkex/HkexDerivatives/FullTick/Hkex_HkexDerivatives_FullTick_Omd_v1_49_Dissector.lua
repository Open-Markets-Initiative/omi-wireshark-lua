...
hkex_hkexderivatives_fulltick_omd_v1_49.trade_condition.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_hkex_hkexderivatives_fulltick_omd_v1_49.fields.trade_condition, range, display)
...
hkex_hkexderivatives_fulltick_omd_v1_49.order_type.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_hkex_hkexderivatives_fulltick_omd_v1_49.fields.order_type, range, display)
