...
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.fourth_filler_1 = ProtoField.new("Fourth Filler 1", "hkex.hkexsecurities.premium.omd.v1.45.fourthfiller1", ftypes.STRING)
...
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.headline = ProtoField.new("Headline", "hkex.hkexsecurities.premium.omd.v1.45.headline", ftypes.BYTES)
...
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.news_line = ProtoField.new("News Line", "hkex.hkexsecurities.premium.omd.v1.45.newsline", ftypes.BYTES)
...
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.second_filler_1 = ProtoField.new("Second Filler 1", "hkex.hkexsecurities.premium.omd.v1.45.secondfiller1", ftypes.STRING)
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.second_filler_2 = ProtoField.new("Second Filler 2", "hkex.hkexsecurities.premium.omd.v1.45.secondfiller2", ftypes.STRING)
...
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.security_name_gb = ProtoField.new("Security Name Gb", "hkex.hkexsecurities.premium.omd.v1.45.securitynamegb", ftypes.BYTES)
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.security_name_gccs = ProtoField.new("Security Name Gccs", "hkex.hkexsecurities.premium.omd.v1.45.securitynamegccs", ftypes.BYTES)
...
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.third_filler_1 = ProtoField.new("Third Filler 1", "hkex.hkexsecurities.premium.omd.v1.45.thirdfiller1", ftypes.STRING)
omi_hkex_hkexsecurities_premium_omd_v1_45.fields.third_filler_2 = ProtoField.new("Third Filler 2", "hkex.hkexsecurities.premium.omd.v1.45.thirdfiller2", ftypes.STRING)
...
-- Hkex HkexSecurities Premium Omd 1.45 Framing
...
-- Hkex HkexSecurities Premium 1.45 Application Messages
...
-- Fourth Filler 1
hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1 = {}

-- Size: Fourth Filler 1
hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.size = 1

-- Display: Fourth Filler 1
hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.display = function(value)
  return "Fourth Filler 1: "..value
end

-- Dissect: Fourth Filler 1
hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.dissect = function(buffer, offset, packet, parent)
  local length = hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_hkexsecurities_premium_omd_v1_45.fields.fourth_filler_1, range, value, display)
...
-- Second Filler 1
hkex_hkexsecurities_premium_omd_v1_45.second_filler_1 = {}

-- Size: Second Filler 1
hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.size = 1

-- Display: Second Filler 1
hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.display = function(value)
  return "Second Filler 1: "..value
end

-- Dissect: Second Filler 1
hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.dissect = function(buffer, offset, packet, parent)
  local length = hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_hkexsecurities_premium_omd_v1_45.fields.second_filler_1, range, value, display)

  return offset + length, value
end

-- Second Filler 2
hkex_hkexsecurities_premium_omd_v1_45.second_filler_2 = {}

-- Size: Second Filler 2
hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.size = 2

-- Display: Second Filler 2
hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.display = function(value)
  return "Second Filler 2: "..value
end

-- Dissect: Second Filler 2
hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.dissect = function(buffer, offset, packet, parent)
  local length = hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_hkexsecurities_premium_omd_v1_45.fields.second_filler_2, range, value, display)
...
-- Third Filler 1
hkex_hkexsecurities_premium_omd_v1_45.third_filler_1 = {}

-- Size: Third Filler 1
hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.size = 1

-- Display: Third Filler 1
hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.display = function(value)
  return "Third Filler 1: "..value
end

-- Dissect: Third Filler 1
hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.dissect = function(buffer, offset, packet, parent)
  local length = hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_hkexsecurities_premium_omd_v1_45.fields.third_filler_1, range, value, display)

  return offset + length, value
end

-- Third Filler 2
hkex_hkexsecurities_premium_omd_v1_45.third_filler_2 = {}

-- Size: Third Filler 2
hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.size = 2

-- Display: Third Filler 2
hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.display = function(value)
  return "Third Filler 2: "..value
end

-- Dissect: Third Filler 2
hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.dissect = function(buffer, offset, packet, parent)
  local length = hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_hkexsecurities_premium_omd_v1_45.fields.third_filler_2, range, value, display)
...
hkex_hkexsecurities_premium_omd_v1_45.security_definition_message.size = function(buffer, offset)
  ...
  index = index + hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.size

  index = index + hkex_hkexsecurities_premium_omd_v1_45.stamp_duty_flag.size

  index = index + hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.size
  ...
  index = index + hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.size
...
hkex_hkexsecurities_premium_omd_v1_45.security_definition_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_filler_1 = hkex_hkexsecurities_premium_omd_v1_45.second_filler_1.dissect(buffer, index, packet, parent)
  ...
  index, third_filler_1 = hkex_hkexsecurities_premium_omd_v1_45.third_filler_1.dissect(buffer, index, packet, parent)
  ...
  index, fourth_filler_1 = hkex_hkexsecurities_premium_omd_v1_45.fourth_filler_1.dissect(buffer, index, packet, parent)
...
hkex_hkexsecurities_premium_omd_v1_45.news_message.size = function(buffer, offset)
  ...
  index = index + hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.size
  ...
  index = index + hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.size
...
hkex_hkexsecurities_premium_omd_v1_45.news_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_filler_2 = hkex_hkexsecurities_premium_omd_v1_45.second_filler_2.dissect(buffer, index, packet, parent)
  ...
  index, third_filler_2 = hkex_hkexsecurities_premium_omd_v1_45.third_filler_2.dissect(buffer, index, packet, parent)
