...
local omi_tmx_quantumfeed_alphalevel2_xmt_v2_1 = Proto("Omi.Tmx.QuantumFeed.AlphaLevel2.Xmt.v2.1", "Tmx QuantumFeed AlphaLevel2 Xmt 2.1")
...
-- Tmx QuantumFeed AlphaLevel2 Xmt 2.1 Framing
...
-- Tmx QuantumFeed AlphaLevel2 2.1 Application Messages
...
omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

-- Handle changed preferences
function omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs_changed()

  -- Check if preferences have changed
  if show.application_messages ~= omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_application_messages then
    show.application_messages = omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_application_messages
  end
  if show.headers ~= omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_headers then
    show.headers = omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_headers
  end
  if show.structs ~= omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_structs then
    show.structs = omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_structs
  end
  if show.indexes ~= omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_indexes then
    show.indexes = omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_indexes
  end
end
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.packet.requiredsize = function(buffer)
  return buffer:len() >= tmx_quantumfeed_alphalevel2_xmt_v2_1.frame_header.size
end
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    for body_index = 1, num_body do
      ...
      index, body = tmx_quantumfeed_alphalevel2_xmt_v2_1.body.dissect(buffer, index, packet, parent, msg_length, body_index)
    end
  end
...
-- Dissector Heuristic for Tmx QuantumFeed AlphaLevel2 Xmt 2.1 (Udp)
local function omi_tmx_quantumfeed_alphalevel2_xmt_v2_1_udp_heuristic(buffer, packet, parent)
...
omi_tmx_quantumfeed_alphalevel2_xmt_v2_1:register_heuristic("udp", omi_tmx_quantumfeed_alphalevel2_xmt_v2_1_udp_heuristic)

-- Register Tmx QuantumFeed AlphaLevel2 Xmt 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_tmx_quantumfeed_alphalevel2_xmt_v2_1)
