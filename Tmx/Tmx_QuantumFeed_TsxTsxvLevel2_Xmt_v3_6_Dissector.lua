...
local omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6 = Proto("Omi.Tmx.QuantumFeed.TsxTsxvLevel2.Xmt.v3.6", "Tmx QuantumFeed TsxTsxvLevel2 Xmt 3.6")
...
-- Tmx QuantumFeed TsxTsxvLevel2 Xmt 3.6 Framing
...
omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs_changed()
  ...
  if show.headers ~= omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs.show_headers then
    show.headers = omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs.show_headers
  end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.packet.requiredsize = function(buffer)
  return buffer:len() >= tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.frame_header.size
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    for body_index = 1, num_body do
      ...
      index, body = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.body.dissect(buffer, index, packet, parent, msg_length, body_index)
    end
  end
...
-- Dissector Heuristic for Tmx QuantumFeed TsxTsxvLevel2 Xmt 3.6 (Udp)
local function omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_udp_heuristic(buffer, packet, parent)
...
-- Register Tmx QuantumFeed TsxTsxvLevel2 Xmt 3.6 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6)
