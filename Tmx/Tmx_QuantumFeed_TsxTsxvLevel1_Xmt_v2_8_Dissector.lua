...
-- Tmx QuantumFeed TsxTsxvLevel1 Xmt 2.8 Framing
...
omi_tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.prefs_changed()
  ...
  if show.headers ~= omi_tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.prefs.show_headers then
    show.headers = omi_tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.prefs.show_headers
  end
