...
omi_smallx_orderbookfeed_sbe_v2_2.fields.auction = ProtoField.new("Auction", "smallx.orderbookfeed.sbe.v2.2.auction", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.book_begin = ProtoField.new("Book Begin", "smallx.orderbookfeed.sbe.v2.2.bookbegin", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
omi_smallx_orderbookfeed_sbe_v2_2.fields.book_end = ProtoField.new("Book End", "smallx.orderbookfeed.sbe.v2.2.bookend", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0020)
omi_smallx_orderbookfeed_sbe_v2_2.fields.book_reset = ProtoField.new("Book Reset", "smallx.orderbookfeed.sbe.v2.2.bookreset", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0040)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.incarnation_end = ProtoField.new("Incarnation End", "smallx.orderbookfeed.sbe.v2.2.incarnationend", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.instrument_begin = ProtoField.new("Instrument Begin", "smallx.orderbookfeed.sbe.v2.2.instrumentbegin", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_smallx_orderbookfeed_sbe_v2_2.fields.instrument_end = ProtoField.new("Instrument End", "smallx.orderbookfeed.sbe.v2.2.instrumentend", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.snapshot_begin = ProtoField.new("Snapshot Begin", "smallx.orderbookfeed.sbe.v2.2.snapshotbegin", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0080)
omi_smallx_orderbookfeed_sbe_v2_2.fields.snapshot_end = ProtoField.new("Snapshot End", "smallx.orderbookfeed.sbe.v2.2.snapshotend", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0100)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.synthetic = ProtoField.new("Synthetic", "smallx.orderbookfeed.sbe.v2.2.synthetic", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.transaction_begin = ProtoField.new("Transaction Begin", "smallx.orderbookfeed.sbe.v2.2.transactionbegin", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
omi_smallx_orderbookfeed_sbe_v2_2.fields.transaction_end = ProtoField.new("Transaction End", "smallx.orderbookfeed.sbe.v2.2.transactionend", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_smallx_orderbookfeed_sbe_v2_2.fields.unused_snapshot_message_instructions_0 = ProtoField.new("Unused Snapshot Message Instructions 0", "smallx.orderbookfeed.sbe.v2.2.unusedsnapshotmessageinstructions0", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
omi_smallx_orderbookfeed_sbe_v2_2.fields.unused_snapshot_message_instructions_1 = ProtoField.new("Unused Snapshot Message Instructions 1", "smallx.orderbookfeed.sbe.v2.2.unusedsnapshotmessageinstructions1", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
omi_smallx_orderbookfeed_sbe_v2_2.fields.unused_snapshot_message_instructions_6 = ProtoField.new("Unused Snapshot Message Instructions 6", "smallx.orderbookfeed.sbe.v2.2.unusedsnapshotmessageinstructions6", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0040)
...
-- SmallX OrderBookFeed 2.2 Application Messages
...
function omi_smallx_orderbookfeed_sbe_v2_2.prefs_changed()
  ...
  if show.structs ~= omi_smallx_orderbookfeed_sbe_v2_2.prefs.show_structs then
    show.structs = omi_smallx_orderbookfeed_sbe_v2_2.prefs.show_structs
  end
  if show.indexes ~= omi_smallx_orderbookfeed_sbe_v2_2.prefs.show_indexes then
    show.indexes = omi_smallx_orderbookfeed_sbe_v2_2.prefs.show_indexes
  end
end
...
-- Register SmallX OrderBookFeed Sbe 2.2 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_smallx_orderbookfeed_sbe_v2_2)
