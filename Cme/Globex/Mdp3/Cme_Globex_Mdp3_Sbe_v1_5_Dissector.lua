...
-- Cme Globex Mdp3 Sbe 1.5 Framing
...
-----------------------------------------------------------------------
-- Cme Globex Mdp3 Sbe 1.5 Formatting
-----------------------------------------------------------------------
...
cme_globex_mdp3_sbe_v1_5.inst_attrib_value.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_cme_globex_mdp3_sbe_v1_5.fields.inst_attrib_value, range, display)
...
cme_globex_mdp3_sbe_v1_5.role = function(packet)
  ...
  local acceptor_port = omi_cme_globex_mdp3_sbe_v1_5.prefs.acceptor_port
...
local function omi_cme_globex_mdp3_sbe_v1_5_tcp_heuristic(buffer, packet, parent)
  local role = cme_globex_mdp3_sbe_v1_5.role(packet)
  local initiator = omi_cme_globex_mdp3_sbe_v1_5_tcp_initiator_heuristic
  local acceptor = omi_cme_globex_mdp3_sbe_v1_5_tcp_acceptor_heuristic
