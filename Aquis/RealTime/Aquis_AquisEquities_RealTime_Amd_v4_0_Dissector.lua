...
-- Aquis AquisEquities RealTime 4.0 Application Messages
...
omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_aquis_aquisequities_realtime_amd_v4_0.prefs_changed()
  ...
  if show.headers ~= omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_headers then
    show.headers = omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_headers
  end
  if show.structs ~= omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_structs then
    show.structs = omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_structs
  end
  if show.indexes ~= omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_indexes then
    show.indexes = omi_aquis_aquisequities_realtime_amd_v4_0.prefs.show_indexes
  end
end
...
-- Reserved 20
aquis_aquisequities_realtime_amd_v4_0.reserved_20 = {}

-- Size: Reserved 20
aquis_aquisequities_realtime_amd_v4_0.reserved_20.size = 20

-- Display: Reserved 20
aquis_aquisequities_realtime_amd_v4_0.reserved_20.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Reserved 20
aquis_aquisequities_realtime_amd_v4_0.reserved_20.dissect = function(buffer, offset, packet, parent)
  local length = aquis_aquisequities_realtime_amd_v4_0.reserved_20.size
  local range = buffer(offset, length)
  ...
  local display = aquis_aquisequities_realtime_amd_v4_0.reserved_20.display(value, buffer, offset, packet, parent)

  parent:add(omi_aquis_aquisequities_realtime_amd_v4_0.fields.reserved_20, range, value, display)
...
aquis_aquisequities_realtime_amd_v4_0.security_definition_flags.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_aquis_aquisequities_realtime_amd_v4_0.fields.security_definition_flags, range, display)
...
aquis_aquisequities_realtime_amd_v4_0.security_definition_message.size =
  ...
  aquis_aquisequities_realtime_amd_v4_0.reserved_20.size + 
...
aquis_aquisequities_realtime_amd_v4_0.security_definition_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Reserved 20: char(20)
  index, reserved_20 = aquis_aquisequities_realtime_amd_v4_0.reserved_20.dissect(buffer, index, packet, parent)
...
aquis_aquisequities_realtime_amd_v4_0.binary_mmt.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_aquis_aquisequities_realtime_amd_v4_0.fields.binary_mmt, range, display)
