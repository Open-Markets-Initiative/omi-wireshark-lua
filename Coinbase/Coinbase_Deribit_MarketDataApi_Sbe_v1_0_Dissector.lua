...
omi_coinbase_deribit_marketdataapi_sbe_v1_0.fields.message_count_short = ProtoField.new("Message Count Short", "coinbase.deribit.marketdataapi.sbe.v1.0.messagecountshort", ftypes.UINT8)
...
omi_coinbase_deribit_marketdataapi_sbe_v1_0.fields.reserved_bits = ProtoField.new("Reserved Bits", "coinbase.deribit.marketdataapi.sbe.v1.0.reservedbits", ftypes.UINT16, nil, base.DEC, 0xFFFC)
...
-- Coinbase Deribit MarketDataApi Sbe 1.0 Framing
...
-- Message Count Short
coinbase_deribit_marketdataapi_sbe_v1_0.message_count_short = {}

-- Size: Message Count Short
coinbase_deribit_marketdataapi_sbe_v1_0.message_count_short.size = 1

-- Display: Message Count Short
coinbase_deribit_marketdataapi_sbe_v1_0.message_count_short.display = function(value)
...
coinbase_deribit_marketdataapi_sbe_v1_0.retransmit_request_message.size =
  ...
  coinbase_deribit_marketdataapi_sbe_v1_0.message_count_short.size
...
coinbase_deribit_marketdataapi_sbe_v1_0.retransmit_request_message.fields = function(buffer, offset, packet, parent)
  ...
  index, message_count_short = coinbase_deribit_marketdataapi_sbe_v1_0.message_count_short.dissect(buffer, index, packet, parent)
...
coinbase_deribit_marketdataapi_sbe_v1_0.md_message.size = function(buffer, offset)
  local index = offset
...
coinbase_deribit_marketdataapi_sbe_v1_0.md_message.dissect = function(buffer, offset, packet, parent, size_of_md_message, md_message_index)
  local size_of_md_message = coinbase_deribit_marketdataapi_sbe_v1_0.md_message.size(buffer, offset)
...
-- Empty Packet
coinbase_deribit_marketdataapi_sbe_v1_0.empty_packet = {}

-- Display: Empty Packet
coinbase_deribit_marketdataapi_sbe_v1_0.empty_packet.display = function(packet, parent, length)
  return "Empty Packet"
end


-- Dissect: Empty Packet
coinbase_deribit_marketdataapi_sbe_v1_0.empty_packet.dissect = function(buffer, offset, packet, parent)
  local display = coinbase_deribit_marketdataapi_sbe_v1_0.empty_packet.display(packet, parent, 0)
...
-- Md Messages
coinbase_deribit_marketdataapi_sbe_v1_0.md_messages = {}

-- Dissect: Md Messages
coinbase_deribit_marketdataapi_sbe_v1_0.md_messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Empty Packet
  if message_count == 0 then
    return coinbase_deribit_marketdataapi_sbe_v1_0.empty_packet.dissect(buffer, offset, packet, parent)
  end
...
coinbase_deribit_marketdataapi_sbe_v1_0.packet_type.bits = function(range, value, packet, parent)
  ...
  parent:add(omi_coinbase_deribit_marketdataapi_sbe_v1_0.fields.packet_reserved_bits, range, value)
end
...
coinbase_deribit_marketdataapi_sbe_v1_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = coinbase_deribit_marketdataapi_sbe_v1_0.md_messages.dissect(buffer, index, packet, parent, message_count)
