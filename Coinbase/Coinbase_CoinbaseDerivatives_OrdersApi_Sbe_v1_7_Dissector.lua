...
local omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7 = Proto("Omi.Coinbase.CoinbaseDerivatives.OrdersApi.Sbe.v1.7", "Coinbase CoinbaseDerivatives OrdersApi Sbe 1.7")
...
-- Coinbase CoinbaseDerivatives OrdersApi Sbe 1.7 Framing
...
-- Coinbase CoinbaseDerivatives OrdersApi 1.7 Application Messages
...
omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7.prefs_changed()
  ...
  if show.headers ~= omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7.prefs.show_headers then
    show.headers = omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7.prefs.show_headers
  end
...
coinbase_coinbasederivatives_ordersapi_sbe_v1_7.flags.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add_le(omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7.fields.flags, range, display)
...
-- Register Coinbase CoinbaseDerivatives OrdersApi Sbe 1.7 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7)
