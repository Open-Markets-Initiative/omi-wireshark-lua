...
local omi_coinbase_deribit_ordersapi_sbe_v1_0 = Proto("Omi.Coinbase.Deribit.OrdersApi.Sbe.v1.0", "Coinbase Deribit OrdersApi Sbe 1.0")
...
omi_coinbase_deribit_ordersapi_sbe_v1_0.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_coinbase_deribit_ordersapi_sbe_v1_0.prefs_changed()
  ...
  if show.headers ~= omi_coinbase_deribit_ordersapi_sbe_v1_0.prefs.show_headers then
    show.headers = omi_coinbase_deribit_ordersapi_sbe_v1_0.prefs.show_headers
  end
...
coinbase_deribit_ordersapi_sbe_v1_0.session_flags.dissect = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(omi_coinbase_deribit_ordersapi_sbe_v1_0.fields.session_flags, range, display)
...
-- Register Coinbase Deribit OrdersApi Sbe 1.0 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_coinbase_deribit_ordersapi_sbe_v1_0)
