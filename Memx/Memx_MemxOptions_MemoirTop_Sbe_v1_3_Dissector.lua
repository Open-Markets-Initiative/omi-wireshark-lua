...
-- Session Shutdown
memx_memxoptions_memoirtop_sbe_v1_3.session_shutdown = {}

-- Display: Session Shutdown
memx_memxoptions_memoirtop_sbe_v1_3.session_shutdown.display = function(packet, parent, length)
  return "Session Shutdown"
end


-- Dissect: Session Shutdown
memx_memxoptions_memoirtop_sbe_v1_3.session_shutdown.dissect = function(buffer, offset, packet, parent)
  local display = memx_memxoptions_memoirtop_sbe_v1_3.session_shutdown.display(packet, parent, 0)
...
-- Heartbeat
memx_memxoptions_memoirtop_sbe_v1_3.heartbeat = {}

-- Display: Heartbeat
memx_memxoptions_memoirtop_sbe_v1_3.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
memx_memxoptions_memoirtop_sbe_v1_3.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = memx_memxoptions_memoirtop_sbe_v1_3.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
memx_memxoptions_memoirtop_sbe_v1_3.sequenced_messages.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0 then
    return memx_memxoptions_memoirtop_sbe_v1_3.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Session Shutdown
  if message_type == 1 then
    return memx_memxoptions_memoirtop_sbe_v1_3.session_shutdown.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Message
