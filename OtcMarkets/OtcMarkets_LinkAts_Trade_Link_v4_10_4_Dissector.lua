...
function omi_otcmarkets_linkats_trade_link_v4_10_4.prefs_changed()
  ...
  if show.indexes ~= omi_otcmarkets_linkats_trade_link_v4_10_4.prefs.show_indexes then
    show.indexes = omi_otcmarkets_linkats_trade_link_v4_10_4.prefs.show_indexes
  end
end
...
otcmarkets_linkats_trade_link_v4_10_4.packet_milli.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if otcmarkets_linkats_trade_link_v4_10_4.timestamp_format == 0 then
  ...
  if otcmarkets_linkats_trade_link_v4_10_4.timestamp_format == 2 and packet then
