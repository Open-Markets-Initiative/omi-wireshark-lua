...
-- OtcMarkets LinkAts Multicast Link 4.10.4 Framing
...
-- OtcMarkets LinkAts Multicast 4.10.4 Application Messages
...
-- OtcMarkets LinkAts Multicast 4.10.4 Session Messages
omi_otcmarkets_linkats_multicast_link_v4_10_4.fields.heartbeat_packet = ProtoField.new("Heartbeat Packet", "otcmarkets.linkats.multicast.link.v4.10.4.heartbeatpacket", ftypes.BYTES)
...
omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs_changed()
  ...
  if show.headers ~= omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_headers then
    show.headers = omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_headers
  end
  if show.structs ~= omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_structs then
    show.structs = omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_structs
  end
  if show.indexes ~= omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_indexes then
    show.indexes = omi_otcmarkets_linkats_multicast_link_v4_10_4.prefs.show_indexes
  end
end
...
otcmarkets_linkats_multicast_link_v4_10_4.packet_milli.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if otcmarkets_linkats_multicast_link_v4_10_4.timestamp_format == 0 then
  ...
  if otcmarkets_linkats_multicast_link_v4_10_4.timestamp_format == 2 and packet then
...
otcmarkets_linkats_multicast_link_v4_10_4.message.size = function(buffer, offset)
  local index = offset
...
otcmarkets_linkats_multicast_link_v4_10_4.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = otcmarkets_linkats_multicast_link_v4_10_4.message.size(buffer, offset)
...
-- Heartbeat Packet
otcmarkets_linkats_multicast_link_v4_10_4.heartbeat_packet = {}

-- Display: Heartbeat Packet
otcmarkets_linkats_multicast_link_v4_10_4.heartbeat_packet.display = function(packet, parent, length)
  return "Heartbeat Packet"
end


-- Dissect: Heartbeat Packet
otcmarkets_linkats_multicast_link_v4_10_4.heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = otcmarkets_linkats_multicast_link_v4_10_4.heartbeat_packet.display(packet, parent, 0)
...
-- Message Block
otcmarkets_linkats_multicast_link_v4_10_4.message_block = {}

-- Dissect: Message Block
otcmarkets_linkats_multicast_link_v4_10_4.message_block.dissect = function(buffer, offset, packet, parent, heartbeat)
  -- Dissect Heartbeat Packet
  if bit.band(packet_flag, 0x01) == 1 then
    return otcmarkets_linkats_multicast_link_v4_10_4.heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  ...
  for message_index = 1, messages do
    ...
    offset = otcmarkets_linkats_multicast_link_v4_10_4.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
end
...
otcmarkets_linkats_multicast_link_v4_10_4.packet.dissect = function(buffer, packet, parent)
  ...
  index = otcmarkets_linkats_multicast_link_v4_10_4.message_block.dissect(buffer, index, packet, parent, heartbeat)
