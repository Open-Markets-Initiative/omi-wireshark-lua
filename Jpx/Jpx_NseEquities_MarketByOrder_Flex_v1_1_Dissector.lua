...
-- Jpx NseEquities MarketByOrder Flex 1.1 Framing
...
omi_jpx_nseequities_marketbyorder_flex_v1_1.fields.tcp_packet_header = ProtoField.new("Tcp Packet Header", "jpx.nseequities.marketbyorder.flex.v1.1.tcppacketheader", ftypes.STRING)
...
-- Jpx NseEquities MarketByOrder 1.1 Application Messages
...
-- Display: Best Bid
jpx_nseequities_marketbyorder_flex_v1_1.best_bid.display = function(raw, value)
...
jpx_nseequities_marketbyorder_flex_v1_1.best_bid.dissect = function(buffer, offset, packet, parent)
  ...
  local display = jpx_nseequities_marketbyorder_flex_v1_1.best_bid.display(raw, value, buffer, offset, packet, parent)
...
-- Display: Best Offer
jpx_nseequities_marketbyorder_flex_v1_1.best_offer.display = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x00000000) then
...
jpx_nseequities_marketbyorder_flex_v1_1.best_offer.dissect = function(buffer, offset, packet, parent)
  ...
  local display = jpx_nseequities_marketbyorder_flex_v1_1.best_offer.display(raw, value, buffer, offset, packet, parent)
...
-- Display: Price
jpx_nseequities_marketbyorder_flex_v1_1.price.display = function(raw, value)
  -- Check null sentinel value
...
jpx_nseequities_marketbyorder_flex_v1_1.price.dissect = function(buffer, offset, packet, parent)
  ...
  local display = jpx_nseequities_marketbyorder_flex_v1_1.price.display(raw, value, buffer, offset, packet, parent)
...
-- Tcp Payload
jpx_nseequities_marketbyorder_flex_v1_1.tcp_payload = {}

-- Dissect: Tcp Payload
jpx_nseequities_marketbyorder_flex_v1_1.tcp_payload.dissect = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Login Request Message
...
-- Tcp Packet Header
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header = {}

-- Size: Tcp Packet Header
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.size =
...
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Tcp Packet Header
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_jpx_nseequities_marketbyorder_flex_v1_1.fields.tcp_packet_header, buffer(offset, 0))
    local index = jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.size
end
...
jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet.dissect = function(buffer, packet, parent)
  ...
  index, tcp_packet_header = jpx_nseequities_marketbyorder_flex_v1_1.tcp_packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Tcp Payload: Runtime Type with 4 branches
  index = jpx_nseequities_marketbyorder_flex_v1_1.tcp_payload.dissect(buffer, index, packet, parent, packet_type)
...
-- Dissect: Payload
jpx_nseequities_marketbyorder_flex_v1_1.payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect Seconds Timestamp Message
  if message_type == "T" then
    return jpx_nseequities_marketbyorder_flex_v1_1.seconds_timestamp_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trading Status Message
  if message_type == "O" then
    return jpx_nseequities_marketbyorder_flex_v1_1.trading_status_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Execution Summary Message
  if message_type == "K" then
    return jpx_nseequities_marketbyorder_flex_v1_1.execution_summary_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Add Order Message
  if message_type == "A" then
    return jpx_nseequities_marketbyorder_flex_v1_1.add_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Executed Message
  if message_type == "E" then
    return jpx_nseequities_marketbyorder_flex_v1_1.order_executed_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Executed With Price Message
  if message_type == "C" then
    return jpx_nseequities_marketbyorder_flex_v1_1.order_executed_with_price_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Delete Message
  if message_type == "D" then
    return jpx_nseequities_marketbyorder_flex_v1_1.order_delete_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Reset Message
  if message_type == "R" then
    return jpx_nseequities_marketbyorder_flex_v1_1.reset_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Communication Control Message
  if message_type == "L" then
    return jpx_nseequities_marketbyorder_flex_v1_1.communication_control_message.dissect(buffer, offset, packet, parent)
  end
...
jpx_nseequities_marketbyorder_flex_v1_1.packet_header.size =
  ...
  jpx_nseequities_marketbyorder_flex_v1_1.number_of_system_reboots.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.sequence_number.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.issue_code.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.update_number.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.packet_number.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.total_number_of_packets.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.utility_flag.size + 
  jpx_nseequities_marketbyorder_flex_v1_1.message_count.size
...
jpx_nseequities_marketbyorder_flex_v1_1.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, issue_code = jpx_nseequities_marketbyorder_flex_v1_1.issue_code.dissect(buffer, index, packet, parent)

  -- Update Number: 4 Byte Unsigned Fixed Width Integer
  index, update_number = jpx_nseequities_marketbyorder_flex_v1_1.update_number.dissect(buffer, index, packet, parent)

  -- Packet Number: 1 Byte Unsigned Fixed Width Integer
  index, packet_number = jpx_nseequities_marketbyorder_flex_v1_1.packet_number.dissect(buffer, index, packet, parent)

  -- Total Number Of Packets: 1 Byte Unsigned Fixed Width Integer
  index, total_number_of_packets = jpx_nseequities_marketbyorder_flex_v1_1.total_number_of_packets.dissect(buffer, index, packet, parent)

  -- Utility Flag: 1 Byte Unsigned Fixed Width Integer
  index, utility_flag = jpx_nseequities_marketbyorder_flex_v1_1.utility_flag.dissect(buffer, index, packet, parent)

  -- Message Count: 1 Byte Unsigned Fixed Width Integer
  index, message_count = jpx_nseequities_marketbyorder_flex_v1_1.message_count.dissect(buffer, index, packet, parent)
...
-- Register Jpx NseEquities MarketByOrder Flex 1.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_jpx_nseequities_marketbyorder_flex_v1_1)
-- Register Jpx NseEquities MarketByOrder Flex 1.1 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_jpx_nseequities_marketbyorder_flex_v1_1)
