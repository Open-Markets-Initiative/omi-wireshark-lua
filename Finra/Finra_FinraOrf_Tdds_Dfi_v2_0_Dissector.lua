...
omi_finra_finraorf_tdds_dfi_v2_0.fields.administrative_message = ProtoField.new("Administrative Message", "finra.finraorf.tdds.dfi.v2.0.administrativemessage", ftypes.STRING)
...
omi_finra_finraorf_tdds_dfi_v2_0.fields.control_message = ProtoField.new("Control Message", "finra.finraorf.tdds.dfi.v2.0.controlmessage", ftypes.STRING)
...
omi_finra_finraorf_tdds_dfi_v2_0.fields.reserved_1 = ProtoField.new("Reserved 1", "finra.finraorf.tdds.dfi.v2.0.reserved1", ftypes.STRING)
...
omi_finra_finraorf_tdds_dfi_v2_0.fields.trade_message = ProtoField.new("Trade Message", "finra.finraorf.tdds.dfi.v2.0.trademessage", ftypes.STRING)
...
-- Reserved 1
finra_finraorf_tdds_dfi_v2_0.reserved_1 = {}

-- Size: Reserved 1
finra_finraorf_tdds_dfi_v2_0.reserved_1.size = 1

-- Display: Reserved 1
finra_finraorf_tdds_dfi_v2_0.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
finra_finraorf_tdds_dfi_v2_0.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = finra_finraorf_tdds_dfi_v2_0.reserved_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = finra_finraorf_tdds_dfi_v2_0.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_finra_finraorf_tdds_dfi_v2_0.fields.reserved_1, range, value, display)
...
finra_finraorf_tdds_dfi_v2_0.control_message_payload = {}

-- Dissect: Control Message Payload
finra_finraorf_tdds_dfi_v2_0.control_message_payload.dissect = function(buffer, offset, packet, parent, control_message_type)
  -- Dissect Start Of Day Message
...
-- Control Message
finra_finraorf_tdds_dfi_v2_0.control_message = {}

-- Calculate size of: Control Message
finra_finraorf_tdds_dfi_v2_0.control_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + finra_finraorf_tdds_dfi_v2_0.control_message_payload.size(buffer, control_message_payload_offset, control_message_payload_type)

  return index
end

-- Display: Control Message
finra_finraorf_tdds_dfi_v2_0.control_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Control Message
finra_finraorf_tdds_dfi_v2_0.control_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index = finra_finraorf_tdds_dfi_v2_0.control_message_payload.dissect(buffer, index, packet, parent, control_message_type)

  return index
end

-- Dissect: Control Message
finra_finraorf_tdds_dfi_v2_0.control_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_finra_finraorf_tdds_dfi_v2_0.fields.control_message, buffer(offset, 0))
    local index = finra_finraorf_tdds_dfi_v2_0.control_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = finra_finraorf_tdds_dfi_v2_0.control_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return finra_finraorf_tdds_dfi_v2_0.control_message.fields(buffer, offset, packet, parent)
  end
end
...
finra_finraorf_tdds_dfi_v2_0.closing_trade_summary_report_message.size =
  ...
  finra_finraorf_tdds_dfi_v2_0.reserved_1.size + 
...
finra_finraorf_tdds_dfi_v2_0.closing_trade_summary_report_message.fields = function(buffer, offset, packet, parent)
  ...
  index, reserved_1 = finra_finraorf_tdds_dfi_v2_0.reserved_1.dissect(buffer, index, packet, parent)
...
finra_finraorf_tdds_dfi_v2_0.general_administrative_message.size = function(buffer, offset)
  local index = 0
...
finra_finraorf_tdds_dfi_v2_0.administrative_message_payload = {}

-- Dissect: Administrative Message Payload
finra_finraorf_tdds_dfi_v2_0.administrative_message_payload.dissect = function(buffer, offset, packet, parent, administrative_message_type)
  -- Dissect General Administrative Message
...
finra_finraorf_tdds_dfi_v2_0.administrative_message = {}

-- Calculate size of: Administrative Message
finra_finraorf_tdds_dfi_v2_0.administrative_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + finra_finraorf_tdds_dfi_v2_0.administrative_message_payload.size(buffer, administrative_message_payload_offset, administrative_message_payload_type)

  return index
end

-- Display: Administrative Message
finra_finraorf_tdds_dfi_v2_0.administrative_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Administrative Message
finra_finraorf_tdds_dfi_v2_0.administrative_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index = finra_finraorf_tdds_dfi_v2_0.administrative_message_payload.dissect(buffer, index, packet, parent, administrative_message_type)

  return index
end

-- Dissect: Administrative Message
finra_finraorf_tdds_dfi_v2_0.administrative_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_finra_finraorf_tdds_dfi_v2_0.fields.administrative_message, buffer(offset, 0))
    local index = finra_finraorf_tdds_dfi_v2_0.administrative_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = finra_finraorf_tdds_dfi_v2_0.administrative_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return finra_finraorf_tdds_dfi_v2_0.administrative_message.fields(buffer, offset, packet, parent)
  end
end
...
finra_finraorf_tdds_dfi_v2_0.trade_correction_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Original Message Sequence Number: Numeric
...
finra_finraorf_tdds_dfi_v2_0.trade_message_payload = {}

-- Dissect: Trade Message Payload
finra_finraorf_tdds_dfi_v2_0.trade_message_payload.dissect = function(buffer, offset, packet, parent, trade_message_type)
  -- Dissect Trade Report Short Form Message
...
-- Trade Message
finra_finraorf_tdds_dfi_v2_0.trade_message = {}

-- Calculate size of: Trade Message
finra_finraorf_tdds_dfi_v2_0.trade_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + finra_finraorf_tdds_dfi_v2_0.trade_message_payload.size(buffer, trade_message_payload_offset, trade_message_payload_type)

  return index
end

-- Display: Trade Message
finra_finraorf_tdds_dfi_v2_0.trade_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Message
finra_finraorf_tdds_dfi_v2_0.trade_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index = finra_finraorf_tdds_dfi_v2_0.trade_message_payload.dissect(buffer, index, packet, parent, trade_message_type)

  return index
end

-- Dissect: Trade Message
finra_finraorf_tdds_dfi_v2_0.trade_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_finra_finraorf_tdds_dfi_v2_0.fields.trade_message, buffer(offset, 0))
    local index = finra_finraorf_tdds_dfi_v2_0.trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = finra_finraorf_tdds_dfi_v2_0.trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return finra_finraorf_tdds_dfi_v2_0.trade_message.fields(buffer, offset, packet, parent)
  end
end
...
finra_finraorf_tdds_dfi_v2_0.payload.dissect = function(buffer, offset, packet, parent, message_category)
  ...
  if message_category == "T" then
    return finra_finraorf_tdds_dfi_v2_0.trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Administrative Message
  if message_category == "A" then
    return finra_finraorf_tdds_dfi_v2_0.administrative_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Control Message
  if message_category == "C" then
    return finra_finraorf_tdds_dfi_v2_0.control_message.dissect(buffer, offset, packet, parent)
  end
