...
-- Finra Trace Btds Dfi 2.1 Framing
...
omi_finra_trace_btds_dfi_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_finra_trace_btds_dfi_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_finra_trace_btds_dfi_v2_1.prefs.show_headers then
    show.headers = omi_finra_trace_btds_dfi_v2_1.prefs.show_headers
  end
